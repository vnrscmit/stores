...
<tr >
<td width="800" align="right"><a href="excel-stockonhand.php?pid=<?php echo $_GET['pid'];?>&sdate=<?php echo $_REQUEST['sdate'];?>&txtclass=<?php echo $_REQUEST['txtclass'];?>&txtitem=<?php echo $_REQUEST['txtitem'];?>&ret=<?php echo $_REQUEST['ret'];?>&chk=<?php echo $_REQUEST['chk'];?>" target="_blank"><img src="../images/excelicon1.jpg" border="0" height="30" width="30" class="butn" alt="Export to Excel" style="display:inline;cursor:hand;" /></a>&nbsp;&nbsp;&nbsp;<img src="../images/Vista-printer.png" border="0" class="butn" height="29" width="35" alt="Print" style="display:inline;cursor:hand;" onclick="javascript:window.print();" />&nbsp;&nbsp;&nbsp;<a href="word_bin.php?whid=<?php echo $whid?>"></a>&nbsp;&nbsp;&nbsp;<img src="../images/close_icon2.jpg" border="0" class="butn" height="30"  alt="Close" style="display:inline;cursor:hand;" onClick="window.close()" /></td>
</tr>
</table>
