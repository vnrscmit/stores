...
<title>Master Report -Report - Warehouse Master</title>
...
?>
    <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
          <tr style="padding:0px 0px 0px 0px" >
            ...
            <td width="940" class="Mainheading" height="25"><table width="809" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
                <tr >
                  <td width="940" height="25">&nbsp;Report - Warehouse Master</td>
                </tr>
            </table></td>
