<?php
	...
	require_once("../include/connection.php");
		...
		echo "<script>window.location='consumption_report1.php?sdate=$sdate1&edate=$edate1&txtclass=$class&txtitem=$item&ret=$ret'</script>";	
	}
...
<title>Stores- Report-Consumption Report</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25"class="Mainheading"  >&nbsp;Consumption Report</td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
<tr class="tblsubtitle" height="25"><td colspan="4" align="center" class="tblheading">Consumption Report</td></tr>
