...
<table align="center" border="1" cellspacing="0" cellpadding="0" width="750" bordercolor="#4ea1e1" style="border-collapse:collapse">
            <tr class="tblsubtitle" height="35">
			 ...
			 <td width="16%" align="center" rowspan="2" valign="middle" class="tblheading">Classification</td>
              <td width="24%" rowspan="2" align="center" valign="middle" class="tblheading">Items</td>
                <td colspan="4" height="23" align="center" valign="middle" class="tblheading">Quantity</td>
                  <td colspan="3" height="23" align="center" valign="middle" class="tblheading">SLOC</td>
			...
			<tr class="tblsubtitle">
                    <td width="5%" align="center" valign="middle" class="tblheading">DC</td>
                    <td width="6%" align="center" valign="middle" class="tblheading">Good</td>
                    <td width="7%" align="center" valign="middle" class="tblheading">Damage</td>
                    <td width="7%" align="center" valign="middle" class="tblheading">Excess/<br />
                      Shortage</td>
					<td width="8%" align="center" valign="middle" class="tblheading">WH</td>
                    <td width="6%" align="center" valign="middle" class="tblheading">Bin</td>
                    <td width="8%" align="center" valign="middle" class="tblheading">Sub Bin</td>
              </tr>
...
<tr class="tblsubtitle" height="20">
  <td colspan="4" align="center" class="tblheading">Add Arrival From Stock Transfer </td>
</tr>
<tr height="15"><td colspan="6" align="right" class="tblheading"><font color="#FF0000" >* </font>indicates required field&nbsp;</td></tr>
 <tr class="Dark" height="25">
           <td width="193"  align="right"  valign="middle" class="tblheading">&nbsp;classification&nbsp;</td>
           <td align="left"  valign="middle" colspan="3">&nbsp;<select class="tbltext" name="txtcla" style="width:170px;"  onchange="showUser(this.value)">
<option value="" selected>--Select Classification--</option>
	<?php while($noticia = mysql_fetch_array($sql1)) { ?>
...
<td width="193" align="right" valign="middle" class="tblheading">Items&nbsp;</td>
<td width="551" align="left" valign="middle" class="tbltext" colspan="3">&nbsp;<select class="tbltext" name="txtitem" style="width:170px;"  onchange="showUser(this.value)">
...
<td align="left"  valign="middle" class="tbltext" colspan="3">&nbsp;<input name="txtcity" type="text" size="15" class="tbltext" tabindex="" maxlength="25"  onBlur="javascript:this.value=ucwords_w(this.value.toLowerCase());"/>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>

<tr class="Light" height="30">
<td align="right"  valign="middle" class="tblheading">&nbsp;Actual Quantity Receive Good&nbsp;</td>
<td align="left"  valign="middle" class="tbltext" colspan="3">&nbsp;<input name="txtmobile" type="text" size="15" class="tbltext" tabindex="" maxlength="13" onKeyPress="return isNumberKey(event)"  />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>

 <tr class="Dark" height="30">
<td align="right"  valign="middle" class="tblheading">&nbsp;Damage&nbsp;</td>
<td align="left"  valign="middle" class="tbltext" colspan="3">&nbsp;<input name="txtmobile" type="text" size="15" class="tbltext" tabindex="" maxlength="13" onKeyPress="return isNumberKey(event)"  />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
<tr class="Light" height="30">
<td align="right"  valign="middle" class="tblheading">&nbsp;Excess/Shortage&nbsp;</td>
<td align="left"  valign="middle" class="tbltext" colspan="3">&nbsp;<input name="txtmobile" type="text" size="15" class="tbltext" tabindex="" maxlength="13" onKeyPress="return isNumberKey(event)"  />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>

<tr class="Dark" height="30">
<td align="right"  valign="middle" class="tblheading">SLOC No of BINS &nbsp;</td>
<td align="left"  valign="middle" class="tbltext" colspan="3">&nbsp;<input name="txtmobile" type="text" size="15" class="tbltext" tabindex="" maxlength="13" onKeyPress="return isNumberKey(event)"  />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>

<tr class="Light" height="30">
<td align="right"  valign="middle" class="tblheading">WH&nbsp;</td>
<td align="left"  valign="middle" class="tbltext" colspan="3">&nbsp;<select class="tbltext" name="txtcla" style="width:170px;"  onchange="showUser(this.value)">
...
<tr class="Dark" height="30">
<td align="right"  valign="middle" class="tblheading">&nbsp;Bin No &nbsp;</td>
<td align="left"  valign="middle" class="tbltext" colspan="3">&nbsp;<select class="tbltext" name="txtcla" style="width:170px;"  onchange="showUser(this.value)">
...
<tr class="Dark" height="30">
<td align="right"  valign="middle" class="tblheading">&nbsp;Sub Bin No &nbsp;</td>
<td align="left"  valign="middle" class="tbltext" colspan="3">&nbsp;<select class="tbltext" name="txtcla" style="width:170px;"  onchange="showUser(this.value)">
...
<td align="left"  valign="middle" class="tbltext" colspan="3">&nbsp;<textarea name="txtaddress" cols="50" rows="5" tabindex="" ></textarea>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
