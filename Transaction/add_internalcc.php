<?php
	...
	$s_chk=mysql_query("SELECT * FROM tbl_captive where yearcode='$yearid_id'") or die (mysql_error());
	$r_chk=mysql_num_rows($s_chk);
	if($r_chk > 0)
	$sql_code="SELECT MAX(code) FROM tbl_captive where yearcode='$yearid_id' ORDER BY code DESC";
	else
	$sql_code="SELECT MAX(code) FROM tbl_captive  where  yearcode='$yearid_id' ORDER BY code DESC";
		...
		if(mysql_num_rows($res_code) > 0)
			{
				...
				$t_code=$row_code['0'];
				$code=$t_code+1;
			$code1="TCC".$code."/".$yearid_id."/".$lgnid;
		}
		//}
		else
		{
...
/*	$a="TCC";
	$sql_code="SELECT MAX(code) FROM tbl_captive where yearcode='$year_id' ORDER BY code DESC";
	$res_code=mysql_query($sql_code)or die(mysql_error());
...
<title>stores - Transaction -add captive Consumption</title>
...
<table width="1003" height="600" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
 ...
 <?php $trid=0;
	/*$sql1=mysql_query("select * from tbl_captive where tid=$tid")or die(mysql_error());
	...
	//$trid=0; */
	 ?> 
		...
		<input type="hidden" name="logid" value="<?php echo $logid?>" />
		 ...
		 <input name="txtptn" value="" type="hidden"> 
...
<tr class="Dark" height="25">
          ...
          <td width="217"  align="left" valign="middle" class="tbltext">&nbsp;<?php echo $code1?></td>
		   
		   <td width="165" height="24"  align="right"  valign="middle" class="tblheading">&nbsp;Date&nbsp;</td>
           <td width="176" colspan="3" align="left"  valign="middle">&nbsp;<input name="txtdate" type="text" size="10" class="tbltext" tabindex="0" readonly="true" style="background-color:#CCCCCC"  value="<?php echo date("d-m-Y");?>"  /></td>
		   </tr>
		<tr class="Light" height="25">
 <td width="182"  align="right"  valign="middle" class="tblheading">&nbsp;Party Name&nbsp;</td>
   <td colspan="5" align="left"  valign="middle">&nbsp;<input name="txt12" type="radio" class="tbltext" value="Yes" onClick="clkp(this.value);" />&nbsp;Select&nbsp;&nbsp;<input name="txt12" type="radio" class="tbltext" value="No" onClick="clkp(this.value);" />&nbsp;Fill&nbsp;&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
</table>
<table id="fill"  align="center" border="1" width="750" cellspacing="0" cellpadding="0" bordercolor="#4ea1e1" style="display:none; border-color:#4ea1e1" > 
<tr class="Dark" height="25">
           <td width="180"  align="right"  valign="middle" class="tblheading" style=" border-color:#4ea1e1">Party&nbsp; </td>
           <td align="left"  valign="middle" colspan="5" style=" border-color:#4ea1e1">&nbsp;<input name="txtparty" type="text" size="35" class="tbltext" tabindex="" maxlength="35"   />&nbsp;<font color="#FF0000"  >*</font>&nbsp;</td>
         </tr>
 <tr class="Light" height="30">
<td width="180" align="right"  valign="middle" class="tblheading" style=" border-color:#4ea1e1">&nbsp;Address 1&nbsp;</td>
<td width="564" align="left"  valign="middle" class="tbltext" style=" border-color:#4ea1e1">&nbsp;<input type="text" class="tbltext" name="txtaddress" size="70" maxlength="70" >&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
<tr class="Dark" height="30">
<td width="180" align="right"  valign="middle" class="tblheading" style=" border-color:#4ea1e1">&nbsp;Address 2&nbsp;</td>
<td width="564" align="left"  valign="middle" class="tbltext" style=" border-color:#4ea1e1">&nbsp;<input type="text" class="tbltext" name="txtaddress1" size="70" maxlength="70" >&nbsp;</td>
</tr>
<tr class="Light" height="30">
<td width="180" align="right"  valign="middle" class="tblheading" style=" border-color:#4ea1e1">&nbsp;City/Town/Village&nbsp;</td>
<td width="564" align="left"  valign="middle" class="tbltext" style=" border-color:#4ea1e1">&nbsp;<input type="text" class="tbltext" name="txtcity" size="50" maxlength="50" >&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
<tr class="Dark" height="30">
<td width="180" align="right"  valign="middle" class="tblheading" style=" border-color:#4ea1e1">&nbsp;Pin&nbsp;</td>
<td width="564" align="left"  valign="middle" class="tbltext" style=" border-color:#4ea1e1">&nbsp;<input type="text" class="tbltext" name="txtpin" size="6" maxlength="6" onkeypress="return isNumberKey(event)" >&nbsp;</td>
</tr>
<tr class="Light" height="30">
...
<td width="564" align="left"  valign="middle" class="tbltext" style=" border-color:#4ea1e1">&nbsp;<select name="txtstate" class="tbltext"  style="width:170px;" tabindex="">
		  ...
		  <option value="Telengaga">Telengaga</option>
...
<tr class="Dark" height="25">
           ...
           <td width="562" colspan="5" align="left"  valign="middle" style=" border-color:#4ea1e1">&nbsp;<input name="txtcontact" type="text" size="15" class="tbltext" tabindex="0" maxlength="15"  onkeypress="return isNumberKey(event)" />&nbsp;</td>
		   </tr>
</table>
<table id="select"  align="center" border="1" width="750" cellspacing="0" cellpadding="0" bordercolor="#4ea1e1" style="display:none; border-color:#4ea1e1" > 
<?php
...
<td width="564" colspan="5" align="left"  valign="middle" class="tbltext" id="vaddress" style=" border-color:#4ea1e1"><div align="justify" class="tbltext" style="padding:2px 5px 5px 5px"></div></td>
</tr>
...
<table align="center" border="1" width="750" cellspacing="0" cellpadding="0" bordercolor="#4ea1e1" style="border-collapse:collapse;" > 
		   ...
		   <tr class="Light" height="25">
<td width="182" align="right"  valign="middle" class="tblheading">&nbsp;Mode of Transit&nbsp;</td>
 <td width="562" colspan="5" align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtmode" type="radio" class="tbltext" value="Applicable" onClick="clkapp(this.value);" />&nbsp;Applicable&nbsp;&nbsp;&nbsp;&nbsp;<input name="txtmode" type="radio" class="tbltext" value="Not Applicable" onClick="clkapp(this.value);" />&nbsp;Not Applicable&nbsp;&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
</table>
...
<td align="left" width="246" valign="middle" class="tbltext" style="border-color:#4ea1e1">&nbsp;<input name="txtvn" type="text" size="12" class="tbltext" tabindex="" maxlength="12"  />&nbsp;<font color="#FF0000">*</font>&nbsp; </td>
...
<td align="left" width="246" valign="middle" class="tbltext" style="border-color:#4ea1e1">&nbsp;<input name="txtcname" type="text" size="20" class="tbltext" tabindex=""  maxlength="20" />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
...
<tr class="Dark" height="30">
<td align="right" width="179" valign="middle" class="tblheading" style="border-color:#4ea1e1">&nbsp;Name of Person&nbsp;</td>
<td width="565" colspan="8" align="left" valign="middle" class="tbltext" style=" border-color:#4ea1e1">&nbsp;<input name="txtpname" type="text" size="30" class="tbltext" tabindex=""  maxlength="30" />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
</table>
<br />
...
</table><input type="hidden" name="trid" value="<?php echo $trid?>" /><input type="hidden" name="rid" value="" />
<br />
<div id="subsubdiv">
<table align="center" border="1" width="750" cellspacing="0" cellpadding="0" bordercolor="#4ea1e1" style="border-collapse:collapse" > 	
<tr class="tblsubtitle" height="20">
