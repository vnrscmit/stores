...
if(isset($_REQUEST['sdate']))
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		if($sdate!="" && $edate!="")
		{
		echo "<script>window.location='c_c_home1.php?sdate=$sdate&edate=$edate'</script>";
		}
		else
		 {?>
		 <script>
...
<title>Stores Transction - Home captive Consumption</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="820" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="820" height="25" class="Mainheading">&nbsp;Transaction - Captive Consumption</td>
	    </tr></table></td>
...
/*if(!isset($_GET['page'])) { 
  ...
  $sql_arr_home=mysql_query("select * from tbl_captive where tdate between '$tdate' and '$pdate'  and ccflg=1 order by yearcode desc, cc_code desc LIMIT $start, $limit") or die(mysql_error());
...
$query = "select * from tbl_captive where tdate between '$tdate' and '$pdate'  and ccflg=1 order by yearcode desc, cc_code desc";
...
$pagination = "";
	if($lastpage > 1)
	{	
		$pagination .= "<div class=\"pagination\" align=\"right\" style=\"width:755px\">";
		//previous button
		if ($page > 1) 
	 ...
	 $srno=($page-1)*$limit+1;
/*$sql_arr_home=mysql_query("select * from tbl_captive where tdate between '$tdate' and '$pdate'  and ccflg=1 order by yearcode desc, cc_code desc LIMIT $from, $max_results") or die(mysql_error());
$tot_arr_home=mysql_num_rows($sql_arr_home);

$total_results = mysql_result(mysql_query("SELECT COUNT(*) as Num FROM tbl_captive where tdate between '$tdate' and '$pdate'  and ccflg=1"),0); */
...
<table align="center" border="1" cellspacing="0" cellpadding="0" width="600" bordercolor="#4ea1e1" style="border-collapse:collapse">
            ...
            <tr class="tblsubtitle" height="20">
			 ...
			 <td width="11%" align="center" valign="middle" class="tblheading">Date</td>
              <td width="49%" align="center" valign="middle" class="tblheading">Party</td>
...
<tr >
<td valign="top" align="right"><a href="c_c_home.php"><img src="../images/back.gif" border="0"style="display:inline;cursor:hand;" /></a></td>
</tr>
</table>
