...
if($txt12=="Yes")
{
 $sql_in1="insert into tbl_captive(code , tdate , party_id , contactno , tmode , tname , lrno , vno ,cname , docketno, pmode, pname, remarks,rettyp, yearcode, ccrole) values ('$code','$tdate','$f', '$contact','$txt1', '$i', '$j', '$k','$l', '$m','$txt13','$pname','$txtremarks','$rettyp','$yearid_id','$logid')";
}
else
{
