<?php
	...
	$sql_main="update tbl_excess set esflg=1, escode=$code  where tid = '$pid'";
...
<title>stores -Transaction: Excess/Shortage - Output Selection</title>
...
winHandle=window.open('es_note_print.php?itmid='+itm,'WelCome','top=170,left=180,width=820,height=450,scrollbars=yes');
if(winHandle==null){
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction: Excess/Shortage - Output Selection </td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
<tr class="Light" height="25">
    ...
    <td align="center"  valign="middle" class="tblheading">&nbsp;<a href="Javascript:void(0)" onclick="openslocpopprint();">Excess/Shortage Note (ESN)</a></td>
</tr>
</table>
...
<?php
	...
	if($typ == "good")
	{
$sql_tbl=mysql_query("select * from tbl_stldg_good where stlg_trtype='ES' and stlg_trsubtype='$tp' and stlg_trid='".$pid."'") or die(mysql_error());
...
<table align="center" border="1" cellspacing="0" cellpadding="0" width="750" bordercolor="#4ea1e1" style="border-collapse:collapse">
  <tr class="tblsubtitle" height="25">
    <td width="34" align="center" class="tblheading" valign="middle">#</td>
	  <td width="169" align="center" class="tblheading" valign="middle">Classification</td>
    <td width="304" align="center" class="tblheading" valign="middle">Item</td>
    <td width="51" align="center" class="tblheading" valign="middle">UPS</td>
    <td width="61" align="center" class="tblheading" valign="middle">Qty</td>
	<td width="117" align="center" class="tblheading" valign="middle">SLOC</td>
    </tr>
...
<tr class="Light" height="25">
	...
	<td width="169" align="center" valign="middle" class="tblheading"><?php echo $row_class['classification'];?></td>
    <td width="304" align="center" valign="middle" class="tblheading"><?php echo $row_item['stores_item'];?></td>
...
$sql_binn=mysql_query("select binname from tbl_bin where binid='".$row_tbl_sub['stlg_binid']."'") or die(mysql_error());
...
$sql_subbinn=mysql_query("select sname from tbl_subbin where sid='".$row_tbl_sub['stlg_subbinid']."'") or die(mysql_error());
...
?>	
	<td width="117" align="center" valign="middle" class="tblheading"><?php echo $slocs;?></td>
  </tr>
  <?php
	}
	else
...
{
$sql_tbl=mysql_query("select * from tbl_stldg_damage where stld_trtype='ES' and stld_trsubtype='$tp' and stld_trid='".$pid."'") or die(mysql_error());
/*$row_tbl=mysql_fetch_array($sql_tbl);			
$issue_id=$row_tbl['issue_id'];
*/
?>
...
<tr >
<td valign="top" align="center"><a href="add_shortage.php"><img src="../images/back.gif" border="0"style="display:inline;cursor:pointer;" /></a>&nbsp;&nbsp;&nbsp;
