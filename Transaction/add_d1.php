<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		if($sdate!="" && $edate!="")
		{
		echo "<script>window.location='add_d1.php?sdate=$sdate&edate=$edate'</script>";
		}
		else
		 {?>
		 <script>
...
<title>stores - Transction- Damage Home</title>
        ...
        <tr>
          <td valign="top"><div class="headerwrapper">
            ...
            <div class="toplinks" style="vertical-align:text-top">
			  ...
			  <li><li> <a href="adminprofile.php">Profile </a> | </li>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="809" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="810" height="25" class="Mainheading">&nbsp;Transaction - Damage To Good </td>
	    </tr></table></td>
...
/*if(!isset($_GET['page'])) { 
  ...
  $sql_arr_home=mysql_query("select * from tbl_dtog where date between '$tdate' and '$pdate' and dgflg=1 order by yearcode desc, code desc LIMIT $start, $limit") or die(mysql_error());
...
$query = "select * from tbl_dtog where date between '$tdate' and '$pdate' and dgflg=1 order by yearcode desc, code desc";
...
$pagination = "";
	...
	{	
	 ...
	 $srno=($page-1)*$limit+1;
/*$sql_arr_home=mysql_query("select * from tbl_dtog where date between '$tdate' and '$pdate' and dgflg=1 order by yearcode desc, code desc LIMIT $from, $max_results") or die(mysql_error());
$tot_arr_home=mysql_num_rows($sql_arr_home);

$total_results = mysql_result(mysql_query("SELECT COUNT(*) as Num FROM tbl_dtog where date between '$tdate' and '$pdate' and  dgflg=1"),0); 
*/
    if($tot_arr_home >0) { 
?>
...
<table align="center" border="1" cellspacing="0" cellpadding="0" width="700" bordercolor="#4ea1e1" style="border-collapse:collapse">
           ...
           <tr class="tblsubtitle" height="20">
			 ...
			 <td width="10%" align="center" valign="middle" class="tblheading">Date</td>
			  ...
			  <td width="38%" align="center" valign="middle" class="tblheading">Item</td>
...
<tr class="Light">
         ...
         <td width="14%" align="center" valign="middle" class="tblheading"><a href="add_dtog_view.php?p_id=<?php echo $row_arr_home['did'];?>"><?php echo "DG".$row_arr_home['dcode']."/".$yearid_id."/".$lgnid;?></a></td>
         ...
         <td width="38%" align="center" valign="middle" class="tblheading"><?php echo $noticia_item['stores_item'];?></td>
		  <td width="11%" align="center" valign="middle" class="tblheading"><a href="Javascript:void(0)" onClick="openslocpopprint('<?php echo $row_arr_home['did'];?>');">G2DN</a></td>
         </tr>
<?php
}
else
...
<tr >
<td valign="top" align="right"><a href="add_d.php"><img src="../images/back.gif" border="0"style="display:inline;cursor:hand;" /></a></td>
</tr>
</table>
