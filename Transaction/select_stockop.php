...
if($printopt == "1" )
{
	echo "<script>window.location='stocknote.php?p_id=$pid'</script>";	
}

if($printopt=="2")
{
echo "<script>window.location='bincard_stock_print.php?p_id=$pid&tp=Internalreturn'</script>";}	
}
if($printopt=="3")
{
echo "<script>window.location='gatepass.php</script>";
}	
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;  Stock Transfer Out Note -STON </td>
	    </tr></table></td>
...
<tr class="tblsubtitle" height="25">
  <td colspan="4" align="center" class="tblheading">Select <span class="Mainheading"> </span></td>
</tr>
<tr class="Light" height="25">
<td width="85"  align="right"  valign="left" class="tbltext">&nbsp;
  <input type="radio" name="fet" value="1" onClick="test1(this.value);" /></td>
    <td width="223" align="left"  valign="middle" class="tblheading">&nbsp;StockTransfer Out Note </td>
</tr>
<tr class="Light" height="25">
