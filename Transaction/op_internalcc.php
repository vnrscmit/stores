<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		$dc=trim($_POST['txtdc']);
		$party=trim($_POST['txtaddress']);
		$adress=trim($_POST['txtparty']);
 	 ...
 	 $sql_in="insert into tbl_captive(code , tdate , party_id , contactno , mode , tname , lrno , vno ,cname , docketno ,pmode ,address ,pname) values ('$code','$tdate','$pname', '$contact','$txt', '$tname', '$lorryno', '$vno','$cname', '$dc','$pmode','$address','$party')";
					//exit;							
		if(mysql_query($sql_in)or die(mysql_error()))
		{
			echo "<script>window.location='select_dicard.php'</script>";	
		}
...
if(document.frmaddDepartment.txt.value=="Yes")
	...
	/*if(document.frmaddDepartment.txtcontact.value=="")
	{
	alert("Please enter Contact NO.");
	document.frmaddDepartment.txtcontact.focus();
	return false;
	}
	
	if(document.frmaddDepartment.txtcontact.value.charCodeAt() == 32)
	{
	alert("Contact NO. cannot start with space.");
	document.frmaddDepartment.txtcontact.focus();
	return false;
	}
	...
	{
		if(document.frmaddDepartment.txt11.value=="Applicable")
		{
...
<table  align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#4ea1e1" > 
...
<tr >
<td valign="top" align="right"><input name="Submit" type="image" src="../images/submit_1.gif" alt="Submit Value" onclick="return mySubmit1();"  border="0" style="display:inline;cursor:hand;" />&nbsp;&nbsp;</td>
</tr>
</table>
...
<td width="96" align="center" valign="middle" class="tblheading">Issue UPS</td>
<td width="100" align="center" valign="middle" class="tblheading">Issue Quantity</td>
