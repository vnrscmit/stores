...
if($printopt == "1" )
{
	echo "<script>window.location='iitn_note.php?p_id=$pid'</script>";	
}
if($printopt=="2")
{
echo "<script>window.location='bincard_inter.php?p_id=$pid&tp=Internalreturn'</script>";}
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">Internal Item Transfer - IITN</td>
	    </tr></table></td>
...
<td width="85"  align="right"  valign="middle" class="tbltext">&nbsp;<input type="radio" name="fet" value="1" onClick="test1(this.value);" /></td>
    <td width="223" align="left"  valign="middle" class="tblheading">&nbsp;Inter Item Transfer 
	 Note </td>
</tr>
