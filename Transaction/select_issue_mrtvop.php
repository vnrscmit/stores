<?php
	...
	/*$sql_code="SELECT MAX(iss_code) FROM tblissue where yearcode='$yearid_id' and  issue_type='MReturnV' ORDER BY iss_code DESC";
	...
	$sql_main="update tblissue set issuetrflag=1, issue_code=$code, ncode='$ncode'  where issue_id = '$pid'";
...
<title>stores -Transaction: Issue Material Return to Vendor - Output Selection </title>
...
winHandle=window.open('mrtv_issue_note_print1.php?itmid='+itm,'WelCome','top=170,left=180,width=820,height=450,scrollbars=yes');
if(winHandle==null){
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction: Issue Material Return to Vendor - Output Selection </td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
$sql_tbl=mysql_query("select * from tbl_stldg_good where stlg_trtype='Issue' and stlg_trsubtype='stocktr' and stlg_trid='".$pid."'") or die(mysql_error());
/*$row_tbl=mysql_fetch_array($sql_tbl);			
...
<tr class="Light" height="25">
    ...
    <td  align="center"  valign="middle" class="tblheading">&nbsp;<a href="Javascript:void(0)" onclick="openslocpopprint();">Vendor Material Return Note (VMRN)</a></td>
</tr>
</table>
<table align="center" border="1" width="750" cellspacing="0" cellpadding="0" bordercolor="#4ea1e1" style="border-collapse:collapse" > 
...
$sql_tbl=mysql_query("select * from tbl_stldg_good where stlg_trtype='Issue' and stlg_trsubtype='MReturnV' and stlg_trid='".$pid."'") or die(mysql_error());/*$row_tbl=mysql_fetch_array($sql_tbl);			
$issue_id=$row_tbl['issue_id'];
*/
?>
...
?>
  <tr class="tblsubtitle" height="25">
    <td width="39" align="center" class="tblheading" valign="middle">#</td>
	  <td width="181" align="center" class="tblheading" valign="middle">Classification</td>
    <td width="257" align="center" class="tblheading" valign="middle">Item</td>
...
<td width="85"  align="right"  valign="middle" class="tbltext">&nbsp;<input type="radio" name="fet" value="1" onClick="test1(this.value);" /></td>
    <td width="223" align="left"  valign="middle" class="tblheading">&nbsp;Vendor Material Return Note Print</td>
</tr>
<tr class="Dark" height="25">
...
<tr >
<td valign="top" align="center"><a href="home_materialreturn.php"><img src="../images/back.gif" border="0"style="display:inline;cursor:pointer;" /></a>&nbsp;&nbsp;<input type="hidden" name="fet1" value="" /></td>	
</tr>
</table>
