...
if($printopt == "1" )
{
	echo "<script>window.location='material_return_noted.php?p_id=$pid'</script>";	
}
if($printopt=="2")
{
echo "<script>window.location='home_bincard_print.php?p_id=$pid&tp=Internalreturn'</script>";}
	*/
...
<title>stores - Transction- Internal Return-Own (Good &amp; Damage) Outputs</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction - Internal Return-Own (Good & Damage) Outputs</td>
	    </tr></table></td>
...
<tr class="Light" height="25">
    ...
    <td align="center"  valign="middle" class="tblheading">&nbsp;<a href="Javascript:void(0)" onclick="openslocpopprint();">Internal Material Return Note - Own (IMRN-O)</a></td>
</tr>
</table>
<?php
...
<tr >
<td width="403" align="center" valign="top"><a href="add_return_stores_st.php"><img src="../images/back.gif" alt="next" OnClick="return mySubmit()" border="0" style="display:inline;cursor:hand;"></a>&nbsp;<input type="hidden" name="fet1" value="" /></td>	
</tr>
</table>
