...
<tr class="tblsubtitle" height="25">
  <td colspan="4" align="center" class="tblheading">Internal Return-Own (Good & Damage)</td>
</tr>
  <tr height="15">
...
<tr class="Dark" height="25">
      ...
      <td width="281" align="left"  valign="middle" class="tbltext">&nbsp;<?php echo "TAI".$row_tbl['arrival_code']."/".$yearid_id."/".$lgnid;?></td>
...
<tr class="Light" height="25">
      <td width="175" height="24"  align="right"  valign="middle" class="tblheading"> Party Name&nbsp;</td>
...
<tr class="Dark" height="30">
      <td width="175" height="24"  align="right"  valign="middle" class="tblheading">Return By ID&nbsp;</td>
...
{
?>
<td align="left"  valign="middle" class="tbltext" colspan="3">&nbsp;<?php echo $row_tbl['retid'];?></td>
<?php
}
else
{
...
<tr >
<td align="right" colspan="3"><img src="../images/close_icon2.jpg" height="30" width="22" border="0" onClick="window.close()" class="butn" />&nbsp;&nbsp;<img src="../images/Vista-printer.png" height="29" width="35" border="0" onClick="javascript:window.print();" class="butn" />&nbsp;&nbsp;</td>
</tr>
</table>
</form>
</td></tr>
