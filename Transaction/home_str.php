<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		if($sdate1!="" && $edate1!="")
		{
		echo "<script>window.location='home_str1.php?sdate=$sdate1&edate=$edate1'</script>";
		}
		else
		{
		echo "<script>window.location='home_str.php'</script>";
		}
...
<title>Stores -Transaction -  Home-Issue- Stock Transfer</title>
...
{
winHandle=window.open('mrtv_issue_note_print.php?itmid='+tid,'WelCome','top=170,left=180,width=820,height=450,scrollbars=yes');
if(winHandle==null){
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="820" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="820" height="25">&nbsp;Transaction - Issue- Stock Transfer </td>
	    </tr></table></td>
	  <td width="90" height="25" align="right" class="submenufont" >
	  <table border="3" align="right" bordercolordark="#5b7e1b" cellspacing="0" cellpadding="0" width="101" style="border-collapse:collapse;">

<!--/*<tr height="15" class="tbltitle" >
<td align="center" width="93" valign="middle" class="tblbutn" style="cursor:hand;"><a href="add_str.php" style="text-decoration:none; color:#FFFFFF">Add </a></td>
</tr>*/-->

<tr height="15" class="tbltitle" >
<td align="center" width="100" valign="middle" class="tblbutn" style="cursor:hand;"><?php if($flg==0 && $flg1==0 && $flg2==0) { ?><a href="add_str.php" style="text-decoration:none; color:#FFFFFF">Add </a><?php } else { ?><a href="Javascript:void(0);" onclick="alert('Can not perform Transaction.\nReason:\n1. Todays date is not in Active Current Financial Year.\n2. Transaction after todays date has been made.\n3. Cycle Inventory transaction is under process.');" style="text-decoration:none; color:#FFFFFF">Add </a><?php } ?></td>
</tr>
...
$sql_arr_home=mysql_query("select * from tblissue where issue_type='stocktr' and issuetrflag=1 order by yearcode desc, iss_code desc LIMIT $from, $max_results") or die(mysql_error());
$tot_arr_home=mysql_num_rows($sql_arr_home);

$total_results = mysql_result(mysql_query("SELECT COUNT(*) as Num FROM tblissue where issue_type='stocktr' and issuetrflag=1"),0); 
    if($tot_arr_home >0) { 
?>
...
<table align="center" border="1" cellspacing="0" cellpadding="0" width="700" bordercolor="#4ea1e1" style="border-collapse:collapse">
            ...
            <tr class="tblsubtitle" height="20">
			 ...
			 <td width="14%" align="center" valign="middle" class="tblheading">ST Date</td>
              <td width="29%" align="center" valign="middle" class="tblheading">Party</td>
			  <td width="14%" align="center" valign="middle" class="tblheading">STR Ref.No.</td>
...
<tr class="Light">
         ...
         <td width="16%" align="center" valign="middle" class="tblheading"><a href="add_issue_str_view.php?p_id=<?php echo $row_arr_home['issue_id'];?>"><?php echo "IS".$row_arr_home['iss_code']."/".$row_arr_home['yearcode']."/".$irole;?></a></td>
		 <td width="14%" align="center" valign="middle" class="tblheading"><?php echo $trdate;?></td>
         <td width="29%" align="center" valign="middle" class="tblheading"><?php echo $row3['business_name'];?></td>
         <td width="14%" align="center" valign="middle" class="tblheading"><?php echo $row_arr_home['strefno']?></td>
		  <td width="20%" align="center" valign="middle" class="tblheading"><a href="Javascript:void(0)" onclick="openslocpopprint('<?php echo $row_arr_home['issue_id'];?>');">STON</a> | <a href="Javascript:void(0)" onclick="openslocpopprint1('<?php echo $row_arr_home['issue_id'];?>');">Gate Pass</a></td>
</tr>
<?php
}
else
