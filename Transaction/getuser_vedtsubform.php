...
$sql_tbl_sub=mysql_query("select * from tblarrival_sub where arrsub_id='".$rid."'") or die(mysql_error());
$row_tbl_sub=mysql_fetch_array($sql_tbl_sub);
$tot_tbl_sub=mysql_num_rows($sql_tbl_sub);
$tid=$row_tbl_sub['arrival_id'];
$subtid=$rid;
$tblslocnog=$row_tbl_sub['noofbin_good'];
$tblslocnod=$row_tbl_sub['noofbin_damage'];

$sql_tbl=mysql_query("select * from tblarrival_sub where arrival_id='".$tid."'") or die(mysql_error());
$srno=1; $itmdchk="";
...
if($itmdchk!="")
{
$itmdchk=$itmdchk.$row_tbl['item_id'].",";
}
else
{
$itmdchk=$row_tbl['item_id'].",";
}
...
$itemqry=mysql_query("select * from tbl_stores where classification_id='".$row_tbl_sub['classification_id']."' and actstatus='Active' order by stores_item") or die(mysql_error());
?>            
...
<option value="" >--Select Item--</option>
	<?php while($noticia_item = mysql_fetch_array($itemqry)) { ?>
		<option <?php if($noticia_item['items_id']==$row_tbl_sub['item_id']){ echo "Selected"; } ?> value="<?php echo $noticia_item['items_id'];?>" />   
...
<td width="126" colspan="3" align="left" valign="middle" class="tbltext" id="uom">&nbsp;<input name="txtuom" type="text" size="10" class="tbltext" tabindex="" maxlength="7" readonly="true" style="background-color:#CCCCCC" value="<?php echo $row_tbl_sub['uom'];?>"  />&nbsp;</td>
</tr>
<input type="hidden" name="itmdchk" value="<?php echo $itmdchk;?>" />
<tr class="Dark" height="30">
<td align="right"  valign="middle" class="tblheading">UPS as per D.C.&nbsp;</td>
<td width="361" align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtupsdc" type="text" size="10" class="tbltext" tabindex="" maxlength="6" onkeypress="return isNumberKey(event)" onchange="itemcheck();"  value="<?php echo $row_tbl_sub['ups_per_dc'];?>"  />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
<td align="right"  valign="middle" class="tblheading">Quantity as per D.C.&nbsp;</td>
<td align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtqtydc" type="text" size="10" class="tbltext" tabindex=""   maxlength="7" onkeypress="return isNumberKey(event)" onchange="upsdcchk();"  value="<?php echo $row_tbl_sub['qty_per_dc'];?>" />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>

 <tr class="Light" height="30">
<td align="right"  valign="middle" class="tblheading">UPS Good&nbsp;</td>
<td align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtupsg" type="text" size="10" class="tbltext" tabindex=""   maxlength="6" onkeypress="return isNumberKey(event)" onchange="upschk(this.value);"  value="<?php echo $row_tbl_sub['ups_good'];?>" />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>

<td align="right"  valign="middle" class="tblheading">Quantity Good&nbsp;</td>
<td align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtqtyg" type="text" size="10" class="tbltext" tabindex=""   maxlength="7" onkeypress="return isNumberKey(event)" onchange="qtychk(this.value);"  value="<?php echo $row_tbl_sub['qty_good'];?>" />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
<tr class="Dark" height="30">
<td align="right"  valign="middle" class="tblheading">UPS Damage&nbsp;</td>
<td width="361" align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtupsd" type="text" size="10" class="tbltext" tabindex=""   maxlength="6" onkeypress="return isNumberKey(event)" onchange="upschk1(this.value);"  value="<?php echo $row_tbl_sub['ups_damage'];?>" />&nbsp;</td>
<td align="right"  valign="middle" class="tblheading">Quantity Damage&nbsp;</td>
<td align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtqtyd" type="text" size="10" class="tbltext" tabindex=""  maxlength="7" onkeypress="return isNumberKey(event)" onchange="qtychk1(this.value);" value="<?php echo $row_tbl_sub['qty_damage'];?>"  />&nbsp;</td>
</tr>

 
<tr class="Light" height="30">
<td align="right"  valign="middle" class="tblheading">Excess/Shortage UPS&nbsp;</td>
<td align="left"  valign="middle" class="tbltext" >&nbsp;<input name="txtexshups" type="text" size="10" class="tbltext" tabindex="" maxlength="6" readonly="true" style="background-color:#CCCCCC" value="<?php echo $row_tbl_sub['exsh_ups'];?>"  /></td>
<td align="right"  valign="middle" class="tblheading">Excess/Shortage Quantity&nbsp;</td>
<td align="left" valign="middle" class="tbltext">&nbsp;<input name="txtexshqty" type="text" size="10" class="tbltext" tabindex="" maxlength="7" readonly="true" style="background-color:#CCCCCC"  value="<?php echo $row_tbl_sub['exsh_qty'];?>" />&nbsp;</td>
</tr>
</table>
...
$ba=0;
$up=0;
$sql_sub_sloc=mysql_query("select * from tblarr_sloc where arr_id='".$rid."' and qty_damage=0 and ups_damage=0 order by arrsloc_id") or die(mysql_error());
$tot_sub_sloc=mysql_num_rows($sql_sub_sloc);
/*$sql_sub_sloc1=mysql_query("select whid,binid,subbin from tblarr_sloc where arr_id='".$rid."' and qty_good=0 and ups_good=0") or die(mysql_error());
echo $tot_sub_sloc1=mysql_num_rows($sql_sub_sloc1);*/
$srno=1;
while($row_sub_sloc=mysql_fetch_array($sql_sub_sloc))
{

$wareh=""; $binn=""; $subbinn=""; $sups="";$sqty=0; $slocs=""; $gd=""; $slups=0; $slqty=0;
$sql_whouse=mysql_query("select perticulars from tbl_warehouse where whid='".$row_sub_sloc['whid']."'") or die(mysql_error());
$row_whouse=mysql_fetch_array($sql_whouse);
$wareh=$row_whouse['perticulars'];

$sql_binn=mysql_query("select binname from tbl_bin where binid='".$row_sub_sloc['binid']."' and whid='".$row_sub_sloc['whid']."'") or die(mysql_error());
$row_binn=mysql_fetch_array($sql_binn);
$binn=$row_binn['binname'];

$sql_subbinn=mysql_query("select sname from tbl_subbin where sid='".$row_sub_sloc['subbin']."' and binid='".$row_sub_sloc['binid']."' and whid='".$row_sub_sloc['whid']."'") or die(mysql_error());
$row_subbinn=mysql_fetch_array($sql_subbinn);
$subbinn=$row_subbinn['sname'];

$sql_issue1=mysql_query("select max(stlg_id) from tbl_stldg_good where stlg_subbinid='".$row_sub_sloc['subbin']."' and stlg_binid='".$row_sub_sloc['binid']."' and stlg_whid='".$row_sub_sloc['whid']."' and stlg_tritemid='".$f."'") or die(mysql_error());
...
//echo $t=mysql_num_rows($sql_issuetbl);
 ...
 { 
$up=$row_issuetbl['stlg_balups'];
$ba=$row_issuetbl['stlg_balqty'];
}
if($srno%2!=0)
{
...
<td align="center" valign="middle" class="tblheading"><?php echo $wareh;?><input type="hidden" name="txtslwhg<?php echo $srno?>" value="<?php echo $row_sub_sloc['whid'];?>" /></td>
<td align="center" valign="middle" class="tblheading"><?php echo $binn;?><input type="hidden" name="txtslbing<?php echo $srno?>" value="<?php echo $row_sub_sloc['binid'];?>" /></td>
<td align="center" valign="middle" class="tblheading"><?php echo $subbinn;?><input type="hidden" name="txtslsubbg<?php echo $srno?>" value="<?php echo $row_sub_sloc['subbin'];?>" /></td>
...
<td align="center" valign="middle" class="tbltext"><input type="text" name="exusp<?php echo $srno?>" class="tbltext" value="<?php echo $up;?>" readonly="true" style="background:#CCCCCC" size="3" /></td>
<td align="center" valign="middle" class="tbltext"><input type="text" name="exqty<?php echo $srno?>" class="tbltext" value="<?php echo $ba;?>" readonly="true" style="background:#CCCCCC" size="3" /></td>
</table>
</div></td>
...
<td  align="left" width="94"  valign="middle" class="tbltext">&nbsp;<input name="txtslupsg<?php echo $srno?>" id="ups<?php echo $srno?>" type="text" size="4" class="tbltext" tabindex="" maxlength="6" onkeypress="return isNumberKey(event)" onchange="upsf<?php echo $srno?>(this.value);" value="<?php echo $row_sub_sloc['ups_good'];?>"  />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>	
<td  align="right" width="44"  valign="middle" class="tblheading">&nbsp;Qty &nbsp;</td>
<td width="106" align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtslqtyg<?php echo $srno?>" id="qty<?php echo $srno?>" type="text" size="4" class="tbltext" tabindex="" maxlength="7" onkeypress="return isNumberKey(event)" onchange="qtyf<?php echo $srno?>(this.value);" value="<?php echo $row_sub_sloc['qty_good'];?>"  />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr></table></div></td>
<td align="center" valign="middle" class="tbltext"><input type="text" name="balups<?php echo $srno?>" class="tbltext" readonly="true" style="background:#CCCCCC" size="3" value="<?php echo $row_sub_sloc['ups_good']+$up;?>" /></td>
<td align="center" valign="middle" class="tbltext"><input type="text" name="balqty<?php echo $srno?>" class="tbltext" readonly="true" style="background:#CCCCCC" size="3" value="<?php echo $row_sub_sloc['qty_good']+$ba;?>" /></td><input type="hidden" name="orowid<?php echo $srno?>" value="<?php echo $row_sub_sloc['rowid'];?>" />
 </tr>
 <?php
 }
 else
...
<td align="center" valign="middle" class="tbltext"><input type="text" name="balups<?php echo $srno?>" class="tbltext" readonly="true" style="background:#CCCCCC" size="3" value="<?php echo $row_sub_sloc['ups_good']+$up;?>" /></td>
<td align="center" valign="middle" class="tbltext"><input type="text" name="balqty<?php echo $srno?>" class="tbltext" readonly="true" style="background:#CCCCCC" size="3" value="<?php echo $row_sub_sloc['qty_good']+$ba;?>" /></td>
...
$tr=mysql_num_rows($sql_issue);
//echo $t=$tr+$tblslocnog;
//$srno=1;
...
$sql_sub_sloc=mysql_query("select * from tblarr_sloc where arr_id='".$rid."' and whid='".$row_issue['stlg_whid']."' and binid='".$row_issue['stlg_binid']."' and subbin='".$row_issue['stlg_subbinid']."' and qty_damage=0 and ups_damage=0 order by arrsloc_id") or die(mysql_error());
$row_sub_sloc=mysql_fetch_array($sql_sub_sloc);

$sql_issuetbl=mysql_query("select * from tbl_stldg_good where stlg_id='".$row_issue1[0]."' and stlg_id!='".$row_sub_sloc['rowid']."' and stlg_balqty > 0") or die(mysql_error()); 
//echo $t=mysql_num_rows($sql_issuetbl);
 while($row_issuetbl=mysql_fetch_array($sql_issuetbl))
 { $cnt++;
 $wareh=""; $binn=""; $subbinn=""; $sups="";$sqty=0; $slocs=""; $gd=""; $slups=0; $slqty=0;
...
<td align="center" valign="middle" class="tbltext"><input type="text" name="balups<?php echo $srno?>" class="tbltext" value="" readonly="true" style="background:#CCCCCC" size="3" /></td>
...
<td align="center" valign="middle" class="tblheading"><input type="text" name="exqty1" class="tbltext" value="" readonly="true" style="background:#CCCCCC" size="3" /></td>
</table>
</div></td>
<td colspan="2"  valign="middle">
<div id="slocrow1">
...
<td align="center" valign="middle" class="tbltext"><input type="text" name="balups1" class="tbltext" value="" readonly="true" style="background:#CCCCCC" size="3" /></td>
<td align="center" valign="middle" class="tbltext"><input type="text" name="balqty1" class="tbltext" value="" readonly="true" style="background:#CCCCCC" size="3" /></td><input type="hidden" name="orowid1" value="0" />
...
<td align="center" valign="middle" class="tbltext"><input type="text" name="balups2" class="tbltext" value="" readonly="true" style="background:#CCCCCC" size="3" /></td>
<td align="center" valign="middle" class="tbltext"><input type="text" name="balqty2" class="tbltext" value="" readonly="true" style="background:#CCCCCC" size="3" /></td><input type="hidden" name="orowid1" value="0" />
</tr>
...
<td align="center" valign="middle" class="tbltext"><input type="text" name="balups3" class="tbltext" value="" readonly="true" style="background:#CCCCCC" size="3" /></td>
<td align="center" valign="middle" class="tbltext"><input type="text" name="balqty3" class="tbltext" value="" readonly="true" style="background:#CCCCCC" size="3" /></td><input type="hidden" name="orowid1" value="0" />
</tr>
<?php
}
else if($t==1)
...
<?php
$sql_sub_sloc=mysql_query("select * from tblarr_sloc where arr_id='".$rid."' and qty_good=0 and ups_good=0 order by arrsloc_id") or die(mysql_error());
$tot_sub_sloc=mysql_num_rows($sql_sub_sloc);
$srno=1;
while($row_sub_sloc=mysql_fetch_array($sql_sub_sloc))
{
...
$sql_issue1=mysql_query("select max(stld_id) from tbl_stldg_damage where stld_subbinid='".$row_sub_sloc['subbin']."' and stld_binid='".$row_sub_sloc['binid']."' and stld_whid='".$row_sub_sloc['whid']."' and stld_tritemid='".$f."'") or die(mysql_error());
$row_issue1=mysql_fetch_array($sql_issue1); 
...
//echo $t=mysql_num_rows($sql_issuetbl);
 while($row_issuetbl=mysql_fetch_array($sql_issuetbl))
 { 
$up=$row_issuetbl['stld_balups'];
$ba=$row_issuetbl['stld_balqty'];
}
if($srno%2!=0)
{
?>
 <tr class="Light" height="25">
<td align="center" valign="middle" class="tblheading"><?php echo $wareh;?><input type="hidden" name="txtslwhd<?php echo $srno?>" value="<?php echo $row_sub_sloc['whid'];?>" /></td>
<td align="center" valign="middle" class="tblheading"><?php echo $binn;?><input type="hidden" name="txtslbind<?php echo $srno?>" value="<?php echo $row_sub_sloc['binid'];?>" /></td>
<td align="center" valign="middle" class="tblheading"><?php echo $subbinn;?><input type="hidden" name="txtslsubbd<?php echo $srno?>" value="<?php echo $row_sub_sloc['subbin'];?>" /></td>
<td colspan="2"  valign="middle">
<div id="slcrow<?php echo $srno?>">
<table align="center" height="27" width="100%"  border="1" cellspacing="0" cellpadding="0" bordercolor="#4ea1e1" style="border-collapse:collapse" >	
<td align="center" valign="middle" class="tbltext"><input type="text" name="exuspd<?php echo $srno?>" class="tbltext" value="<?php echo $up;?>" readonly="true" style="background:#CCCCCC" size="3" /></td>
<td align="center" valign="middle" class="tbltext"><input type="text" name="exqtyd<?php echo $srno?>" class="tbltext" value="<?php echo $ba;?>" readonly="true" style="background:#CCCCCC" size="3" /></td>
</table>
</div></td>
...
<tr>
<td align="right" width="47"  valign="middle" class="tblheading">&nbsp;UPS &nbsp;</td>
<td  align="left" width="94"  valign="middle" class="tbltext">&nbsp;<input name="txtslupsd<?php echo $srno?>" id="ups<?php echo $srno+3?>" type="text" size="4" class="tbltext" tabindex="" maxlength="6" onkeypress="return isNumberKey(event)" onchange="upsf<?php echo $srno+3?>(this.value);" value="<?php echo $row_sub_sloc['ups_damage'];?>"  />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>	
<td  align="right" width="44"  valign="middle" class="tblheading">&nbsp;Qty &nbsp;</td>
<td width="106" align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtslqtyd<?php echo $srno?>" id="qty<?php echo $srno+3?>" type="text" size="4" class="tbltext" tabindex="" maxlength="7" onkeypress="return isNumberKey(event)" onchange="qtyf<?php echo $srno+3?>(this.value);" value="<?php echo $row_sub_sloc['qty_damage'];?>"  />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr></table></div></td>
<td align="center" valign="middle" class="tbltext"><input type="text" name="balupsd<?php echo $srno?>" class="tbltext" readonly="true" style="background:#CCCCCC" size="3" value="<?php echo $row_sub_sloc['ups_damage']+$up;?>" /></td>
<td align="center" valign="middle" class="tbltext"><input type="text" name="balqtyd<?php echo $srno?>" class="tbltext" readonly="true" style="background:#CCCCCC" size="3" value="<?php echo $row_sub_sloc['qty_damage']+$ba;?>" /></td>
<input type="hidden" name="dorowid<?php echo $srno?>" value="<?php echo $row_sub_sloc['rowid'];?>" />
 </tr>
 <?php
 }
 else
...
<td align="center" valign="middle" class="tbltext"><input type="text" name="balupsd<?php echo $srno?>" class="tbltext" readonly="true" style="background:#CCCCCC" size="3" value="<?php echo $row_sub_sloc['ups_damage']+$up;?>" /></td>
<td align="center" valign="middle" class="tbltext"><input type="text" name="balqtyd<?php echo $srno?>" class="tbltext" readonly="true" style="background:#CCCCCC" size="3" value="<?php echo $row_sub_sloc['qty_damage']+$ba;?>" /></td><input type="hidden" name="dorowid<?php echo $srno?>" value="<?php echo $row_sub_sloc['rowid'];?>" />
 </tr>
<?php 
 }
 $srno++;
...
$sql_sub_sloc=mysql_query("select * from tblarr_sloc where arr_id='".$rid."' and whid='".$row_issue['stld_whid']."' and binid='".$row_issue['stld_binid']."' and subbin='".$row_issue['stld_subbinid']."' and qty_good=0 and ups_good=0 order by arrsloc_id") or die(mysql_error());
$row_sub_sloc=mysql_fetch_array($sql_sub_sloc);

$sql_issuetbl=mysql_query("select * from tbl_stldg_damage where stld_id='".$row_issue1[0]."' and stld_id!='".$row_sub_sloc['rowid']."' and stld_balqty > 0") or die(mysql_error()); 
...
<tr>
<td align="right" width="47"  valign="middle" class="tblheading">&nbsp;UPS &nbsp;</td>
<td  align="left" width="94"  valign="middle" class="tbltext">&nbsp;<input name="txtslupsd<?php echo $srno?>" id="ups<?php echo $srno?>" type="text" size="4" class="tbltext" tabindex="" maxlength="6" onkeypress="return isNumberKey(event)" onchange="upsf<?php echo $srno?>(this.value);" value=""  />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>	
<td  align="right" width="44"  valign="middle" class="tblheading">&nbsp;Qty &nbsp;</td>
<td width="106" align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtslqtyd<?php echo $srno?>" id="qty<?php echo $srno?>" type="text" size="4" class="tbltext" tabindex="" maxlength="7" onkeypress="return isNumberKey(event)" onchange="qtyf<?php echo $srno?>(this.value);" value=""  />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr></table></div></td>
<td align="center" valign="middle" class="tbltext"><input type="text" name="balupsd<?php echo $srno?>" class="tbltext" value="" readonly="true" style="background:#CCCCCC" size="3" /></td>
...
<td align="center" valign="middle" class="tbltext"><input type="text" name="balupsd1" class="tbltext" value="" readonly="true" style="background:#CCCCCC" size="3" /></td>
...
<td align="center" valign="middle" class="tbltext"><input type="text" name="balupsd2" class="tbltext" value="" readonly="true" style="background:#CCCCCC" size="3" /></td>
<td align="center" valign="middle" class="tbltext"><input type="text" name="balqtyd2" class="tbltext" value="" readonly="true" style="background:#CCCCCC" size="3" /></td><input type="hidden" name="dorowid1" value="0" />
</tr>
<?php
}
else if($t==1)
