 ...
 if($srno%2!=0)
{
 ...
 ?>
  <tr class="Dark" height="25">
    <td align="center" valign="middle" class="tblheading" colspan="12">Item not in Stock</td>
  </tr>
  <?php
 }
 ?>
  <input type="hidden" name="txtupsg" value="<?php echo $totups;?>" /> <input type="hidden" name="txtqtyg" value="<?php echo $totqty;?>" />  <input type="hidden" name="srno2" value="<?php echo $srno;?>" />  <input type="hidden" name="chkbox2" value=""/>  <input type="hidden" name="srno12" value=""/>  <input type="hidden" name="edtrowid2" value="<?php echo $rid;?>" />  <input type="hidden" name="orwoid2" value="" /> <input type="hidden" name="orwoid" value="" />
</table>
...
<td align="center" valign="middle" class="tblheading">&nbsp;</td>
 ...
 ?>
   <input type="hidden" name="txtupsd" value="<?php echo $totups;?>" /> <input type="hidden" name="txtqtyd" value="<?php echo $totqty;?>" />
