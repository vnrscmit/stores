...
<option value="" >--Select Classification--</option>
 ...
 <?php 
$itemqry=mysql_query("select items_id, stores_item classification_id='".$row_tbl_sub['classification_id']."' and actstatus='Active' from tbl_stores ") or die(mysql_error());
?>            
...
<td width="361" align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtupsdc" type="text" size="10" class="tbltext" tabindex="" maxlength="5" onkeypress="return isNumberKey(event)" onchange="itemcheck();"  value="<?php echo $row_tbl_sub['ups_per_dc'];?>"  />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
...
<td align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtupsg" type="text" size="10" class="tbltext" tabindex=""   maxlength="5" onkeypress="return isNumberKey(event)" onchange="upschk(this.value);"  value="<?php echo $row_tbl_sub['ups_good'];?>" />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
...
<td width="361" align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtupsd" type="text" size="10" class="tbltext" tabindex=""   maxlength="5" onkeypress="return isNumberKey(event)" onchange="upschk1(this.value);"  value="<?php echo $row_tbl_sub['ups_damage'];?>" />&nbsp;</td>
...
<td align="left"  valign="middle" class="tbltext" >&nbsp;<input name="txtexshups" type="text" size="10" class="tbltext" tabindex="" maxlength="5" readonly="true" style="background-color:#CCCCCC" value="<?php echo $row_tbl_sub['exsh_ups'];?>"  /></td>
...
<td  align="left" width="94"  valign="middle" class="tbltext">&nbsp;<input name="txtslupsg<?php echo $srno?>" id="ups<?php echo $srno?>" type="text" size="4" class="tbltext" tabindex="" maxlength="7" onkeypress="return isNumberKey(event)" onchange="upsf<?php echo $srno?>(this.value);" value="<?php echo $row_sub_sloc['ups_good'];?>"  />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>	
...
<tr>
<td align="right" width="47"  valign="middle" class="tblheading">&nbsp;UPS &nbsp;</td>
<td  align="left" width="94"  valign="middle" class="tbltext">&nbsp;<input name="txtslupsd<?php echo $srno?>" id="ups<?php echo $srno?>" type="text" size="4" class="tbltext" tabindex="" maxlength="7" onkeypress="return isNumberKey(event)" onchange="upsf<?php echo $srno?>(this.value);" value=""  />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>	
<td  align="right" width="44"  valign="middle" class="tblheading">&nbsp;Qty &nbsp;</td>
