...
<title>stores - Transaction: Good to Damage - Output Selection </title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction: Good to Damage - Output Selection </td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
<tr class="Light" height="25">
    ...
    <td align="center"  valign="middle" class="tblheading">&nbsp;<a href="Javascript:void(0)" onclick="openslocpopprint();">Good to Damage Note (G2DN)</a></td>
</tr>
</table>
<?php
...
$sql_tbl=mysql_query("select * from tbl_stldg_good where stlg_trtype='GD' and stlg_trsubtype='$tp' and stlg_trid='".$pid."'") or die(mysql_error());
/*$row_tbl=mysql_fetch_array($sql_tbl);			
...
?>
  <tr class="tblsubtitle" height="25">
    <td width="39" align="center" class="tblheading" valign="middle">#</td>
	  <td width="185" align="center" class="tblheading" valign="middle">Classification</td>
    <td width="282" align="center" class="tblheading" valign="middle">Item</td>
    <td width="60" align="center" class="tblheading" valign="middle">UPS</td>
    <td width="60" align="center" class="tblheading" valign="middle">Qty</td>
...
<tr class="Light" height="25">
	...
	<td width="185" align="center" valign="middle" class="tblheading"><?php echo $row_class['classification'];?></td>
    <td width="282" align="center" valign="middle" class="tblheading"><?php echo $row_item['stores_item'];?></td>
...
//$sql_tbl=mysql_query("select * from tbl_stldg_damage where stld_trtype='GD' and stld_trsubtype='$tp' and stld_trid='".$pid."' group by stld_subbinid order by stld_id desc") or die(mysql_error());
/*$row_tbl=mysql_fetch_array($sql_tbl);			
$issue_id=$row_tbl['issue_id'];
*/
?>
...
<?php
$srno=1;
$sql_issue=mysql_query("select distinct stld_whid, stld_subbinid, stld_binid from tbl_stldg_damage where stld_trtype='GD' and stld_trsubtype='$tp' and stld_trid='".$pid."'") or die(mysql_error());
...
$sql_tbl=mysql_query("select * from tbl_stldg_damage where stld_id='".$row_issue1[0]."' and stld_balqty > 0") or die(mysql_error()); 
...
<tr >
<td valign="top" align="center"><a href="add_g.php"><img src="../images/back.gif" border="0"style="display:inline;cursor:pointer;" /></a>&nbsp;&nbsp;&nbsp;
