	...
	while($row_arrsub=mysql_fetch_array($sql_arrsub))
	{
		...
		while($row_arrsub_sub=mysql_fetch_array($sql_arrsub_sub))
		{
			...
			$qty=$row_arrsub_sub['qty_issue'];
				...
				$sql_sub_sub="insert into tbl_stldg_good (yearcode,stlg_trtype, stlg_trsubtype, stlg_trid, stlg_trpartyid, stlg_trdate, stlg_trclassid, stlg_tritemid, stlg_whid, stlg_binid, stlg_subbinid, stlg_opups, stlg_opqty, stlg_trups, stlg_trqty, stlg_balups, stlg_balqty) values('$yearid_id','Issue', 'eindent', '$pid', '$partyid', '$trdate', '$classid', '$itemid', '$whid', '$binid', '$subbinid', '$opups', '$opqty', '$ups', '$qty', '$balups', '$balqty')";
...
<td width="88%" align="left" valign="middle" class="tbltext" colspan="18">&nbsp;<?php echo $row2['remarks'];?>&nbsp;</td>
</tr>
</table>
