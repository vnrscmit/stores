...
$a123456=mysql_query($sql_main) or die(mysql_error());
	...
	while($row_arrsub=mysql_fetch_array($sql_arrsub))
	{
		...
		while($row_arrsub_sub=mysql_fetch_array($sql_arrsub_sub))
		{
			...
			$sql_sub_sub="insert into tbl_stldg_good (yearcode, stlg_trtype, stlg_trsubtype, stlg_trid, stlg_trpartyid, stlg_trdate, stlg_trclassid, stlg_tritemid, stlg_whid, stlg_binid, stlg_subbinid, stlg_opups, stlg_opqty, stlg_trups, stlg_trqty, stlg_balups, stlg_balqty) values('$yearid_id','Arrival', 'Vendor', '$pid', '$partyid', '$trdate', '$classid', '$itemid', '$whid', '$binid', '$subbinid', '$opups', '$opqty', '$ups', '$qty', '$balups', '$balqty')";
...
<td width="275"  align="left" valign="middle" class="tbltext">&nbsp;<?php echo "TAV".$row_tbl['arrival_code']."/".$yearid_id."/".$lgnid;
		?></td>
...
<table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#4ea1e1" style="border-collapse:collapse" >*/-->
<tr class="Dark" height="30">
<td align="center" valign="middle" class="tblheading">&nbsp;Remarks&nbsp;</td>
<td width="5%" align="left" valign="middle" class="tblheading" colspan="18">&nbsp;<?php echo $remarks;?>&nbsp;</td>
</tr>
</table>
