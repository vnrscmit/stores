...
<td align="center" valign="middle" class="tblheading"><input type="text" name="<?php echo $d?>" class="tbltext" value="<?php echo $row_sb['stlg_balups'];?>" readonly="true" style="background:#CCCCCC" size="3" /></td>
<td align="center" valign="middle" class="tblheading"><input type="text" name="<?php echo $id?>" class="tbltext" value="<?php echo $row_sb['stlg_balqty'];?>" readonly="true" style="background:#CCCCCC" size="3" /></td>
</table>