...
<title>stores - Transction-Bin Status card</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="940" height="25" class="Mainheading" >&nbsp;Transaction Arrival - Bin Status Card </span></td>
	    </tr></table></td>
...
?>
  <tr class="tblsubtitle" height="25">
    <td width="38" align="center" class="tblheading" valign="middle">#</td>
	  <td width="176" align="center" class="tblheading" valign="middle">&nbsp;Classificat
	    <?php echo $row_class['classification'];?>
	    ion</td>
...
<tr class="Light" height="25">
	...
	<td width="176" align="center" valign="middle" class="tblheading">&nbsp;</td>
...
<tr >
<td valign="top" align="center"><?php if($tp=="Vendor"){ ?><a href="select_arrivalop.php?p_id=<?php echo $pid;?>"><img src="../images/back.gif" border="0"  style="display:inline;cursor:hand;"/></a><?php } else { ?><a href="select_arrival_stocktrop.php?p_id=<?php echo $pid;?>"><img src="../images/back.gif" border="0"  style="display:inline;cursor:hand;"/></a><?php } ?>&nbsp;</td>
</tr>
</table>
</td>
<td width="30"></td>
