...
<title>stores - Transction-Vendor Note</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Goods Receipt Note - GRN</td>
	    </tr></table></td>
...
<td width="86" align="right" valign="middle" class="tblheading">&nbsp;GRN No &nbsp;</td>
<td width="272" colspan="3" align="left" valign="middle" class="tbltext">&nbsp;<?php echo "AV".$row_tbl['arr_code']."/".$lgnid;?></td>
</tr>
<?php
...
?>
<!--<tr class="Light" height="20">
<td align="right"  valign="middle" class="tblheading">Addess Office&nbsp;</td>
<td align="left"  valign="middle" class="tbltext" colspan="5">&nbsp;<?php echo $row4['address'];?></td>
</tr>
<?php
...
?>
<tr class="Light" height="20">
<td align="right"  valign="middle" class="tblheading">Address Plant&nbsp;</td>
<td align="left"  valign="middle" class="tbltext" colspan="5">&nbsp;<?php echo $row4['plant'];?></td>
</tr>-->
<tr class="Dark" height="20">
...
$sql_item=mysql_query("select * from tbl_partymaser where p_id='".$row_tbl_sub['pid']."'") or die(mysql_error());
$row_item=mysql_fetch_array($sql_item);
if($srno%2!=0)
{
...
<table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#4ea1e1" style="border-collapse:collapse" >
<tr class="Light" height="20">
<td width="141" align="right"  valign="middle" class="tblheading">&nbsp;Remarks&nbsp;</td>
...
<td width="89" align="right"  valign="middle" class="tblheading">Cst&nbsp;</td>
<td colspan="3" align="left"  valign="middle" class="tbltext">&nbsp;
  <?php echo $row_param['cst'];?></td>

<td width="130" align="right"  valign="middle" class="tblheading">Seed Licese No. &nbsp;</td>
<td width="99" colspan="3" align="left"  valign="middle" class="tbltext">&nbsp;<?php echo $row_tbl['licence_no'];?></td>
</tr>
</table>
<br />
...
<table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#4ea1e1" style="border-collapse:collapse" >
<tr class="Light">
<td align="left" valign="middle" class="tblheading" colspan="6"><font color="#FF0000">You are requested to Collect below standard material if any within a week from the date of this intimation failing which we are not</font> <font color="#FF0000">responsible for any loss or damage caused to your material .Further ,duduction wil made in the bill for the above items </font>  </td>
</tr>
</table><br />
<br />
<table align="center" border="0" width="850" cellspacing="0" cellpadding="0" bordercolor="#4ea1e1" style="border-collapse:collapse" >
...
<td width="96" align="right" valign="middle" class="smalltblheading">&nbsp;Checked By &nbsp;</td>
<td width="189" align="left" valign="middle" class="smalltbltext">&nbsp;</td>
...
<tr >
<td valign="top" align="center"><a href="select_arrivalop.php?p_id=<?php echo $pid;?>" tabindex="20"><img src="../images/back.gif" border="0"style="display:inline;cursor:hand;" /></a>&nbsp;&nbsp;<a href="Javascript:void(0)" onclick="openslocpopprint();"><img src="../images/printpreview.gif" border="0"style="display:inline;cursor:hand;" /></a></td>
</tr>
</table>
</td><td width="30"></td>
</tr>
