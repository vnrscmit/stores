...
<td width="194" align="left" valign="middle" class="tbltext">&nbsp;<?php echo "CC".$row['code']."/".$yearid_id."/".$row['ncode'];?></td>
</tr>
...
<td width="160" align="center" class="tblheading" valign="middle">Classification </td>
<td width="337" align="center" class="tblheading" valign="middle">Item </td>
<td width="65" align="center" class="tblheading" valign="middle">UoM </td>
<td width="61" align="center" class="tblheading" valign="middle">UPS</td>
<td width="59" align="center" class="tblheading" valign="middle">Quantity</td>
</tr>
