...
$sql_arr_home=mysql_query("select * from tbl_iitr where tdate between '$tdate' and '$pdate' and  iitrflg=0  order by yearcode desc, iitr_code desc LIMIT $from, $max_results") or die(mysql_error());
$tot_arr_home=mysql_num_rows($sql_arr_home);

$total_results = mysql_result(mysql_query("SELECT COUNT(*) as Num FROM tbl_iitr where tdate between '$tdate' and '$pdate' and  iitrflg=0"),0); 
 if($tot_arr_home >0) { 
   ?>
...
<tr class="Light">
         ...
         <td width="15%" align="center" valign="middle" class="tblheading"><a href="iitr_view.php?p_id=<?php echo $row_arr_home['iitr_id'];?>"><?php echo "IT".$row_arr_home['iitr_code']."/".$row_arr_home['yearcode']."/".$logid;?></a></td>
...
<tr >
<td valign="top" align="right"><a href="home_interitem.php"><img src="../images/back.gif" border="0"style="display:inline;cursor:hand;" /></a></td>
</tr>
</table>
