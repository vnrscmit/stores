...
if($trid == 0)
{
$sql_main="insert into tblissue (yearcode,issue_type, issue_code, issue_date, dcrefno, rettype, party_id, tmode, trans_name, trans_lorryrepno, trans_vehno, trans_paymode, courier_name, docket_no, pname_byhand, issue_role, rettyp) values('$yearid_id','MReturnV','$code','$tdate','$txtpdc','$txtrettype','$f','$txt1','$i','$j','$k','$txt13','$l','$m','$pname','$logid','$rettyp')";
...
{
$subid=$edtrowid;
$sql_sub="update tblissue_sub set issue_id='$mainid', classification_id='$classid', item_id='$itemid', uom='$txtuom', rettype='$txtrettype' where issuesub_id='$subid'";
