<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		{	$id=mysql_insert_id();
			...
			echo "<script>window.location='home_issuenote.php'</script>";	
		}
		//}
	//}
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;<a href="stores_home.php" style="text-decoration:underline; cursor:hand; color:#404d21;">&nbsp; Transaction Issue  </a>-  Note </td>
	    </tr></table></td>
...
<tr>
<td width="30">	 </td><td>
<table  border="1" cellspacing="0" cellpadding="0" width="887" bordercolor="#4ea1e1" style="border-collapse:collapse" align="center">
            <tr class="tblsubtitle" height="35">
              <td width="4%" rowspan="2" align="center" valign="middle" class="tblheading">#</td>
			 <td width="9%" align="center" rowspan="2" valign="middle" class="tblheading">Classification</td>
              <td width="5%" rowspan="2" align="center" valign="middle" class="tblheading">Items</td>
			...
			<tr class="<?php echo $trcls;?>" height="25">
              ...
              <td align="center" width="10%" class="smalltbltext" valign="middle" rowspan="2">&nbsp;</td>
              <td align="center" width="10%" class="smalltbltext" valign="middle">&nbsp;</td>
              <td width="14%" align="center" valign="middle" class="smalltbltext">&nbsp;</td>
              <td width="12%" align="center" valign="middle" class="smalltbltext">&nbsp;</td>
           </tr>
            <?php $srno=$srno+1;							 ?>
          </table>
		 <table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#4ea1e1" style="border-collapse:collapse" >
		  <tr>
		   <td width="12%" align="center" valign="middle" class="smalltbltext">Issue By______________________</td>
		    <td width="12%" align="center" valign="middle" class="smalltbltext">Raised By_____________________</td>
           </tr>
		   </table>
        <p>
          <?php
...
<tr >
<td valign="top" align="center"><a href="home_transction_issue.php"><img src="../images/back.gif" border="0"  style="display:inline;cursor:hand;"/></a>&nbsp;<a href="javascript:document.frmaddDept.reset()"><img src="../images/reset.gif" OnClick="myReset()"alt="reset"  border="0" style="display:inline;cursor:hand;"></a>&nbsp;<input name="Submit" type="image" src="../images/submit_1.gif" alt="Submit Value" onClick="return mySubmit();"  border="0" style="display:inline;cursor:hand;"></td>
</tr>
</table>
