...
<title>stores - Transction-STR Note</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Stock Transfer Receipt Note - STRN</td>
	    </tr></table></td>
...
<td align="left"  valign="middle" class="tbltext" colspan="5">&nbsp;<?php echo $row_tbl['stnno'];?></td>
</tr>
...
<td width="76" align="right"  valign="middle" class="tblheading">Cst&nbsp;</td>
<td colspan="3" align="left"  valign="middle" class="tbltext">&nbsp;<?php echo $row_param['cst'];?></td>

<td width="171" align="right"  valign="middle" class="tblheading">Seed Licese No. &nbsp;</td>
...
<tr >
<td valign="top" align="center"><a href="select_arrival_stocktrop.php?p_id=<?php echo $pid;?>" tabindex="20"><img src="../images/back.gif" border="0"style="display:inline;cursor:hand;" /></a>&nbsp;&nbsp;<a href="Javascript:void(0)" onclick="openslocpopprint();"><img src="../images/printpreview.gif" border="0"style="display:inline;cursor:hand;" /></a></td>
</tr>
</table>
</td><td width="30"></td>
</tr>
