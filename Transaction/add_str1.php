<?php
		...
		if(isset($_POST['frm_action'])=='submit')
	{
		...
		$strno=trim($_POST['txtstrno']);
		$strdate1=trim($_POST['txtstrdate']);
		$txt=trim($_POST['txt1']);
 	 ...
 	 $sql_in="insert into tbl_issuestock(code , tdate ,p_id , address, strno, strdate , mode , tname , lrno , vno , pmode, cname , dno) values('$code','$tdate','$classification' ,'$address','$strno','$strdate', '$txt', '$tname', '$lorryno', '$vno', '$pmode', '$cname','$dc')";
					//exit;							
		if(mysql_query($sql_in)or die(mysql_error()))
		{
			echo "<script>window.location='add_str1.php'</script>";	
		}
...
$sql_code="SELECT MAX(code) FROM tbl_issuestock ORDER BY code DESC";
...
<title>Stores- Transaction Transaction - Issue - Stock Transfer</title>
...
<tr class="Dark">
           <td width="128" align="right"  valign="middle" class="smalltblheading">Transaction ID &nbsp;</td>
           <td width="213" align="left"  valign="middle">&nbsp;</td>
		   
		   <td width="109" align="right"  valign="middle" class="smalltblheading">Issue&nbsp;Date&nbsp;</td>
           <td align="left"  valign="middle" colspan="3">&nbsp;</td>
		   </tr>
		
		 <tr class="Dark">
           <td width="128"  align="right"  valign="middle" class="smalltblheading"> Party Name&nbsp;</td>
           <td align="left"  valign="middle" colspan="5">&nbsp;</td>
		   </tr>
		   
		   <tr class="Dark" >
			 <td width="128"  align="right" valign="middle" class="smalltblheading">&nbsp;Address&nbsp;</td>
    <td colspan="5" align="left"  valign="top" class="smalltbltext">&nbsp;</td>
         </tr>
		
  <tr class="Dark">
           <td width="128" align="right"  valign="middle" class="smalltblheading">STR&nbsp;</td>
           <td align="left"  valign="middle">&nbsp;</td>
			<td width="109" align="right"  valign="middle" class="smalltblheading">ST&nbsp;</td>
           <td width="178" align="left"  valign="middle">&nbsp;</td>
			
			<td width="80" align="right"  valign="middle" class="smalltblheading">STR Date&nbsp;</td>
           <td width="128" align="left"  valign="middle">&nbsp;</td>
         </tr>
<tr class="Dark">
...
<table align="center" border="1" cellspacing="0" cellpadding="0" width="750" bordercolor="#4ea1e1" style="border-collapse:collapse">
  <tr class="tblsubtitle" height="25">
    ...
    <td width="195" align="left" class="tblheading" valign="middle">&nbsp;Classification</td>
    <td width="118" align="center" class="tblheading" valign="middle">Items</td>
    <td width="64" align="center" class="tblheading" valign="middle">UOM</td>
    <td width="65" align="center" class="tblheading" valign="middle">UPS</td>
	  <td width="64" align="center" class="tblheading" valign="middle">Quantity</td>
      <td width="69" align="center" class="tblheading" valign="middle">Edit </td>
    <td width="76" align="center" class="tblheading" valign="middle">Delete</td>
    </tr>
  <?php
...
?>
  <tr class="Light" height="25">
    <td  valign="middle" class="tbltext" align="center"><input name="date" type="text" size="6" class="tbltext" tabindex="0"  readonly="true" style="background-color:#CCCCCC" /></td>
    <td valign="middle" class="tbltext" align="left"><input name="date" type="text" size="6" class="tbltext" tabindex="0"  readonly="true" style="background-color:#CCCCCC" /></td>
    <td valign="middle" class="tbltext" align="center"><input name="date" type="text" size="6" class="tbltext" tabindex="0"  readonly="true" style="background-color:#CCCCCC" /></td>
    <td valign="middle" class="tbltext" align="center"><input name="date" type="text" size="6" class="tbltext" tabindex="0"  readonly="true" style="background-color:#CCCCCC" /></td>
    <td valign="middle" class="tbltext" align="center"><input name="date" type="text" size="6" class="tbltext" tabindex="0"  readonly="true" style="background-color:#CCCCCC" /></td>
    <td valign="middle" class="tbltext" align="center"><input name="date" type="text" size="6" class="tbltext" tabindex="0"  readonly="true" style="background-color:#CCCCCC" /></td>
...
?><tr class="Dark" height="25">
  <td width="226"  align="right"  valign="middle" class="tblheading">&nbsp;Select Classification&nbsp; </td>                                                   
            <td colspan="5" align="left"  valign="top" class="tbltext" id="vaddress">&nbsp;<select class="tbltext" name="txtwh" style="width:170px;background-color:#CCCCCC"  onchange="showUser(this.value)">
<option value="" selected>--Select classification--</option>
	<?php while($noticia = mysql_fetch_array($classqry)) { ?>
...
?> 
           ...
           <td width="189" height="24"  align="right"  valign="middle" class="tblheading">Items &nbsp;</td>
             <td colspan="5" align="left"  valign="top" class="tbltext" id="vaddress">&nbsp;<select class="tbltext" name="txtperticulars" style="width:170px;background-color:#CCCCCC">
<option value="" selected>--Select Items--</option>
</select>&nbsp;<font color="#FF0000"><a href="">Details</a>*</font>&nbsp;</td>
         </tr>
		      <tr class="Dark" height="25">
			 <td width="189"  align="right" valign="middle" class="tblheading">&nbsp;Sloc&nbsp;</td>
    <td colspan="5" align="left"  valign="top" class="tbltext" id="vaddress">&nbsp;<input type="checkbox" name="two" value="2" onClick="chk();"  />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
		 ...
		 <tr class="Light" height="25">
			 <td width="189"  align="right" valign="middle" class="tblheading">&nbsp;Sloc&nbsp;</td>
    <td colspan="5" align="left"  valign="top" class="tbltext" id="vaddress">&nbsp;<input name="txtid1" type="text" size="5" class="tbltext" tabindex=""   maxlength="5"  style="background-color:#CCCCCC"/>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
         </tr>
		<tr class="Dark" height="25">
           <td width="189" align="right" valign="middle" class="tblheading">&nbsp;UPS&nbsp;</td>
<td width="173"  align="left" valign="middle" class="tbltext">&nbsp;<input name="txtid1" type="text" size="5" class="tbltext" tabindex=""   maxlength="5"  style="background-color:#CCCCCC"/>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>

<td width="139" align="right" valign="middle" class="tblheading">Quantity&nbsp;</td>
<td width="239" colspan="3" align="left" valign="middle" class="tbltext">&nbsp;<input name="date" type="text" size="7" class="tbltext" tabindex="0"    maxlength="7" style="background-color:#CCCCCC"/>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
 ...
 <tr class="tblsubtitle" height="20">
  <td colspan="5" align="center" class="tblheading">Issue>Multiple SLOC Selection</td>
</tr>
    ...
    <td colspan="5" align="left"  valign="top" class="tbltext" id="vaddress">&nbsp;<input type="checkbox" name="two" value="2" onClick="chk();"  />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
		...
		<tr class="Dark" height="25">
           <td width="189" align="right" valign="middle" class="tblheading">&nbsp;UPS&nbsp;</td>
<td width="173"  align="left" valign="middle" class="tbltext">&nbsp;<input name="txtid1" type="text" size="5" class="tbltext" tabindex=""   maxlength="5" />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
...
<tr class="tblsubtitle" height="20">
  <td colspan="5" align="center" class="tblheading">Balance > Multiple entries</td>
</tr>
			 ...
			 <td width="11%" align="center" rowspan="2" valign="middle" class="tblheading">Sloc</td>
              <td width="12%" rowspan="2" align="center" valign="middle" class="tblheading">UPS</td>
			   <td width="11%" rowspan="2" align="center" valign="middle" class="tblheading">Qty</td>
			    <td colspan="2" height="23" align="center" valign="middle" class="tblheading">Issue Qty</td>
...
<tr >
<td valign="top" align="center"><a href="add_str.php"><img src="../images/back.gif" border="0"  style="display:inline;cursor:hand;"/></a>&nbsp;<a href="javascript:document.frmaddDept.reset()"></a>&nbsp;<input name="Submit" type="image" src="../images/submit_1.gif" alt="Submit Value" onClick="return mySubmit();"  border="0" style="display:inline;cursor:hand;"></td>
</tr>
</table>
</td><td width="30"></td>
</tr>
