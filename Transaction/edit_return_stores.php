...
<title>Stores- Transaction- Edit Return </title>
...
<tr class="tblsubtitle" height="25">
  <td colspan="4" align="center" class="tblheading">Edit Internal Material Return - Own (Good & Damage)</td>
</tr>
  <tr height="15">
...
<table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#4ea1e1" style="border-collapse:collapse" >
<?php
$sql_tbl_sub=mysql_query("select * from tblarrival_sub where arrival_id='".$tid."'") or die(mysql_error());
$subtid=0;
?>
