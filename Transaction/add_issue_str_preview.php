<?php
	...
	if(isset($_REQUEST['txtstrno']))
	{
	$txtstrno = $_REQUEST['txtstrno'];
	}
	if(isset($_REQUEST['txtstrdate']))
	{
	 $txtstrdate = $_REQUEST['txtstrdate'];
	}
...
$sql_main="update tblissue set yearcode='$yearid_id',strefno='$txtstrno', party_id='$txtcla', strdate='$sdate', tmode='$txt11', trans_name='$txttname', trans_lorryrepno='$txtlrn', trans_vehno='$txtvn', trans_paymode='$txt14', courier_name='$txtcname', docket_no='$txtdc', pname_byhand='$txtpname', remarks='$remarks', rettyp='$rettyp' where issue_id = '$pid'";
	...
	while($row_arrsub=mysql_fetch_array($sql_arrsub))
	{
		...
		while($row_arrsub_sub=mysql_fetch_array($sql_arrsub_sub))
		{
			...
			$qty=$row_arrsub_sub['qty_issue'];
				...
				$sql_sub_sub="insert into tbl_stldg_good (yearcode,stlg_trtype, stlg_trsubtype, stlg_trid, stlg_trpartyid, stlg_trdate, stlg_trclassid, stlg_tritemid, stlg_whid, stlg_binid, stlg_subbinid, stlg_opups, stlg_opqty, stlg_trups, stlg_trqty, stlg_balups, stlg_balqty) values('$yearid_id','Issue', 'stocktr', '$pid', '$partyid', '$trdate', '$classid', '$itemid', '$whid', '$binid', '$subbinid', '$opups', '$opqty', '$ups', '$qty', '$balups', '$balqty')";
...
$cntg=0;
	...
	$res_code=mysql_query($sql_code)or die(mysql_error());
		...
		if($r_chk > 0)
		$sql_code1="SELECT MAX(ncode) FROM tblissue where yearcode='$yearid_id' and issue_type='stocktr' ORDER BY ncode DESC";
		else
		$sql_code1="SELECT MAX(ncode) FROM tblissue where yearcode='$yearid_id' and  issue_type='stocktr' ORDER BY ncode DESC";
...
mysql_query($sql_gp) or die (mysql_error());
			...
			echo "<script>window.location='select_issue_strop.php?p_id=$pid'</script>";	
}
/*$a="IS";
...
<title>stores Transction Issue - Stock Transfer-Preview</title>
...
winHandle=window.open('issue_str_print.php?&pid='+pid,'WelCome','top=170,left=180,width=820,height=350,scrollbars=yes');
if(winHandle==null){
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transction Issue - Stock Transfer </td>
	    </tr></table></td>
...
<td width="204"  align="left" valign="middle" class="tbltext">&nbsp;<?php echo "TIS".$row['issue_code']."/".$yearid_id."/".$lgnid;?></td>
...
<td align="left"  valign="middle" class="tbltext" colspan="6" id="vaddress"><div align="justify" class="tbltext" style="padding:2px 5px 5px 5px"><?php echo $row3['address'];?>, <?php echo $row3['city'];?>, <?php echo $row3['state'];?></div></td>
</tr>
...
<table align="center" border="1" cellspacing="0" cellpadding="0" width="750" bordercolor="#4ea1e1" style="border-collapse:collapse">
            <tr class="tblsubtitle" height="35">
			 ...
			 <td width="17%" align="center" rowspan="2" valign="middle" class="tblheading">Classification</td>
              <td width="23%" rowspan="2" align="center" valign="middle" class="tblheading">Item</td>
...
<tr class="Dark" height="25">
              ...
              <td width="5%" align="center" valign="middle" class="smalltbltext"><?php echo $opups;?></td>
              <td valign="middle" class="smalltbltext" align="center"><?php echo $opqty;?></td>
              <td width="5%" align="center" valign="middle" class="smalltbltext"><?php echo $slups;?></td>
...
<tr class="Dark" height="30">
<td width="12%" align="right" valign="middle" class="tblheading">&nbsp;Remarks&nbsp;</td>
<td width="88%" align="left" valign="middle" class="tbltext">&nbsp;<?php echo $row['remarks'];?>&nbsp;</td>
</tr>
</table>
