...
if(document.frmaddDepartment.srno.value > 0)
{
	...
	{	//alert(document.frmaddDepartment.chkbox.value);
		...
		{
		alert('Total Distributed Quantity cannot be more than the Total Quantity to be Issued');
		return false;
...
?> 	  
		...
		<input type="hidden" name="txtid" value="<?php echo $row['issue_code'];?>" />
...
<tr class="Dark" height="25">
           ...
           <td width="213" align="left"  valign="middle">&nbsp;<?php echo "TIS".$row['issue_code']."/".$yearid_id."/".$lgnid;?></td>
		   
		   <td width="109" height="24"  align="right"  valign="middle" class="tblheading">ST &nbsp;Date&nbsp;</td>
           <td align="left"  valign="middle" colspan="3">&nbsp;<input name="txtdate" type="text" size="10" class="tbltext" tabindex="0"  readonly="true" style="background-color:#CCCCCC"  maxlength="10" value="<?php echo $tdate;?>" /></td>
		   </tr>
...
?>		   <tr class="Dark" height="25">
    ...
    <td colspan="5" align="left"  valign="top" class="tbltext" id="vaddress"><div align="justify" class="tbltext" style="padding:2px 5px 5px 5px"><?php echo $row4['address']?>, <?php echo $row4['city'];?>, <?php echo $row4['state'];?></div></td>
         </tr>
		
  <tr class="Light" height="25">
           <td width="128" height="24"  align="right"  valign="middle" class="tblheading">STR Ref.No.&nbsp;</td>
           <td align="left"  valign="middle">&nbsp;<input name="txtstrno" type="text" size="10" class="tbltext" value="<?php echo $row['strefno'];?>" tabindex="0" maxlength="25" />&nbsp;</td>
			<td width="109" height="24"  align="right"  valign="middle" class="tblheading">STR&nbsp;Date&nbsp;</td>
            <td width="171" align="left"  valign="middle">&nbsp;<input name="txtstrdate" type="text" size="10" class="tbltext" tabindex="0" maxlength="25" value="<?php echo $sdate;?>"    />&nbsp;<a href="javascript:void(0)" onClick="imgOnClick(document.frmaddDepartment.txtstrdate,-100,-100)" tabindex="6"><img src="../images/cal.gif" alt="Calender" border="0" align="absmiddle"></a><script type="text/javascript" language="javascript" src="../include/popcalender.js"></script></td>
