...
?>
	...
	winHandle=window.open('ci_list_print.php?p_id='+pid,'WelCome','top=70,left=50,width=920,height=450,scrollbars=yes');
if(winHandle==null){
...
{
echo "<script>window.location='update_list.php?p_id=$pid'</script>";	
}
else
{
echo "Bye";	
...
<title>stores- Transaction- Select Captive</title>
...
{
alert("Please select Cycle Inventory");
return false;
}
	return true;	 
}
...
<tr class="tblsubtitle" height="25">
  <td colspan="4" align="center" class="tblheading">Transaction Cycle Inventory </td>
</tr>
<tr class="Light" height="25">

<td width="85"  align="right"  valign="middle" class="tbltext">&nbsp;<input type="radio" name="fet" value="1" onClick="test1(this.value);" /></td>
<td width="223" align="left"  valign="middle" class="tblheading">&nbsp;Print Cycle Inventory List</td>
</tr>
<tr class="Dark" height="25">
<td  align="right"  valign="middle" class="tbltext">&nbsp;<input type="radio" name="fet" value="2" onClick="test1(this.value);" /></td>
<td width="223" align="left"  valign="middle" class="tblheading">&nbsp;Update Cycle Inventory List</td >
 </tr>
</table>

<table align="center" width="314" cellpadding="5" cellspacing="5" border="0" >
<tr >
<td valign="top" align="center"><a href="home_ci1.php"><img src="../images/back.gif" border="0"  style="display:inline;cursor:hand;"/></a>&nbsp;&nbsp;<input name="Submit" type="image" src="../images/next.gif" alt="next" OnClick="return mySubmit()" border="0" style="display:inline;cursor:hand;">&nbsp;<input type="hidden" name="fet1" value="" /></td>	
</tr>
</table>
