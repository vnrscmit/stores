...
/*$a="GD";
	$sql_code="SELECT MAX(code) FROM tbl_gtod ORDER BY code DESC";
...
<title>Stores-Transaction -Edit G To D</title>
...
<tr class="tblsubtitle" height="20">
  <td colspan="4" align="center" class="tblheading">Edit Good To Damage</td>
</tr>
<tr height="15"><td colspan="4" align="right" class="tblheading"><font color="#FF0000" >* </font>indicates required field&nbsp;</td></tr>

 <tr class="Dark" height="30">
 <td width="224"  align="right"  valign="middle" class="tblheading">&nbsp;Transaction Id &nbsp;</td>
<td width="359"  align="left" valign="middle" class="tbltext">&nbsp;<?php echo "TGD".$row['code']."/".$yearid_id."/".$lgnid;?></td>
...
<td align="left"  valign="middle" class="tbltext" colspan="3" id="vaddress">&nbsp;<?php echo $row4['address']?>, <?php echo $row4['city'];?>, <?php echo $row4['state'];?></td>
</tr>
<?php 
