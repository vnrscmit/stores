...
if($z1 == 0)
{
$sql_main="insert into tblarrival (yearcode,arrival_type, arrival_code, arrival_date, dcno, party_id, tmode, trans_name, trans_lorryrepno, trans_vehno, trans_paymode, courier_name, docket_no, pname_byhand, remarks, arr_role) values('$yearid_id','Vendor','$c','$tdate','$g','$f','$a','$i','$j','$k','$l','$m','$n','$pname','$y1','$logid')";
...
$sql_main="update tblarrival set arrival_type='Vendor', arrival_code='$c', arrival_date='$tdate', dcno='$g', party_id='$f', tmode='$a', trans_name='$i', trans_lorryrepno='$j', trans_vehno='$k', trans_paymode='$l', courier_name='$m', docket_no='$n', pname_byhand='$pname', remarks='$y1', arr_role='$logid' where arrival_id = '$z1'";
