<?php
	...
	$filename="Transaction-issue- Stock Transfer Out- Note".$pid ['itmid'].".doc";    
...
<title>Stores - Transaction -STON</title>
...
<td width="174" align="right" valign="middle" class="tblheading">Stock Transfer&nbsp;Date&nbsp;</td>
...
<td width="194" align="left" valign="middle" class="tbltext">&nbsp;<?php echo "IM".$row['iss_code']."/".$yearid_id."/".$row_tbl['ncode'];?></td>
</tr>
...
<td align="left"  valign="middle" class="tbltext" colspan="3" ><div align="justify" class="tbltext" style="padding:2px 5px 5px 5px"><?php echo $row3['business_name'];?><br /><?php echo $row3['address'];?>, <?php echo $row3['city'];?> - <?php echo $row3['pin'];?>, <?php echo $row3['state'];?>,<br />Ph: <?php echo $row3['std'];?>-<?php echo $row3['phone'];?>, <?php echo $row3['mob'];?><br /><?php echo $ptc;?> </div></td>
</tr>
<tr class="Light" height="20">
...
<table align="center" border="1" cellspacing="0" cellpadding="0" width="750" bordercolor="#4ea1e1" style="border-collapse:collapse">
    ...
    <td width="282" align="center" class="tblheading" valign="middle">Classification</td>
    <td width="237" align="center" class="tblheading" valign="middle">Item</td>
    <td width="49" align="center" class="tblheading" valign="middle">UOM</td>
...
<tr class="Dark" height="25">
			  ...
			  <td align="center" width="49" class="smalltbltext" valign="middle"><?php echo $row_eindent_sub['uom']?></td>
...
<td width="12%" align="center" valign="middle" class="tblheading">&nbsp;Return Status&nbsp;</td>
<td width="88%" align="left" valign="middle" class="tbltext" colspan="18">&nbsp;<?php echo $row['rettyp'];?>&nbsp;</td>
</tr>		  
		  
<tr class="Dark" height="30">
<td width="12%" align="right" valign="middle" class="tblheading">&nbsp;Remarks&nbsp;</td>
<td width="88%" align="left" valign="middle" class="tbltext" colspan="18">&nbsp;<?php echo $row['remarks'];?>&nbsp;</td>
</tr>
</table>
<br />
...
<td width="180" align="left"  valign="middle" class="tbltext">&nbsp;<?php echo $row_param['cst_no'];?></td>

<td width="120" align="right"  valign="middle" class="tblheading">Seed License No.:&nbsp;</td>
