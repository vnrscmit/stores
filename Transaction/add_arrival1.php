<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		if($sdate!="" && $edate!="")
		{
		echo "<script>window.location='add_arrival1.php?sdate=$sdate&edate=$edate'</script>";
		}
		else
		 {?>
		 <script>
...
<title>Stores- Transaction- Sloc  Home</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="809" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="810" height="25" class="Mainheading">&nbsp;Transaction - SLOC Updation</td>
	    </tr></table></td>
...
<td align="center" width="130" valign="middle" class="tblbutn" style="cursor:hand;"><a href="add_sloc.php" style="text-decoration:none; color:#FFFFFF">Add </a></td>
</tr>-->
<tr height="15" class="tbltitle" >
...
/*if(!isset($_GET['page'])) { 
  ...
  $sql_arr_home=mysql_query("select * from tbl_sloc where issuedate between '$tdate' and '$pdate' and supflg=1 order by yearcode desc, scode desc LIMIT $start, $limit") or die(mysql_error());
...
$query = "select * from tbl_sloc where issuedate between '$tdate' and '$pdate' and supflg=1 order by yearcode desc, scode desc";
...
$pagination = "";
	...
	{	
	 ...
	 $srno=($page-1)*$limit+1;
/*$sql_arr_home=mysql_query("select * from tbl_sloc where issuedate between '$tdate' and '$pdate' and supflg=1 order by yearcode desc, scode desc LIMIT $from, $max_results") or die(mysql_error());
$tot_arr_home=mysql_num_rows($sql_arr_home);

$total_results = mysql_result(mysql_query("SELECT COUNT(*) as Num FROM tbl_sloc where issuedate between '$tdate' and '$pdate' and  supflg=1"),0); */
...
<table align="center" border="1" cellspacing="0" cellpadding="0" width="700" bordercolor="#4ea1e1" style="border-collapse:collapse">
		<tr class="tblsubtitle" height="20">
			 ...
			 <td width="13%" align="center" valign="middle" class="tblheading">Date</td>
              <td width="27%" align="center" valign="middle" class="tblheading">Classification</td>
...
$itemqry1=mysql_query("select * from tbl_stores where items_id='".$row_arr_home['items_id']."'") or die(mysql_error());
...
<tr class="Light">
         ...
         <td width="15%" align="center" valign="middle" class="tblheading"><a href="add_sloc_view.php?p_id=<?php echo $row_arr_home['slid'];?>"><?php echo "SU".$row_arr_home['scode']."/".$row_arr_home['yearcode']."/".$srole;?></a></td>
		 <td width="13%" align="center" valign="middle" class="tblheading"><?php echo $trdate;?></td>
         <td width="27%" align="center" valign="middle" class="tblheading"><?php echo $noticia_class['classification'];?></td>
         <td width="40%" align="center" valign="middle" class="tblheading"><?php echo $row_itm['stores_item']?></td>
         </tr>
<?php
}
else
