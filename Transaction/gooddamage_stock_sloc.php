...
<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		{	$id=mysql_insert_id();
			...
			echo "<script>window.location='select_d2gn.php'</script>";	
		}
		//}
	//}
...
<title>stores- Transaction - home D to G </title>
...
<table width="1003" height="600" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    <td valign="top"><table width="231" height="72" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr>
          <td width="231" valign="top"><div class="headerwrapper">
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;<a href="stores_home.php" style="text-decoration:underline; cursor:hand; color:#404d21;"></a>&nbsp; Transaction - home D to G </td>
	    </tr></table></td>
...
<td align="left" valign="middle" class="tbltext">&nbsp;<input name="txtexshqty" type="text" size="10" class="tbltext" tabindex="" maxlength="7" readonly="true" style="background-color:#CCCCCC"  />&nbsp;&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
		 ...
		 <tr class="tblsubtitle" height="20">
  <td colspan="6" align="center" class="tblheading">Transfer To Good</td>
</tr>
<tr class="Dark" height="30">
<td align="right"  valign="middle" class="tblheading">WH&nbsp;</td>
