<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		$filename="Report-Good Receipt Note-".$itmid ['itmid'].".doc";    
...
<td width="219" colspan="3" align="left" valign="middle" class="tbltext">&nbsp;<?php echo "AV".$row_tbl['arr_code']."/".$row_tbl['yearcode']."/".$row_tbl['ncode'];?></td>
</tr>
<?php
...
<td align="left"  valign="middle" class="tbltext" colspan="5"><div align="justify" class="tbltext" style="padding:2px 5px 5px 5px"><?php echo $row3['business_name'];?><br /><?php echo $row3['address'];?>, <?php echo $row3['city'];?> - <?php echo $row3['pin'];?>, <?php echo $row3['state'];?>, <?php echo $row3['country'];?><br />Ph: <?php echo $row3['mob'];?>, <?php echo $row3['std'];?>-<?php echo $row3['phone'];?> </div></td>
</tr>
<tr class="Dark" height="20">
...
?>
			<tr class="tblsubtitle" height="20">
			 ...
			 <td width="18%" align="center" rowspan="3" valign="middle" class="tblheading">Classification</td>
			  ...
			  <td width="8%" rowspan="3" align="center" valign="middle" class="tblheading">UoM</td>
...
<tr class="Light" height="20">
			 ...
			 <td width="8%" align="center" valign="middle" class="tblheading"><?php echo $row_item['uom'];?></td>
...
<tr >
<td align="right" colspan="3"><a href="word_class.php?itmid=<?php echo $itmid?>"><img src="../images/mswordicon.jpg" border="0" class="butn" height="30" width="30" alt="Export to MS-Word" style="cursor:pointer"   /></a>&nbsp;&nbsp;&nbsp;<img src="../images/Vista-printer.png" height="29" width="35" border="0" onClick="javascript:window.print();" class="butn" style="cursor:pointer"   />&nbsp;&nbsp;<img src="../images/close_icon2.jpg" height="30" width="22" border="0" onClick="window.close()"  target="_blank" class="butn" style="cursor:pointer"   />&nbsp;&nbsp;</td>
</tr>
</table>
</td></tr>
</table>
