<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		if($sdate1!="" && $edate1!="")
		{
		echo "<script>window.location='home_transction_issue_internal1.php?sdate=$sdate1&edate=$edate1'</script>";
		}
		else
		{
		echo "<script>window.location='home_transaction_issue_internal.php'</script>";
		}
	}
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="820" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="810" height="25">&nbsp;Issue Types - Internal Issue - Physical Indent</td>
	    </tr></table></td>
...
$targetpage = $PHP_SELF; 
  ...
  $sql_arr_home=mysql_query("select * from tblissue where issue_type='pindent' and issuetrflag=1 order by yearcode desc, iss_code desc LIMIT $start, $limit") or die(mysql_error());
...
$query = "select * from tblissue where issue_type='pindent' and issuetrflag=1 order by yearcode desc, iss_code desc";
...
$sql_arr_home=mysql_query("select * from tblissue where issue_type='pindent' and issuetrflag=1 order by yearcode desc, iss_code desc LIMIT $from, $max_results") or die(mysql_error());
$tot_arr_home=mysql_num_rows($sql_arr_home);
...
<tr >
<td valign="top" align="right"><a href="select_transction_issue_internal.php"><img src="../images/back.gif" border="0"style="display:inline;cursor:hand;" /></a></td>
</tr>
</table>
</td><td width="30"></td>
</tr>
