...
<title>stores - Tranasction-Bin card Captive Consumption</title>
...
$sql_tbl=mysql_query("select * from tbl_stldg_good where stlg_trtype='cc' and stlg_trsubtype='cc' and stlg_trid='".$pid."'") or die(mysql_error());
