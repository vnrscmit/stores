...
<td align="center" valign="middle" class="tblheading" colspan="4">&nbsp;</td>
 ...
 <input type="hidden" name="srno" value="<?php echo $srno;?>" /> <input type="hidden" name="chkbox" value=""/> <input type="hidden" name="srno1" value=""/><input type="hidden" name="edtrowid" value="<?php echo $rid;?>" /><input type="hidden" name="trid" value="<?php echo $trid?>" />
</table>
