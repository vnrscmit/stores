<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		{	$id=mysql_insert_id();
			...
			echo "<script>window.location='home_transction_issue.php'</script>";	
		}
		//}
	//}
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="809" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#b9d647" >
	    <tr >
	      <td width="810" height="25">&nbsp;Transction Arrival Issue </td>
	    </tr></table></td>
...
<a href="add_transction_issue.php" style="text-decoration:none; color:#000000"><td align="center" width="130" valign="middle" class="subheading" style="cursor:hand;">Add Issue</td></a>
</tr>
...
<td width="30">	 </td><td><table  border="1" cellspacing="0" cellpadding="0" width="974" bordercolor="#b9d647" style="border-collapse:collapse">
           ...
           <td width="16%" align="center" valign="middle" class="smalltbltext">&nbsp;</td>
              <td width="16%" align="center" valign="middle" class="smalltbltext">&nbsp;</td>
              <td valign="middle" class="tbltext" align="center"><a href="edit_transction_issue.php"><img src="../images/edit.png" border="0" /></a></td>
