...
*/
	...
	*/
	...
	if(isset($_POST['frm_action'])=='submit')
	{
			...
			if($printopt == "1" )
			{
				echo "<script>window.location='pindent_note.php?p_id=$pid'</script>";	
			}
			else if($printopt =="2")
			{
				echo "<script>window.location='bincard_pindnet_print.php?p_id=$pid&tp=pindent'</script>";	
			}
			else
			{
...
<title>stores - Transction-Physical Indent O/P</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction: Issue Internal - P-Indent - Output Selection </td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
<tr class="Light" height="25">
    ...
    <td align="center"  valign="middle" class="tblheading">&nbsp;&nbsp;<a href="Javascript:void(0)" onclick="openslocpopprint();">P-Indent Issue Note</a></td>
</tr>
</table>
<?php
...
$sql_tbl=mysql_query("select * from tbl_stldg_good where stlg_trtype='Issue' and stlg_trsubtype='pindent' and stlg_trid='".$pid."'") or die(mysql_error());
/*$row_tbl=mysql_fetch_array($sql_tbl);			
...
<tr >
<td valign="top" align="center"><a href="home_transction_issue_internal.php"><img src="../images/back.gif" border="0"style="display:inline;cursor:hand;" /></a>&nbsp;&nbsp;&nbsp;
