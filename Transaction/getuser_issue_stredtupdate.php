...
$sql_sub="update tblissue_sub set issue_id='$mainid', classification_id='$classid', item_id='$itemid', ups_indent='$txtups', qty_indent='$txtqty', uom='$txtuom' where issuesub_id='".$edtrowid."'";
