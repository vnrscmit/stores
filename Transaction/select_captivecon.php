...
if($printopt == "1" )
{
	echo "<script>window.location='captive_consumption_note.php?p_id=$pid'</script>";	
}
if($printopt=="2")
{
echo "<script>window.location='home1_bincard_print.php?p_id=$pid&tp=Internalreturn'</script>";}
...
<td width="85"  align="right"  valign="middle" class="tbltext">&nbsp;<input type="radio" name="fet" value="1" onClick="test1(this.value);" /></td>
    <td width="223" align="left"  valign="middle" class="tblheading">&nbsp;Captive Consumption
	 Note </td>
</tr>
