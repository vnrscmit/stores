...
//$a="c";
	//$a="c";
	$sql_code="SELECT MAX(arrival_code) FROM tblarrival where yearcode='$yearid_id' and  ORDER BY arrival_code DESC";
...
<title>stores - Transaction - Arrival from Vendor - Preview- Preview</title>
...
<td width="275"  align="left" valign="middle" class="tbltext">&nbsp;<?php echo "AV".$row_tbl['arrival_code']."/".$yearid_id;?></td>
