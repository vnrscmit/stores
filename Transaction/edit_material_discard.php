...
//}}
//}
$sql_code="SELECT MAX(tcode) FROM tbl_discard ORDER BY tcode DESC";
...
<title>stores - Transaction - Add material Discard</title>
...
<td width="564" align="left"  valign="middle" class="tbltext" style=" border-color:#4ea1e1" colspan="3">&nbsp;<input type="text" class="tbltext" name="txtaddress" size="70" maxlength="70" value="<?php echo $row['address'];?>" >&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
<tr class="Dark" height="30">
<td width="180" align="right"  valign="middle" class="tblheading" style=" border-color:#4ea1e1">&nbsp;Address 2&nbsp;</td>
<td width="564" align="left"  valign="middle" class="tbltext" style=" border-color:#4ea1e1" colspan="3">&nbsp;<input type="text" class="tbltext" name="txtaddress1" size="70" maxlength="70" value="<?php echo $row['address1'];?>" >&nbsp;</td>
</tr>
<tr class="Light" height="30">
<td width="180" align="right"  valign="middle" class="tblheading" style=" border-color:#4ea1e1">&nbsp;City/Town/Village&nbsp;</td>
<td width="564" align="left"  valign="middle" class="tbltext" style=" border-color:#4ea1e1" colspan="3">&nbsp;<input type="text" class="tbltext" name="txtcity" size="50" maxlength="50" value="<?php echo $row['city'];?>" >&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
<tr class="Dark" height="30">
<td width="180" align="right"  valign="middle" class="tblheading" style=" border-color:#4ea1e1">&nbsp;Pin&nbsp;</td>
<td width="564" align="left"  valign="middle" class="tbltext" style=" border-color:#4ea1e1" colspan="3">&nbsp;<input type="text" class="tbltext" name="txtpin" size="6" maxlength="6" value="<?php if($row['pin'] > 0){ echo $row['pin'];} else { echo "";}?>" onkeypress="return isNumberKey(event)" >&nbsp;</td>
</tr>
<tr class="Light" height="30">
...
<td width="564" align="left"  valign="middle" class="tbltext" style=" border-color:#4ea1e1" colspan="3">&nbsp;<input type="text" class="tbltext" name="txtphone" size="15" maxlength="15" value="<?php echo $row['phoneno'];?>" onkeypress="return isNumberKey(event)" >&nbsp;</td>
</tr>
  <tr class="Light" height="25">
...
<table id="transmode" align="center" border="1" width="750" cellspacing="0" cellpadding="0" bordercolor="#4ea1e1" style="display:<?php if($row['tmode'] != "") { echo "Block"; } else { echo "none";} ?>" > 
<tr class="Dark" height="25">
...
?>		  
 <tr class="Light" height="20">
             <td width="3%" align="center" valign="middle" class="tblheading"><?php echo $sr;?></td>
			 <td width="16%" align="center" valign="middle" class="tblheading"><?php echo $noticia_class['classification'];?></td>
             <td width="20%" align="center" valign="middle" class="tblheading"><?php echo $noticia_item['stores_item'];?></td>
			 <td align="center" valign="middle" class="tblheading"><?php echo $noticia_item['uom'];?></td>
             <td align="center" valign="middle" class="tblheading"><?php echo $opups;?></td>
             <td width="5%" align="center" valign="middle" class="tblheading"><?php echo $opqty;?></td>
             <td width="4%" align="center" valign="middle" class="tblheading"><?php echo $slups;?></td>
             <td width="6%" align="center" valign="middle" class="tblheading"><?php echo $slqty;?></td>
			<td width="4%" align="center" valign="middle" class="tblheading"><?php echo $balups;?></td>
             <td width="6%" align="center" valign="middle" class="tblheading"><?php echo $balqty;?></td>
