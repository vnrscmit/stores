...
<title>stores - Transaction Issue -Bin Status Card</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="940" height="25" class="Mainheading" >&nbsp;Transaction Issue -Bin Status Card </td>
	    </tr></table></td>
...
<tr >
<td valign="top" align="center"><a href="select_issue_pindentop.php?p_id=<?php echo $pid;?>"><img src="../images/back.gif" border="0"  style="display:inline;cursor:hand;"/></a>&nbsp;&nbsp;<input name="Submit" type="image" src="../images/next.gif" alt="next" OnClick="return mySubmit()" border="0" style="display:inline;cursor:hand;" />&nbsp;<input type="hidden" name="fet1" value="" /></td>	
</tr>
</table>
</td>
<td width="30"></td>
