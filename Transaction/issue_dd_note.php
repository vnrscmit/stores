...
<title>stores - Transction-Material Discard Note</title>
...
alert(itm);
winHandle=window.open('issue_dd_print.php?p_id='+itm,'WelCome','top=170,left=180,width=820,height=450,scrollbars=yes');
if(winHandle==null){
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">Material Discard Note</td>
	    </tr></table></td>
...
<tr class="tblsubtitle" height="20">
  <td colspan="6" align="center" class="tblheading">Material Discard Note</td>
</tr>

<tr class="Dark" height="30">
<td width="174" align="right" valign="middle" class="tblheading">&nbsp;Transaction Id &nbsp;</td>
<td width="204"  align="left" valign="middle" class="tbltext">&nbsp;<?php echo "DD".$row['tcode'];?></td>
...
<td align="left"  valign="middle" class="tbltext" colspan="3" id="vaddress">&nbsp;<?php echo $row['address'];?></td>
</tr>
...
<table align="center" border="1" cellspacing="0" cellpadding="0" width="750" bordercolor="#4ea1e1" style="border-collapse:collapse">
			 ...
			 <td width="16%" align="center" rowspan="3" valign="middle" class="tblheading">Classification</td>
              <td width="20%" rowspan="3" align="center" valign="middle" class="tblheading">Items</td>
			  <td width="5%" rowspan="3" align="center" valign="middle" class="tblheading">UOM</td> 
			  
			                 <td colspan="5"  align="center" valign="middle" class="tblheading">Quantity</td>
                  <td colspan="2" rowspan="2" align="center" valign="middle" class="tblheading">Damage</td>
              </tr>
			<tr class="tblsubtitle">
			  <td colspan="3" align="center" valign="middle" class="tblheading">Stock</td>
...
?>		  
 <tr class="Light" height="20">
             ...
             <td align="center" valign="middle" class="tblheading"><?php echo $opups1;?></td>
             <td width="5%" align="center" valign="middle" class="tblheading"><?php echo $opqty1;?></td>
             <td width="4%" align="center" valign="middle" class="tblheading"><?php echo $balups1;?></td>
             <td width="6%" align="center" valign="middle" class="tblheading"><?php echo $balqty1;?></td>
...
<table align="center" border="1" width="750" cellspacing="0" cellpadding="0" bordercolor="#4ea1e1" style="border-collapse:collapse" >
<tr class="Dark" height="30">
<td width="64" align="right"  valign="middle" class="tblheading">&nbsp;Type&nbsp;</td>
<td width="680" align="left"  valign="middle" class="tbltext">&nbsp;<?php echo $row['rettyp'];?></td>
</tr>
<tr class="Dark" height="30">
