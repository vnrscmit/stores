...
$sql_in1=mysql_query("select * from tbl_dtog where did=$trid") or die(mysql_error());
...
$sql_subtbl=mysql_query("select * from tbl_dtog_sub where did='".$trid."'and rowid='".$stldgid."'") or die(mysql_error());
...
//$srno=1;
//echo $t[0];
$sql_issue=mysql_query("select * from tbl_dtog_sub where dgsubid='".$p1_array[$ct]."'") or die(mysql_error());
$totups=0; $totqty=0; 
 while($row_issue=mysql_fetch_array($sql_issue))
 { 
  $up=$row_issue['opups'];
...
<td align="center" valign="middle" class="tbltext"><input type="text" name="balupsg<?php echo $srno?>" class="tbltext" value="<?php echo $up+$ups;?>"  size="3" /></td>
<td align="center" valign="middle" class="tbltext"><input type="text" name="balqtyg<?php echo $srno?>" class="tbltext" value="<?php echo $qt+$qty;?>" readonly="true" style="background:#CCCCCC" size="3" /></td> <input type="hidden" name="dorowid<?php echo $srno?>" value="<?php echo $row_issue['rowid'];?>" />
</tr>
 <?php
 }
 else
