...
if(isset($_POST['frm_action'])=='submit')
	{
	    ...
	    $sql_in="update tbl_opr set login='$login',
									pass='$pass',
									email='$email'
									where id='$loginid'";
											//exit;
...
<title>stores - Transaction-operator Role</title>
...
<!-- actual page start--->	
 ...
 <?php
	$result=mysql_query("SELECT * FROM tbl_opr where id='".$loginid."'")or die(mysql_error()); 
