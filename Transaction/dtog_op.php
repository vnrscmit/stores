...
<tr class="tblsubtitle" height="35">
			...
			<tr class="<?php echo $trcls;?>" height="25">
              ...
              <td align="center" class="smalltbltext" valign="middle"><select class="tbltext" name="txtwh" style="width:100px;"  onchange="showUser(this.value)">
<option value="" selected>--Select WH--</option>
	<?php while($noticia = mysql_fetch_array($quer3)) { ?>
		...
		<?php } ?>
			  ...
			  <td align="center" width="14%" class="smalltbltext" valign="middle" rowspan="2"><select class="tbltext" name="txtwh" style="width:100px;"  onchange="showUser(this.value)">
<option value="" selected>--Select WH--</option>
	<?php while($noticia = mysql_fetch_array($quer3)) { ?>
		<option value="<?php echo $noticia['whid'];?>" />   
		<?php echo $noticia['perticulars'];?>
