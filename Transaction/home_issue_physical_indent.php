<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		{*/
			echo "<script>window.location='home_issue_physical_indent.php'</script>";	
		}
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="809" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#b9d647" >
	    <tr >
	      <td width="810" height="25">&nbsp;Transction Issue Physical Indents </td>
	    </tr></table></td>
...
<a href="add_issu_physical_indent.php" style="text-decoration:none; color:#000000"><td align="center" width="130" valign="middle" class="subheading" style="cursor:hand;">Add Issue</td></a>
</tr>
...
<tr>
<td>
<td width="30">	 </td><td><table  border="1" cellspacing="0" cellpadding="0" width="974" bordercolor="#b9d647" style="border-collapse:collapse"> 
<tr class="tblsubtitle" height="35">
              <td width="4%" rowspan="2" align="center" valign="middle" class="tblheading">#</td>
			 <td width="8%" align="center" rowspan="2" valign="middle" class="tblheading">Classification</td>
			...
			<tr class="<?php echo $trcls;?>" height="25">
              ...
              <td align="center" width="8%" class="smalltbltext" valign="middle" rowspan="2">&nbsp;</td>
              <td align="center" width="8%" class="smalltbltext" valign="middle">&nbsp;</td>
              <td align="center" width="8%" class="smalltbltext" valign="middle">&nbsp;</td>
...
<tr >
<td valign="top" align="center"><a href="home_issue_physical_indent.php"><img src="../images/back.gif" border="0"  style="display:inline;cursor:hand;"/></a>&nbsp;<a href="javascript:document.frmaddDept.reset()"><img src="../images/reset.gif" OnClick="myReset()"alt="reset"  border="0" style="display:inline;cursor:hand;"></a>&nbsp;<input name="Submit" type="image" src="../images/submit_1.gif" alt="Submit Value" onClick="return mySubmit();"  border="0" style="display:inline;cursor:hand;"></td>
</tr>
</table>
</td><td width="30"></td>
</tr>
