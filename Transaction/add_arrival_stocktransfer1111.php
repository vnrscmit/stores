<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		echo "<script>window.location='add_arrival_stock_preview.php?p_id=$p_id'</script>";	
...
function clk(opt)
{
	if(document.frmaddDepartment.txtstno.value!="")
	{
	if(opt!="")
	{
		if(opt=="Transport")
...
{
alert("Please select Stock Transfer first");
document.frmaddDepartment.txtstno.value="";
}
}
...
if(document.frmaddDepartment.txtstno.value=="")
{
alert("Please enter Stock Transfer first");
...
if(document.frmaddDepartment.txtcla.value=="")
	...
	if(document.frmaddDepartment.txtstno.value=="")
	{
	alert("Please enter S.T.N. NO.");
	document.frmaddDepartment.txtstno.focus();
	return false;
	}
	
	if(document.frmaddDepartment.txtstno.value.charCodeAt() == 32)
	{
	alert("S.T. NO. cannot start with space.");
	document.frmaddDepartment.txtstno.focus();
	return false;
	}
	...
	if(document.frmaddDepartment.txt11.value=="Transport")
	{
		...
		{
		alert("Transport Name cannot start with spsace.");
		document.frmaddDepartment.txttname.focus();
		return false;
		}
...
<td width="254"  align="left" valign="middle" class="tbltext">&nbsp;<input name="txtid" type="text" size="5" class="tbltext" tabindex="" readonly="true" style="background-color:#CCCCCC"  value="<?php echo $code1?>"/></td>
...
<td align="left"  valign="middle" class="tbltext" >&nbsp;<select class="tbltext" name="txtcla" style="width:150px;" onchange="showUser(this.value,'saddress','Stock & Transfer','','');">
<option value="" selected="selected">--Select Stock--</option>
	...
	<td align="right"  valign="middle" class="tblheading">STN Number &nbsp;</td>
<td align="left"  valign="middle" class="tbltext" colspan="3">&nbsp;<input name="txtstno" type="text" size="20" class="tbltext" tabindex="" maxlength="20"  onchange="stnochk();" />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
          </tr>

<!--
/*<tr class="Dark" height="30">
<td align="right"  valign="middle" class="tblheading">S. T. N. Number&nbsp;</td>
<td align="left"  valign="middle" class="tbltext" colspan="5">&nbsp;<input name="txtstno" type="text" size="20" class="tbltext" tabindex="" maxlength="20"  onchange="stockchk();" />  &nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
*/-->
<?php
...
<td align="left"  valign="middle" class="tbltext" colspan="5" id="saddress">&nbsp;&nbsp; </td>
</tr>
