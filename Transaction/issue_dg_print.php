...
<title>Stores- Tranasaction- Damage To Good</title>
...
<tr class="Dark" height="30">
 <td width="207"  align="right"  valign="middle" class="tblheading">&nbsp;Transaction Id&nbsp;</td>
<td width="341"  align="left" valign="middle" class="tbltext">&nbsp;<?php echo "TDG".$row['code']."/".$yearid_id."/".$lgnid;?></td>

<td width="40" align="right" valign="middle" class="tblheading">&nbsp;Date&nbsp;</td>
<td width="152" align="left" valign="middle" class="tbltext">&nbsp;<?php echo $tdate;?></td>
</tr>
<?php 
...
?>
		 <tr class="Light" height="25">
           <td width="207"  align="right"  valign="middle" class="tblheading">&nbsp;Classification&nbsp; </td>                                   
...
?> 
		<tr class="Dark" height="25">
           <td width="207" height="24"  align="right"  valign="middle" class="tblheading">Stores Item&nbsp;</td>
           <td align="left"  valign="middle" id="item" class="tbltext">&nbsp;<?php echo $noticia_item['stores_item'];?>&nbsp;</td>
    
            <td width="40" height="24"  align="right"  valign="middle" class="tblheading">UoM&nbsp;</td>
