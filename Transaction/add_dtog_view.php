...
$sql_main="update tbl_dtog set classification_id='$classid' , items_id='$itemid' , uom='$txtuom', remarks='$txtremarks' where did='".$pid."'";
...
if(isset($_POST['frm_action'])=='submit')
	...
	$sql_arr=mysql_query("select * from tbl_dtog where did='".$pid."'") or die(mysql_error());
	while($row_arr=mysql_fetch_array($sql_arr))
	{
		$trdate=$row_arr['date'];
	
	$sql_sub=mysql_query("SELECT sum(ups),sum(qty),rowid FROM `tbl_dtog_sub` where did='".$pid."' group by rowid") or die(mysql_error());
	while($row_sub=mysql_fetch_array($sql_sub))
	{
		...
		$sql_iss1=mysql_query("select * from tbl_stldg_damage where stld_id='".$rowid."'") or die(mysql_error());
		$row_iss1=mysql_fetch_array($sql_iss1); 
		
		$whid1=$row_iss1['stld_whid'];
		$binid1=$row_iss1['stld_binid'];
		$subbinid1=$row_iss1['stld_subbinid'];
		$classid1=$row_iss1['stld_trclassid'];
		$itemid1=$row_iss1['stld_tritemid'];
		
		$sql_issue1=mysql_query("select max(stld_id) from tbl_stldg_damage where stld_subbinid='".$subbinid1."' and stld_binid='".$binid1."' and stld_whid='".$whid1."'") or die(mysql_error());
		...
		$opups1=$row_issuetbl['stld_balups'];
		$opqty1=$row_issuetbl['stld_balqty'];
		$balups1=$opups1-$oups;
		$balqty1=$opqty1-$oqty;
				
				$sql_sub_sub1="insert into tbl_stldg_damage (stld_trtype, stld_trsubtype, stld_trid, stld_trdate, stld_trclassid, stld_tritemid, stld_whid, stld_binid, stld_subbinid, stld_opups, stld_opqty, stld_trups, stld_trqty, stld_balups, stld_balqty) values('DG', 'DG', '$pid', '$trdate', '$classid1', '$itemid1', '$whid1', '$binid1', '$subbinid1', '$opups1', '$opqty1', '$oups', '$oqty', '$balups1', '$balqty1')";
				mysql_query($sql_sub_sub1) or die(mysql_error());
				
				
	$sql_arrsub=mysql_query("select * from tbl_dtog_sub where did='".$pid."' and rowid='".$rowid."'") or die(mysql_error());
	while($row_arrsub=mysql_fetch_array($sql_arrsub))
	{
		...
		$sql_issue2=mysql_query("select max(stlg_id) from tbl_stldg_good where stlg_subbinid='".$subbinid."' and stlg_binid='".$binid."' and stlg_whid='".$whid."'") or die(mysql_error());
		...
		$sql_sub_sub="insert into tbl_stldg_good (stlg_trtype, stlg_trsubtype, stlg_trid, stlg_trdate, stlg_trclassid, stlg_tritemid, stlg_whid, stlg_binid, stlg_subbinid, stlg_opups, stlg_opqty, stlg_trups, stlg_trqty, stlg_balups, stlg_balqty) values('DG', 'DG', '$pid', '$trdate', '$classid', '$itemid', '$whid', '$binid', '$subbinid', '$opups', '$opqty', '$ups', '$qty', '$balups', '$balqty')";
			...
			echo "<script>window.location='select_dg_op.php?p_id=$pid'</script>";	*/
		
	}

/*$a="DG";
	$sql_code="SELECT MAX(code) FROM tbl_dtog  where yearcode='$yearid_id' ORDER BY code DESC";
...
<title>Stores - Transaction - Damage To Good- View</title>
...
winHandle=window.open('issue_dg_print.php?&pid='+pid,'WelCome','top=170,left=180,width=820,height=350,scrollbars=yes');
if(winHandle==null){
        ...
        <tr>
          <td valign="top"><div class="headerwrapper">
            ...
            <ul  id="nav">
             ...
             <li><a href="#"> Masters </a>
              <ul>
                <li><a href="../Masters/home_classification.php" 

>&nbsp;Classification&nbsp;Master</a></li>
				...
				<li><a href="../Masters/viewers_home.php" 

>&nbsp;Viewers&nbsp;Master</a></li>
				<li><a href="../Masters/home_report.php" 

>&nbsp;Reports&nbsp;Master</a></li>
                <li><a href="../Masters/companyhome.php" >&nbsp;Parameters&nbsp;Master</a></li>
                <li><a href="../Masters/current_year.php" 

>&nbsp;Year&nbsp;Management&nbsp;Master</a></li>
              </ul>
            </li>
            <li><a href="#">Transactions </a>
             <ul>
				...
				<li><a href="home_interitem.php" 

>&nbsp;Inter&nbsp;Item&nbsp;Transfer</a></li>
				<li><a href="home_openstock.php" 
...
>&nbsp;Opening&nbsp;Stock</a></li>
			...
			<li><a href="#">Transactions </a>
              <ul>
				...
				<li><a href="add_discard.php" 

>&nbsp;Material&nbsp;Discard</a></li>
				<li><a href="home_ci1.php" 

>&nbsp;Cycle&nbsp;Inventory</a></li>
                <li><a href="add_arrival.php" >&nbsp;SLOC&nbsp;Updation</a></li>
				<li><a href="reorder.php" 

>&nbsp;Order&nbsp;Placement&nbsp;at&nbsp;Reorder</a></li>
             </ul>
            </li>
			<?php
			}
            ...
            <li><a href="#"> Reports </a>
              <ul>
                <li><a href="../reports/stockonhandreport.php" 

>&nbsp;Stock&nbsp;on&nbsp;Hand&nbsp;Report</a></li>
                <li><a href="../reports/partywiseperiodreport.php" 

>&nbsp;Party&nbsp;wise&nbsp;Stock&nbsp;Report</a></li>
                <li><a href="../reports/storesitamledger.php" 

>&nbsp;Stores&nbsp;Item&nbsp;Ledger&nbsp;Report</a></li>
				<li><a href="../reports/stocktransferreport.php" 

>&nbsp;Stock&nbsp;Transfer&nbsp;Report</a></li>
				<li><a href="../reports/captiveconsumptionreport.php" 

>&nbsp;Captive&nbsp;Consumption&nbsp;Report</a></li>
                <li><a href="../reports/discardreport.php" >&nbsp;Discard&nbsp;Report</a></li>
                <li><a href="../reports/reorderlevelreport.php" 

>&nbsp;Reorder&nbsp;Level&nbsp;Report</a></li>
				 <li><a href="../reports/reorderlevelreport.php" 

>&nbsp;Reorder&nbsp;Level&nbsp;Report</a></li>
				 <li><a href="../reports/slocreport.php" 

>&nbsp;SLOC&nbsp;Status&nbsp;Report</a></li> 
				<?php
			  if($role == "admin")
			  {
			  ?>
...
<tr class="tblsubtitle" height="20">
  <td colspan="4" align="center" class="tblheading">Damage To Good</td>
</tr>
<tr class="Dark" height="30">
 <td width="265"  align="right"  valign="middle" class="tblheading">&nbsp;Transaction Id&nbsp;</td>
<td width="318"  align="left" valign="middle" class="tbltext">&nbsp;<?php echo "DG".$row['dcode']."/".$yearid_id."/".$lgnid;?></td>
...
<tr class="tblsubtitle" height="25">
    ...
    <td width="108" align="center" valign="middle" class="tblheading">SLOC</td>
    <td width="66" align="center" valign="middle" class="tblheading">UPS</td>
    <td width="72" align="center" valign="middle" class="tblheading">Qty</td>
    <td width="95" align="center" valign="middle" class="tblheading">SLOC</td>
    <td width="67" align="center" valign="middle" class="tblheading">UPS</td>
    <td width="75" align="center" valign="middle" class="tblheading">Qty</td>
    <td width="78" align="center" valign="middle" class="tblheading">UPS</td>
...
</table><input type="hidden" name="trid" value="<?php echo $trid;?>" /><br />
...
<tr >
<td valign="top" align="right"><a href="add_d.php?p_id=<?php echo $pid;?>"><img src="../images/back.gif" border="0"style="display:inline;cursor:hand;" /></a>&nbsp;&nbsp;</td>
</tr>
