  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;<a href="stores_home.php" style="text-decoration:underline; cursor:hand; color:#404d21;"></a>Transction Issue-Indents-view </td>
	    </tr></table></td>
...
<td width="187" align="right" valign="middle" class="tblheading">&nbsp;Transction Id&nbsp;</td>
<td width="260"  align="left" valign="middle" class="tbltext">&nbsp;<?php echo "IR".$row_tbl['code']."/".$yearid_id."/".$logid;?></td>

<td width="103" align="right" valign="middle" class="tblheading">Indent Date&nbsp;</td>
<td width="190" colspan="3" align="left" valign="middle" class="tbltext">&nbsp;<?php echo $tdate;?></tr>

<tr class="Light" height="30">
<td width="187" align="right" valign="middle" class="tblheading">Indent Number  </td>
<td width="260"  align="left" valign="middle" class="tbltext">&nbsp;<?php echo $row_tbl['code']?></td>
<?php 
$result=mysql_query("SELECT * FROM tbl_roles where id='".$row_tbl['id']."'")or die(mysql_error()); 
$row = mysql_fetch_array($result);

?>
<td width="103" align="right" valign="middle" class="tblheading">Raised by&nbsp;</td>
...
<tr >
<td width="794" align="right" valign="top"><a href="../indexindet.php"><img src="../images/back.gif" border="0"style="display:inline;cursor:hand;" /></a>&nbsp;&nbsp;<a href="Javascript:void(0)" onclick="openprint();"><img src="../images/printpreview.gif" border="0"style="display:inline;cursor:hand;" /></a>&nbsp;&nbsp;</td>
</tr>
</table>
</td><td width="30"></td>
</tr>
