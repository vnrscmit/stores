...
if($printopt == "1" )
{
	echo "<script>window.location='pindent_note.php'</script>";	
}
else if($printopt =="2")
{
echo "<script>window.location='bincard_pindnet_print.php'</script>";	
}
else
{
echo "Bye";	
...
<title>stores - Transction-Select Physical Indent</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction: Issue P-Indent - Output Selection</td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
<td width="85"  align="right"  valign="middle" class="tbltext">&nbsp;<input type="radio" name="fet" value="1" onClick="test1(this.value);" /></td>
    <td width="223" align="left"  valign="middle" class="tblheading">&nbsp;P-Indent Issue Note</td>
</tr>
