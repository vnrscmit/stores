	...
	*/
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		{	$id=mysql_insert_id();
			 ...
			 {						*/			
			echo "<script>window.location='captive_consumption_note.php'</script>";	
		}
		//}
	//}
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;<a href="stores_home.php" style="text-decoration:underline; cursor:hand; color:#404d21;">&nbsp; Transaction Issue  </a>- Internal Captive Consumption Note</td>
	    </tr></table></td>
...
<table align="center" border="1" cellspacing="0" cellpadding="0" width="850" bordercolor="#4ea1e1" style="border-collapse:collapse">
			...
			<tr class="<?php echo $trcls;?>" height="20">
...
<tr >
<td valign="top" align="center"><a href="home_transction_issue.php"><img src="../images/back.gif" border="0"  style="display:inline;cursor:hand;"/></a>&nbsp;<a href="javascript:document.frmaddDept.reset()"></a>&nbsp;</td>
</tr>
</table>
