<?php
	...
	$res_code=mysql_query($sql_code)or die(mysql_error());
		...
		$sql_code1="SELECT MAX(ncode) FROM tblarrival where arrival_type='Internalreturn' ORDER BY ncode DESC";
...
if($printopt == "1" )
{
	echo "<script>window.location='eindent_note.php'</script>";	
}
else if($printopt =="2")
{
echo "<script>window.location='bincard_eindnet_print.php'</script>";	
}
else
{
echo "Bye";	
...
{
alert("Please select Out Put Of vendor");
return false;
}
	return true;	 
}
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;e-Indent Note </td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
<td width="85"  align="right"  valign="middle" class="tbltext">&nbsp;<input type="radio" name="fet" value="1" onClick="test1(this.value);" /></td>
    <td width="223" align="left"  valign="middle" class="tblheading">&nbsp;e-Indent Issue Note</td>
</tr>
<tr class="Dark" height="25">
<td  align="right"  valign="middle" class="tbltext">&nbsp;<input type="radio" name="fet" value="2" onClick="test1(this.value);" /></td>
 <td width="223" align="left"  valign="middle" class="tblheading">&nbsp; Bin Card</td >
 </tr>
</table>

<table align="center" width="314" cellpadding="5" cellspacing="5" border="0" >
<tr >
<td valign="top" align="center"><a href="select_vendorop.php"><img src="../images/back.gif" border="0"  style="display:inline;cursor:hand;"/></a>&nbsp;&nbsp;<input name="Submit" type="image" src="../images/next.gif" alt="next" OnClick="return mySubmit()" border="0" style="display:inline;cursor:hand;">&nbsp;<input type="hidden" name="fet1" value="" /></td>	
</tr>
</table>
