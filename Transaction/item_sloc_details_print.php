...
<table align="center" border="1" width="800" cellspacing="0" cellpadding="0" bordercolor="#4ea1e1" style="border-collapse:collapse" > 
...
<td width="275"  align="left" valign="middle" class="tbltext">&nbsp;<?php echo "TAV".$row_tbl['arrival_code']."/".$lgnid."/".$yearid_id;?></td>
