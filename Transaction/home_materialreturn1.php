...
session_start();
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		if($sdate!="" && $edate!="")
		{
		echo "<script>window.location='home_materialreturn1.php?sdate=$sdate&edate=$edate'</script>";
		}
		else
		 {?>
		 <script>
...
<title>Stock- Transaction -Home Material Return To Vendor</title>
...
{
winHandle=window.open('mrtv_issue_note_print1.php?itmid='+tid,'WelCome','top=170,left=180,width=820,height=450,scrollbars=yes');
if(winHandle==null){
...
{
winHandle=window.open('gatepass.php?itmid='+itm,'WelCome','top=170,left=180,width=820,height=450,scrollbars=yes');
if(winHandle==null){
alert("While Launching New Window...\nYour browser maybe blocking up Popup windows. \n\n  Please check your Popup Blocker Settings or ..\n Please hold Ctrl Key and Click on link to open new Browser"); 
}
}
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="800" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="800" height="25">&nbsp;Transaction - Issue- Material Return to Vendor  </td>
	    </tr></table></td>
	  <td width="120" height="25" align="right" class="submenufont" >
	  <table border="3" align="right" bordercolordark="#5b7e1b" cellspacing="0" cellpadding="0" width="106" style="border-collapse:collapse;">

<!--<tr height="15" class="tbltitle" >
<td align="center" width="120" valign="middle" class="tblbutn" style="cursor:hand;"><a href="add_materialreturn.php" style="text-decoration:none; color:#FFFFFF">Add </a></td>
</tr>-->
<tr height="15" class="tbltitle" >
<td align="center" width="100" valign="middle" class="tblbutn" style="cursor:hand;"><?php if($flg==0 && $flg1==0 && $flg2==0) { ?><a href="add_materialreturn.php" style="text-decoration:none; color:#FFFFFF">Add </a><?php } else { ?><a href="Javascript:void(0);" onClick="alert('Can not perform Transaction.\nReason:\n1. Todays date is not in Active Current Financial Year.\n2. Transaction after todays date has been made.\n3. Cycle Inventory transaction is under process.');" style="text-decoration:none; color:#FFFFFF">Add </a><?php } ?></td>
</tr>
...
/*if(!isset($_GET['page'])) { 
  ...
  $sql_arr_home=mysql_query("select * from tblissue where issue_date between '$tdate' and '$pdate' and issue_type='MReturnV' and issuetrflag=1 order by yearcode desc, iss_code desc LIMIT $start, $limit") or die(mysql_error());
...
$query = "select * from tblissue where issue_date between '$tdate' and '$pdate' and issue_type='MReturnV' and issuetrflag=1 order by yearcode desc, iss_code desc";
...
$pagination = "";
	...
	{	
	 ...
	 $srno=($page-1)*$limit+1;
/*$sql_arr_home=mysql_query("select * from tblissue where issue_date between '$tdate' and '$pdate' and issue_type='MReturnV' and issuetrflag=1 order by yearcode desc, iss_code desc LIMIT $from, $max_results") or die(mysql_error());
$tot_arr_home=mysql_num_rows($sql_arr_home);

$total_results = mysql_result(mysql_query("SELECT COUNT(*) as Num FROM tblissue where issue_date between '$tdate' and '$pdate' and issue_type='MReturnV' and issuetrflag=1"),0); 
*/
    if($tot_arr_home >0) { 
?>
...
<table align="center" border="1" cellspacing="0" cellpadding="0" width="700" bordercolor="#4ea1e1" style="border-collapse:collapse">
            ...
            <tr class="tblsubtitle" height="20">
			 ...
			 <td width="13%" align="center" valign="middle" class="tblheading">Date</td>
              <td width="36%" align="center" valign="middle" class="tblheading">Party Name</td>
			  <td width="15%" align="center" valign="middle" class="tblheading">Party DC Ref. Number</td>
...
<tr class="Light">
         ...
         <td width="13%" align="center" valign="middle" class="tblheading"><a href="add_issue_mrtv_view.php?p_id=<?php echo $row_arr_home['issue_id'];?>"><?php echo "IM".$row_arr_home['iss_code']."/".$row_arr_home['yearcode']."/".$irole;?></a></td>
		 <td width="13%" align="center" valign="middle" class="tblheading"><?php echo $trdate;?></td>
         <td width="36%" align="center" valign="middle" class="tblheading"><?php echo $row3['business_name'];?></td>
         <td width="15%" align="center" valign="middle" class="tblheading"><?php echo $row_arr_home['dcrefno']?></td>
         <td width="19%" align="center" valign="middle" class="tblheading"><a href="Javascript:void(0)" onClick="openslocpopprint('<?php echo $row_arr_home['issue_id'];?>');">VMRN</a> | <a href="Javascript:void(0)" onClick="openslocpopprint1('<?php echo $row_arr_home['issue_id'];?>');">Gate Pass</a></td>
</tr>
<?php
}
else
...
<tr >
<td valign="top" align="right"><a href="home_materialreturn.php"><img src="../images/back.gif" border="0"style="display:inline;cursor:hand;" /></a></td>
</tr>
</table>
</td><td width="30"></td>
</tr>
