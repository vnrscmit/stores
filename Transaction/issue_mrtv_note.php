...
<title>stores - Transction-VMRN</title>
...
winHandle=window.open('mrtv_issue_note_print.php?p_id='+itm,'WelCome','top=170,left=180,width=820,height=450,scrollbars=yes');
if(winHandle==null){
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">Vendor Material Return Note</td>
	    </tr></table></td>
...
<tr class="tblsubtitle" height="20">
  <td colspan="6" align="center" class="tblheading">Vendor Material Return Note</td>
</tr>

<tr class="Dark" height="20">
<td width="174" align="right" valign="middle" class="tblheading">&nbsp;Transaction Id &nbsp;</td>
<td width="204"  align="left" valign="middle" class="tbltext">&nbsp;<?php echo "IM".$row['issue_code'];?></td>
...
<table align="center" border="1" cellspacing="0" cellpadding="0" width="750" bordercolor="#4ea1e1" style="border-collapse:collapse">
    ...
    <td width="243" align="center" class="tblheading" valign="middle">&nbsp;Classification</td>
    <td width="211" align="center" class="tblheading" valign="middle">Items</td>
    <td width="43" align="center" class="tblheading" valign="middle">UOM</td>
    <td width="51" align="center" class="tblheading" valign="middle">UPS</td>
	  <td width="62" align="center" class="tblheading" valign="middle">Quantity</td>
	   <td width="92" align="center" class="tblheading" valign="middle">Good/Damage</td>
      <?php
$sr=1;
...
<tr class="Dark" height="25">
			  ...
			  <td align="center" width="43" class="smalltbltext" valign="middle"><?php echo $row_eindent_sub['uom']?></td>
              <td align="center" width="51" class="smalltbltext" valign="middle"><?php echo $row_eindent_sub['ups_indent']?></td>
              <td align="center" width="62" class="smalltbltext" valign="middle"><?php echo $row_eindent_sub['qty_indent']?></td>
              <td align="center" width="92" class="smalltbltext" valign="middle"><?php echo ucwords($row_issuemain['rettype']);?></td>
...
<tr >
<td valign="top" align="center"><a href="select_issue_mrtvop.php?p_id=<?php echo $pid;?>" tabindex="20"><img src="../images/back.gif" border="0"style="display:inline;cursor:hand;" /></a>&nbsp;&nbsp;<a href="Javascript:void(0)" onclick="openslocpopprint();"><img src="../images/printpreview.gif" border="0"style="display:inline;cursor:hand;" /></a></td>
</tr>
</table>
</td><td width="30"></td>
</tr>
