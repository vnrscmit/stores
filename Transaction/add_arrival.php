...
$sql_tbl=mysql_query("select * from tbl_sloc where surole='".$logid."' and supflg=0") or die(mysql_error());
...
<title>Stores- Transaction - Sloc Update -  Home</title>
...
$targetpage = $PHP_SELF; 
  ...
  $sql_arr_home=mysql_query("select * from tbl_sloc where supflg=1 order by yearcode desc, scode desc LIMIT $start, $limit") or die(mysql_error());
...
$query = "select * from tbl_sloc where supflg=1 order by yearcode desc, scode desc";
...
$sql_arr_home=mysql_query("select * from tbl_sloc where supflg=1 order by yearcode desc, scode desc LIMIT $from, $max_results") or die(mysql_error());
$tot_arr_home=mysql_num_rows($sql_arr_home);

$total_results = mysql_result(mysql_query("SELECT COUNT(*) as Num FROM tbl_sloc where  supflg=1"),0); */
