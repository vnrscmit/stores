...
if($printopt == "1" )
{
echo "<script>window.location='damage_material_noted.php?p_id=$pid'</script>";	
}
else if($printopt=="2")
{
echo "<script>window.location='good_bincard_print.php?p_id=$pid&tp=Internalreturn'</script>";	
...
<title>Stores - Transaction - Select o/</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="900" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="800" height="25">&nbsp;Transaction - Internal Return-Party (Damage) Outputs</td>
	    </tr></table></td>
...
<tr class="Light" height="25">
    ...
    <td align="center"  valign="middle" class="tblheading">&nbsp;<a href="Javascript:void(0)" onclick="openslocpopprint();">Internal Material Return Note - Party (IMRN-P)</a></td>
</tr>
</table>
<?php
...
if($row_sloc['ups_damage']!=0 && $row_sloc['ups_damage']==0)
$gd=$gd."G"."<br />";
else
$gd=$gd."D"."<br />";
}
...
<tr >
<td valign="top" align="center"><a href="add_return_stores2.php"><img src="../images/back.gif" border="0"style="display:inline;cursor:hand;" /></a>&nbsp;&nbsp;&nbsp;
