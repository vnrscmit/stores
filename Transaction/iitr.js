...
if(tp=="etdrecgd")
{
var url="getuser_iitredtrec.php";
url=url+"?a="+str;
url=url+"&b="+d;
url=url+"&c="+e;
url=url+"&sid="+Math.random();
...
if(tp=="slocshowmrv")
{ //alert(str);
var url="getuser_iit_slocshow.php";
url=url+"?a="+str;
url=url+"&b="+d;
url=url+"&c="+e;
url=url+"&f="+i;
...
if(tp=="slocshowsub")
{ //alert(str);
var url="getuser_iit_slocshow1.php";
url=url+"?a="+str;
url=url+"&b="+d;
url=url+"&c="+e;
url=url+"&f="+i;
...
if(tp=="mformccupdate")
{ //alert(str);
var url="getuser_iitetdupdate.php";
url=url+"?"+str; 
url=url+"&sid="+Math.random();
xmlHttp.onreadystatechange=stateChanged ;
xmlHttp.open("GET",url,true);
