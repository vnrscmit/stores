<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		{*/
			 ...
			 $sql_in="insert into tbl_gtod(code, tdate , classification_id, items_id,uom) values ('$id', '$tdate' , '$classification' , '$items', '$uom')";
						//exit;				
...
<title>stores - Transction-Material Return Note</title>
...
<td width="202" align="right" valign="middle" class="tblheading">&nbsp;Date&nbsp;</td>
<td width="642"  align="left" valign="middle" class="tbltext">&nbsp;<?php echo $tdate;?></td>

<td width="99" align="right" valign="middle" class="tblheading">&nbsp;IMRN No &nbsp;</td>
<td width="272" colspan="3" align="left" valign="middle" class="tbltext">&nbsp;<?php echo "AI".$row_tbl['arr_code']."/".$lgnid;?></td>
</tr>
