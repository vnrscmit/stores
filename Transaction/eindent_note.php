...
{
var itm=document.frmaddDepartment.pid.value;
var tid=document.frmaddDepartment.tid.value;
winHandle=window.open('eindent_note_print.php?p_id='+itm+'&tid='+tid,'WelCome','top=170,left=180,width=820,height=450,scrollbars=yes');
if(winHandle==null){
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;e- Indent  Issue Note </td>
	    </tr></table></td>
...
<tr class="tblsubtitle" height="20">
  <td colspan="6" align="center" class="tblheading">Issue Internal - eIndents </td>
</tr>
...
<td width="215"  align="left" valign="middle" class="tbltext">&nbsp;<input name="txtid" type="text" size="5" class="tbltext" tabindex="" readonly="true" style="background-color:#CCCCCC"  value="<?php echo "IE".$row2['iss_code']?>"/></td>
...
<td width="215"  align="left" valign="middle" class="tbltext">&nbsp;<input name="indentno" type="text" size="5" class="tbltext" tabindex="0"  readonly="true" style="background-color:#CCCCCC" value="<?php echo $row2['dcrefno'];?>"  />&nbsp; </td>
...
<td width="215"  align="left" valign="middle" class="tbltext">&nbsp;<input name="indentdate" type="text" size="10" class="tbltext" tabindex="" readonly="true" style="background-color:#CCCCCC" value="<?php echo $sdate;?>" /></td>

<td width="193" align="right" valign="middle" class="tblheading">Issue Date&nbsp;</td>
<td width="227" colspan="3" align="left" valign="middle" class="tbltext">&nbsp;<input name="issuedate" type="text" size="10" class="tbltext" tabindex="0"  readonly="true" style="background-color:#CCCCCC" value="<?php echo $tdate;?>" />&nbsp; </td>
</tr>
</table>
</br>
...
<tr class="Dark" height="25">
              ...
              <td align="center" width="6%" class="smalltbltext" valign="middle"><?php echo $row_eindent_sub['ups']?></td>
...
<tr >
<td valign="top" align="center"><a href="select_issue_eindentop.php?p_id=<?php echo $pid;?>&tid=<?php echo $tid;?>" tabindex="20"><img src="../images/back.gif" border="0"style="display:inline;cursor:hand;" /></a>&nbsp;&nbsp;<a href="Javascript:void(0)" onclick="openslocpopprint();"><img src="../images/printpreview.gif" border="0"style="display:inline;cursor:hand;" /></a></td>
</tr>
</table>
</td><td width="30"></td>
</tr>
