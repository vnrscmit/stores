  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="940" height="25" class="Mainheading" >&nbsp;Transaction Arrival - <span class="subheading" style="color:#303918; ">Bin Status Card </span></td>
	    </tr></table></td>
...
<tr >
<td valign="top" align="center"><?php if($tp=="Vendor"){ ?><a href="add_interitem.php?p_id=<?php echo $pid;?>"><img src="../images/back.gif" border="0"  style="display:inline;cursor:hand;"/></a><?php } else { ?><a href="select_arrival_stocktrop.php?p_id=<?php echo $pid;?>"><img src="../images/back.gif" border="0"  style="display:inline;cursor:hand;"/></a><?php } ?>&nbsp;</td>
</tr>
</table>
</td>
<td width="30"></td>
