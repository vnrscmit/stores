<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		if($sdate!="" && $edate!="")
		{
		echo "<script>window.location='home_openstock1.php?sdate=$sdate&edate=$edate'</script>";
		}
		else
		 {?>
		 <script>
...
<title>stores - Transction-Home opening Stock</title>
...
$sql_arr_home=mysql_query("select * from tblarrival where arr_role='".$logid."' and arrival_type='Vendor' and arrtrflag=1") or die(mysql_error());
...
$sql_arr_home=mysql_query("select * from tblarrival where arrival_date between '$tdate' and '$pdate' and arr_role='".$logid."' and arrival_type='Vendor' and arrtrflag=1 order by yearcode desc, arr_code desc LIMIT $from, $max_results") or die(mysql_error());
$tot_arr_home=mysql_num_rows($sql_arr_home);

$total_results = mysql_result(mysql_query("SELECT COUNT(*) as Num FROM tblarrival where arrival_date between '$tdate' and '$pdate' and arr_role='".$logid."' and arrival_type='Vendor' and arrtrflag=1"),0); 
...
<table align="center" border="1" cellspacing="0" cellpadding="0" width="700" bordercolor="#4ea1e1" style="border-collapse:collapse">
            ...
            <tr class="tblsubtitle" height="20">
			 ...
			 <td width="15%" align="center" valign="middle" class="tblheading">Date</td>
              <td width="42%" align="center" valign="middle" class="tblheading">Classification</td>
			  <td width="21%" align="center" valign="middle" class="tblheading">Item</td>
			   </tr>
<?php
//$srno=1;
if($tot_arr_home > 0)
...
<tr class="Light">
         ...
         <td width="15%" align="center" valign="middle" class="tblheading"><a href="home_openstock_view.php?p_id=<?php echo $row_arr_home['arrival_id'];?>"><?php echo "OP".$row_arr_home['arrival_code'];?></a></td>
		 <td width="5%" align="center" valign="middle" class="tblheading"><?php echo $trdate;?></td>
		 
         <td width="42%" align="center" valign="middle" class="tblheading"><?php echo $noticia_class['classification'];?></td>
         <td width="21%" align="center" valign="middle" class="tblheading"><?php echo $noticia_item['stores_item'];?></td>
		  </tr>
<?php
}
else
