<?php
	...
	$query=mysql_query("SELECT * FROM tblclassification where classification='$class'") or die("Error: " . mysql_error());
		...
		{*/
			echo "<script>window.location='home_return_stores.php'</script>";	
		}
		//}
	//}
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="809" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#b9d647" >
	    <tr >
	      <td width="810" height="25">&nbsp;Transction Receive Material Return to Stores </td>
	    </tr></table></td>
...
<a href="add_return_stores.php" style="text-decoration:none; color:#000000">
<td align="center" width="130" valign="middle" class="subheading" style="cursor:hand;">Add Return </td>
</a>
</tr>
...
<td width="157" align="left" class="tblheading" valign="middle">&nbsp;Classification</td>
<td width="68" align="center" class="tblheading" valign="middle">Items</td>
<td width="81" align="center" class="tblheading" valign="middle">Uom</td>
<td width="124" align="left" class="tblheading" valign="middle">&nbsp;UPS</td>
<td width="78" align="center" class="tblheading" valign="middle">Quantity</td>
<td align="center" colspan="2" class="tblheading" valign="middle">Sloc</td>
<td width="53" align="center" class="tblheading" valign="middle">Edit</td>
<td width="84" align="center" class="tblheading" valign="middle">Delete</td>
</tr>
<?php
//$srno=1;
...
<td valign="middle" class="tbltext" align="left">&nbsp;<?php echo $row['binname'];?></td>
<td width="25" align="center" valign="middle" class="tbltext"><a href="edit_bin.php?binid=<?php echo $row['binid'];?>"><?php echo $row['binname'];?></a></td>
<td width="25" align="left" valign="middle" class="tbltext">&nbsp;<?php echo $row['binname'];?></td>
<td valign="middle" class="tbltext" align="center"><a href="edit_return_stores.php"><img src="../images/edit.png" border="0" /></a></td>
