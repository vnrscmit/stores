...
if(isset($_POST['frm_action'])=='submit')
	...
	while($row_sub=mysql_fetch_array($sql_sub))
	{
		...
		$balqty1=$opqty1-$oqty;
				...
				$sql_sub_sub1="insert into tbl_stldg_good (yearcode,stlg_trtype, stlg_trsubtype, stlg_trid, stlg_trdate, stlg_trclassid, stlg_tritemid, stlg_whid, stlg_binid, stlg_subbinid, stlg_opups, stlg_opqty, stlg_trups, stlg_trqty, stlg_balups, stlg_balqty) values('$yearid_id','IT', 'IT', '$pid', '$trdate', '$classid1', '$itemid1', '$whid1', '$binid1', '$subbinid1', '$opups1', '$opqty1', '$oups', '$oqty', '$balups1', '$balqty1')";
	...
	while($row_arrsub=mysql_fetch_array($sql_arrsub))
	{
		...
		$sql_sub_sub="insert into tbl_stldg_good (yearcode,stlg_trtype, stlg_trsubtype, stlg_trid, stlg_trdate, stlg_trclassid, stlg_tritemid, stlg_whid, stlg_binid, stlg_subbinid, stlg_opups, stlg_opqty, stlg_trups, stlg_trqty, stlg_balups, stlg_balqty) values('$yearid_id','IT', 'IT', '$pid', '$trdate', '$classid', '$itemid', '$whid', '$binid', '$subbinid', '$opups', '$opqty', '$ups', '$qty', '$balups', '$balqty')";
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction -  Inter Item Transfer- View</td>
	    </tr></table></td>
	    	  </tr>
	  </table></td></tr>
...
<tr height="15"><td colspan="4" align="right" class="tblheading"><font color="#FF0000" >* </font>indicates required field&nbsp;</td></tr>
 ...
 <td width="267"  align="right"  valign="middle" class="tblheading">&nbsp;Transaction Id&nbsp;</td>
<td width="288"  align="left" valign="middle" class="tbltext">&nbsp;<?php echo "IT".$row['tcode']."/".$yearid_id;?></td>

<td width="95" align="right" valign="middle" class="tblheading">&nbsp;Date&nbsp;</td>
...
?>
		 <tr class="Dark" height="25">
           <td width="267"  align="right"  valign="middle" class="tblheading">&nbsp;Select Classification&nbsp;</td>                                   
...
?> 
		<tr class="Light" height="25">
           <td width="267" height="24"  align="right"  valign="middle" class="tblheading">Item&nbsp;</td>
           <td align="left"  valign="middle" colspan="3" id="item" class="tbltext">&nbsp;<?php echo $noticia_item['stores_item'];?>&nbsp;</td>
         </tr>
		 <tr class="Dark" height="25">
            <td width="267" height="24"  align="right"  valign="middle" class="tblheading">UoM&nbsp;</td>
           <td align="left"  valign="middle" colspan="3" id="uom" class="tbltext">&nbsp;<?php echo $noticia_item['uom'];?></td>
         </tr>
		 <tr class="Light" height="25">
            <td width="267" height="24"  align="right"  valign="middle" class="tblheading">Type&nbsp;</td>
...
<tr >
<td valign="top" align="right"><a href="home_interitem.php?p_id=<?php echo $pid;?>"><img src="../images/back.gif" border="0"style="display:inline;cursor:hand;" /></a>&nbsp;&nbsp;&nbsp;</td>
</tr>
