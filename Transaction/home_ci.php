...
<title>stores-Transaction- Print cycle Inventory</title>
...
<table align="center" border="1" cellspacing="0" cellpadding="0" width="736" bordercolor="#4ea1e1" style="border-collapse:collapse">
            ...
            <tr class="tblsubtitle" height="35">
              <td width="1%" rowspan="2" align="center" valign="middle" class="tblheading">#</td>
			    <td width="11%" rowspan="2" align="center" valign="middle" class="tblheading">Classification </td>
				 <td width="5%" rowspan="2" align="center" valign="middle" class="tblheading">Item</td>
			    <td width="4%" rowspan="2" align="center" valign="middle" class="tblheading">UoM</td>
				
					 <td colspan="4" height="23" align="center" valign="middle" class="tblheading">Stock as per records </td>
			  	 <td colspan="3" height="23" align="center" valign="middle" class="tblheading">Stock as per actuals</td>
			 <td colspan="3" height="23" align="center" valign="middle" class="tblheading">Difference is Stock</td>
                            </tr>
			<tr class="tblsubtitle">
			 <td width="8%" align="center" valign="middle" class="tblheading">SLOC 1</td>
				   <td width="6%" align="center" valign="middle" class="tblheading">SLOC1</td>
				      <td width="8%" align="center" valign="middle" class="tblheading">UPS</td>
                   <td  colspan="1" align="center" valign="middle" class="tblheading" rowspan="">SLOC wise distribution of stock </td>
				   ...
				   <td width="7%" align="center" valign="middle" class="tblheading">UPS</td>
				    <td width="10%" align="center" valign="middle" class="tblheading">QTY</td>
				      <td width="17%" align="center" valign="middle" class="tblheading">Date of CI</td>
              </tr>
			<tr class="<?php echo $trcls;?>" height="25">
              ...
              <td align="center" width="11%" class="smalltbltext" valign="middle"><input name="txtid" type="text" size="5" class="tbltext" tabindex="" readonly="true" style="background-color:#CCCCCC" /></td>
             
			  
              <td width="5%" align="center" valign="middle" class="smalltbltext"><input name="txtid" type="text" size="5" class="tbltext" tabindex="" readonly="true" style="background-color:#CCCCCC" /></td>
            <td valign="middle" class="tbltext" align="center"><input name="txtid" type="text" size="5" class="tbltext" tabindex="" readonly="true" style="background-color:#CCCCCC" /></td>
			 <td width="8%" align="center" valign="middle" class="smalltbltext">&nbsp;</td>
            <td valign="middle" class="tbltext" align="center">&nbsp;</td>
              <td width="8%" align="center" valign="middle" class="smalltbltext">&nbsp;</td>
              <td width="9%" align="center" valign="middle" class="smalltbltext">&nbsp;</td>
              <td width="5%" align="center" valign="middle" class="smalltbltext">&nbsp;</td>
...
<br/>
<table align="center" border="1" width="617" cellspacing="0" cellpadding="0" bordercolor="#4ea1e1" style="border-collapse:collapse" >
<?php
...
<td width="445" align="left"  valign="middle" class="tbltext">&nbsp;
