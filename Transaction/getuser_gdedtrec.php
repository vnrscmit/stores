...
$sql_in1=mysql_query("select * from tbl_gtod where gid=$trid") or die(mysql_error());
...
$sql_subtbl=mysql_query("select * from tbl_gtod_sub where gid='".$trid."' and rowid='".$stldgid."'") or die(mysql_error());
...
// echo $row_issuetbl['stld_whid']."/".$row_issuetbl['stld_binid']."/".$row_issuetbl['stld_subbinid']."<br>";
 ...
 /*$sql_subtb=mysql_query("select * from tbl_gtod_sub where gid='".$trid."' and rowid='".$stldgid."'") or die(mysql_error());
...
//$srno=1;
//echo $t[0];
$sql_issue=mysql_query("select * from tbl_gtod_sub where gdsubid='".$p1_array[$ct]."'") or die(mysql_error());
$totups=0; $totqty=0; 
 while($row_issue=mysql_fetch_array($sql_issue))
 { 
  $up=$row_issue['opups'];
...
<option value="" selected>--WH--</option>
	<?php while($noticia_whd1 = mysql_fetch_array($whd1_query)) { ?>
		<option <?php if($row_subtbl['whid']==$noticia_whd1['whid']){ echo "Selected"; } ?> value="<?php echo $noticia_whd1['whid'];?>" />   
		<?php echo $noticia_whd1['perticulars'];?>
		<?php } ?>
	</select>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
<?php
...
<?php while($noticia_bind1 = mysql_fetch_array($bind1_query)) { ?>
		<option <?php if($row_subtbl['binid']==$noticia_bind1['binid']){ echo "Selected"; } ?> value="<?php echo $noticia_bind1['binid'];?>" />   
...
<?php while($noticia_subbind1 = mysql_fetch_array($subbind1_query)) { ?>
		<option <?php if($row_subtbl['subbinid']==$noticia_subbind1['sid']){ echo "Selected"; } ?> value="<?php echo $noticia_subbind1['sid'];?>" />   
...
<tr>
<td align="right" width="47"  valign="middle" class="tblheading">&nbsp;UPS &nbsp;</td>
<td  align="left" width="94"  valign="middle" class="tbltext">&nbsp;<input name="txtslupsd1" id="ups1" type="text" size="4" class="tbltext" tabindex="" maxlength="7" onkeypress="return isNumberKey(event)" onchange="upsf4(this.value);" value="<?php echo $row_subtbl['ups'];?>"  />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>	
<td  align="right" width="44"  valign="middle" class="tblheading">&nbsp;Qty &nbsp;</td>
<td width="106" align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtslqtyd1" id="qty1" type="text" size="4" class="tbltext" tabindex="" maxlength="7" onkeypress="return isNumberKey(event)" onchange="qtyf4(this.value);" value="<?php echo $row_subtbl['qty'];?>"  />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr></table></div></td>
<td align="center" valign="middle" class="tbltext"><input type="text" name="balupsd1" class="tbltext" value="<?php echo $row_subtbl['ups'];?>" readonly="true" style="background:#CCCCCC" size="3" /></td>
<td align="center" valign="middle" class="tbltext"><input type="text" name="balqtyd1" class="tbltext" value="<?php echo $row_subtbl['qty'];?>" readonly="true" style="background:#CCCCCC" size="3" /></td> <input type="hidden" name="dorowid1" value="0" />
</tr>
<?php
}
else
...
<option value="" selected>--WH--</option>
	<?php while($noticia_whd2 = mysql_fetch_array($whd2_query)) { ?>
		<option <?php if($row_subtbl['whid']==$noticia_whd2['whid']){ echo "Selected"; } ?>  value="<?php echo $noticia_whd2['whid'];?>" />   
		<?php echo $noticia_whd2['perticulars'];?>
		<?php } ?>
	</select>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
<?php
...
<?php while($noticia_bind2 = mysql_fetch_array($bind2_query)) { ?>
		<option <?php if($row_subtbl['binid']==$noticia_bind2['binid']){ echo "Selected"; } ?> value="<?php echo $noticia_bind2['binid'];?>" />   
...
<?php while($noticia_subbind2 = mysql_fetch_array($subbind2_query)) { ?>
		<option <?php if($row_subtbl['subbinid']==$noticia_subbind2['sid']){ echo "Selected"; } ?> value="<?php echo $noticia_subbind2['sid'];?>" />   
...
<td width="47" align="right"  valign="middle" class="tblheading">&nbsp;UPS &nbsp;</td>
<td width="94" align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtslupsd2" id="ups2" type="text" size="4" class="tbltext" tabindex="" maxlength="7" onkeypress="return isNumberKey(event)" onchange="upsf5(this.value);" value="<?php echo $row_subtbl['ups'];?>"  />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>	
<td width="44" align="right"  valign="middle" class="tblheading">&nbsp;Qty &nbsp;</td>
<td width="106"  align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtslqtyd2" id="qty2" type="text" size="4" class="tbltext" tabindex="" maxlength="7" onkeypress="return isNumberKey(event)" onchange="qtyf5(this.value);" value="<?php echo $row_subtbl['qty'];?>"   />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr></table></div></td>
<td align="center" valign="middle" class="tbltext"><input type="text" name="balupsd2" class="tbltext" value="<?php echo $row_subtbl['ups'];?>" readonly="true" style="background:#CCCCCC" size="3" /></td>
<td align="center" valign="middle" class="tbltext"><input type="text" name="balqtyd2" class="tbltext" value="<?php echo $row_subtbl['qty'];?>" readonly="true" style="background:#CCCCCC" size="3" /></td> <input type="hidden" name="dorowid2" value="0" />
</tr>
<?php
}
$flash++;
...
{
if($whid!=$row_subtbl['whid'] && $binid!=$row_subtbl['binid'] && $subbinid!=$row_subtbl['subbinid'])
{
?>
<?php
$whd2_query=mysql_query("select whid, perticulars from tbl_warehouse") or die(mysql_error());
