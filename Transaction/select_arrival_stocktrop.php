...
<title>stores - Transction-Select output</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction: Arrival from Stock Transfer- Output Selection </td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
<tr class="Light" height="25">
    ...
    <td width="223" align="center"  valign="middle" class="tblheading">&nbsp;<a href="Javascript:void(0)" onclick="openslocpopprint();">Stock Tranasfer Receive Note (STRN)</a></td>
</tr>
</table>
<?php
...
$sql_tbl=mysql_query("select * from tbl_stldg_good where stlg_trtype='Arrival' and stlg_trsubtype='$tp' and stlg_trid='".$pid."'") or die(mysql_error());
/*$row_tbl=mysql_fetch_array($sql_tbl);			
...
<tr >
<td valign="top" align="center"><a href="add_arrival_stocktransfer2.php"><img src="../images/back.gif" border="0"style="display:inline;cursor:hand;" /></a>&nbsp;&nbsp;&nbsp;</td>	
</tr>
</table>
