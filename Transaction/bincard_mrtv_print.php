  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="940" height="25" class="Mainheading" >&nbsp;Transaction Issue - Material Return to Vendor</td>
	    </tr></table></td>
...
$sql_tbl=mysql_query("select * from tbl_stldg_good where stlg_trtype='Issue' and stlg_trsubtype='MReturnV' and stlg_trid='".$pid."'") or die(mysql_error());
...
?>
  <tr class="tblsubtitle" height="25">
    ...
    <td width="257" align="middle" class="tblheading" valign="middle">&nbsp;Items</td>
...
<tr >
<td valign="top" align="center"><a href="select_issue_mrtvop.php?p_id=<?php echo $pid;?>"><img src="../images/back.gif" border="0"  style="display:inline;cursor:hand;"/></a>&nbsp;&nbsp;
  <input name="Submit" type="image" src="../images/next.gif" alt="next" onclick="return mySubmit()" border="0" style="display:inline;cursor:hand;" />
  &nbsp;
