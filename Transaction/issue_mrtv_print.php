...
<td width="204"  align="left" valign="middle" class="tbltext">&nbsp;<?php echo "IM".$row['issue_code']."/".$yearid_id;?></td>
...
<td align="left"  valign="middle" class="tbltext" colspan="3" ><div align="justify" class="tbltext" style="padding:2px 5px 5px 5px"><?php echo $row3['business_name'];?>, <?php echo $row3['city'];?>, <?php echo $row3['state'];?>, <?php echo $row3['country'];?></div></td>
          </tr>
<tr class="Dark" height="20">
<td align="right"  valign="middle" class="tblheading">&nbsp;Address&nbsp;</td>
<td align="left"  valign="middle" class="tbltext" colspan="3" id="vaddress">&nbsp;<?php echo $row3['address'];?></td>
</tr>
<tr class="Light" height="20">
...
<tr >
<td align="right" colspan="3"><img src="../images/close_icon2.jpg" height="30" width="22" border="0" onClick="window.close()" style="cursor:pointer" />&nbsp;&nbsp;<img src="../images/Vista-printer.png" height="29" width="35" border="0" onClick="javascript:window.print();" style="cursor:pointer" />&nbsp;&nbsp;</td>
</tr>
</table>
</form>
</td></tr>
