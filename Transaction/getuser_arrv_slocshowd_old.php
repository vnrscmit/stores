...
<td align="center" valign="middle" class="tblheading"><?php echo $wareh;?><input type="hidden" id="whg<?php echo $srno?>" name="txtslwhg<?php echo $srno?>" value="<?php echo $row_issuetbl['stlg_whid'];?>" /></td>
<td align="center" valign="middle" class="tblheading"><?php echo $binn;?><input type="hidden" id="b<?php echo $srno?>" name="txtslbing<?php echo $srno?>" value="<?php echo $row_issuetbl['stlg_binid'];?>" /></td>
<td align="center" valign="middle" class="tblheading"><?php echo $subbinn;?><input type="hidden" id="sb<?php echo $srno?>" name="txtslsubbg<?php echo $srno?>" value="<?php echo $row_issuetbl['stlg_subbinid'];?>" /></td>
...
<td width="98" align="center"  valign="middle" class="tbltext">&nbsp;
  <select class="tbltext" id="whg1" name="txtslwhg1" style="width:70px;" onchange="wh1(this.value);"  >
...
<td width="84" align="center"  valign="middle" class="tbltext" id="bing1">&nbsp;
  <select class="tbltext" name="txtslbing1" id="b1" style="width:60px;" onchange="bin1(this.value);" >
...
<td width="103" align="center"  valign="middle" class="tbltext" id="sbing1">&nbsp;
  <select class="tbltext" name="txtslsubbg1" id="sb1" style="width:60px;" onchange="subbin1(this.value);"  >
...
<td width="98" align="center"  valign="middle" class="tbltext">&nbsp;
  <select class="tbltext" id="whg2" name="txtslwhg2" style="width:70px;" onchange="wh2(this.value);" >
<option value="" selected>--WH--</option>
...
<td width="84" align="center"  valign="middle" class="tbltext" id="bing2">&nbsp;
  <select class="tbltext" name="txtslbing2" id="b2" style="width:60px;" onchange="bin2(this.value);"  >
<option value="" selected>--Bin--</option>
</select>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
<?php
...
<td width="103" align="center"  valign="middle" class="tbltext" id="sbing2">&nbsp;
  <select class="tbltext" name="txtslsubbg2" id="sb2" style="width:60px;" onchange="subbin2(this.value);" >
<option value="" selected>--Sub Bin--</option>
</select>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
<td colspan="2"  valign="middle">
<div id="slcrow2">
...
<td width="98" align="center"  valign="middle" class="tbltext">&nbsp;
  <select class="tbltext" id="whg3" name="txtslwhg3" style="width:70px;" onchange="wh3(this.value);" >
<option value="" selected>--WH--</option>
...
<td width="84" align="center"  valign="middle" class="tbltext" id="bing3">&nbsp;
  <select class="tbltext" name="txtslbing3" id="b3" style="width:60px;" onchange="bin3(this.value);"  >
<option value="" selected>--Bin--</option>
</select>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
<?php
...
<td width="103" align="center"  valign="middle" class="tbltext" id="sbing3">&nbsp;
  <select class="tbltext" name="txtslsubbg3" id="sb3" style="width:60px;" onchange="subbin3(this.value);" >
<option value="" selected>--Sub Bin--</option>
</select>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
<td colspan="2"  valign="middle">
<div id="slcrow3">
