...
<?php echo $row3['business_name'];?><br /><?php echo $row3['address'];?>, <?php echo $row3['city'];?> - <?php echo $row3['pin'];?>, <?php echo $row3['state'];?>,<br />Ph: <?php echo $row3['std'];?>-<?php echo $row3['phone'];?>, <?php echo $row3['mob'];?><br /><?php echo $ptc;?> </div></td>
</tr>
<tr class="Light" height="20">
...
<table align="center" border="1" cellspacing="0" cellpadding="0" width="750" bordercolor="#4ea1e1" style="border-collapse:collapse">
    ...
    <td width="276" align="center" class="tblheading" valign="middle">Classification</td>
    <td width="243" align="center" class="tblheading" valign="middle">Item</td>
...
<td width="13%" align="right" valign="middle" class="tblheading">&nbsp;Return Status&nbsp;</td>
<td width="87%" align="left" valign="middle" class="tbltext" colspan="18">&nbsp;<?php echo $row['rettyp'];?>&nbsp;</td>
</tr>		  
<tr class="Dark" height="30">
<td width="13%" align="right" valign="middle" class="tblheading">&nbsp;Remarks&nbsp;</td>
<td width="87%" align="left" valign="middle" class="tbltext" colspan="18">&nbsp;<?php echo $row['remarks'];?>&nbsp;</td>
</tr>
</table>
<br />
