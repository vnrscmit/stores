...
<td align="right"  valign="middle" class="tblheading">&nbsp;Payment Mode&nbsp;</td>
 <td align="left"  valign="middle" class="tbltext"colspan="3">&nbsp;<?php if($row['trans_paymode'] == "ToPay")
$pmode="To Pay";
else
...
<tr class="Light" height="30">
<td width="24%" align="center" rowspan="2" valign="left" class="tblheading">&nbsp;</td>
</tr>
</table>
<table align="center" border="1" cellspacing="0" cellpadding="0" width="750" bordercolor="#4ea1e1" style="border-collapse:collapse">
            <tr class="tblsubtitle" height="35">
			 ...
			 <td width="17%" align="center" rowspan="2" valign="middle" class="tblheading">Classification</td>
              <td width="23%" rowspan="2" align="center" valign="middle" class="tblheading">Items</td>
