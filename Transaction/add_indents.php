<?php
	...
	/*$res_in=mysql_query("select * from tbl_ieindent");
	$row_rt=mysql_num_rows($res_in);*/
	
	$row_rt=mysql_query("select * from tbl_ieindent where  flg=0 and id='".$loginid."' order by code desc ") or die(mysql_error());
    $tot_home=mysql_num_rows($row_rt);

//$total_results = mysql_result(mysql_query("SELECT COUNT(*) as Num FROM tbl_ieindent where  flg=0"),0); 
		...
		if(mysql_num_rows($res_code) > 0)
			{
				...
				$t_code=$row_code['0'];
				$code=$t_code+1;
				$code1="TIR".$code."/".$yearid_id."/".$lgnid;
		}
		
		else
		{
			$code=1;
			$code1="TIR".$code."/".$yearid_id."/".$logid;
		}
	...
	{	
		if(document.frmaddDepartment.txtitem.value!="")
		{
			...
			{ 
				...
				{
					if(document.getElementById('itm').value==itm[i])
					{
						flg=1;
					}
				}
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;<a href="stores_home.php" style="text-decoration:underline; cursor:hand; color:#404d21;"></a>Transaction Raise - Indents </td>
	    </tr></table></td>
...
<tr>
<td>
<table align="center" border="1" width="750" cellspacing="0" cellpadding="0" bordercolor="#4ea1e1" style="border-collapse:collapse" > <?php //if($tot_home < 3) { ?>
...
<td width="186" align="right" valign="middle" class="tblheading">&nbsp;Transction Id&nbsp;</td>
<td width="213"  align="left" valign="middle" class="tbltext">&nbsp;<?php echo $code1?></td>

<td width="112" align="right" valign="middle" class="tblheading">Indent Date&nbsp;</td>
<td width="229" colspan="3" align="left" valign="middle" class="tbltext">&nbsp;<input name="idate" type="text" size="10" class="tbltext" tabindex="0"  readonly="true" style="background-color:#CCCCCC" value="<?php echo date("d-m-Y");?>" />&nbsp; </td>
</tr>
...
?>
<td width="112" align="right" valign="middle" class="tblheading">Raised by&nbsp;</td>
<td width="229" colspan="3" align="left" valign="middle" class="tbltext">&nbsp;<input name="iraised" type="text" size="25" class="tbltext" tabindex="" readonly="true" style="background-color:#CCCCCC" value="<?php echo $row['name'];?>"/></td>
</tr>
</table>
</br>
<div id="ind">
...
?>
		 <tr class="Dark" height="25">
           ...
           <td align="left"  valign="middle" colspan="3">&nbsp;<select class="tbltext" name="txtclass" style="width:230px;"   onchange="modetchk(this.value)" tabindex="0">
...
<td width="350" align="left" valign="middle" class="tbltext" >&nbsp;<select class="tbltext" name="txtitem" id="itm" style="width:230px;" onchange="classchk(this.value);" tabindex="0" >
...
<td align="left" valign="middle" class="tbltext" colspan="3">&nbsp;<input name="txtqty" type="text" size="10" class="tbltext" tabindex="0"   maxlength="7"  onkeypress="return isNumberKey(event)" onchange="tbset()" />&nbsp;</td>
		 
</table><input type="hidden" name="itmdchk" value="" /><input type="hidden" name="maintrid" value="<?php echo $tid;?>" /><input type="hidden" name="subtrid" value="<?php echo $subtid;?>" />
<br/>
<table align="center" width="750" cellpadding="5" cellspacing="5" border="0" >
<tr >
<td width="746" align="right" valign="top"><img id="btn" src="../images/post.gif" border="0" style="display:inline;cursor:hand;" onclick="pform();"  />&nbsp;&nbsp;</td>
</tr>
</table></div></div>
<table align="center" border="1" width="750" cellspacing="0" cellpadding="0" bordercolor="#4ea1e1" style="border-collapse:collapse" >
<tr class="Dark" height="30">
<td width="60" align="right"  valign="middle" class="tblheading">&nbsp;Remarks&nbsp;</td>
<td width="784" align="left"  valign="middle" class="tbltext">&nbsp;<input type="text" name="txtremarks" class="tbltext" size="90" maxlength="90" value="" ></td>
</tr>
</table>
<table align="center" width="750" cellpadding="5" cellspacing="5" border="0" >
<tr >
...
<tr >
<td valign="top" align="center" class="tblheading" style="color:#4ea1e1">You can Raise up to 3 Indents 
</tr>
<tr >
<td valign="top" align="center"><a href="../indexindet.php"><img src="../images/back.gif" border="0"  style="display:inline;cursor:hand;"/></a>&nbsp;</td>
</tr>
</table>-->
<?php //} ?>
