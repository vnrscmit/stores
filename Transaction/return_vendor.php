  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction Material Return To Vendor </td>
	    </tr></table></td>
...
<table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#4ea1e1" style="border-collapse:collapse" > 		 
		 <tr class="Dark" height="25">
           <td width="322"  align="right"  valign="middle" class="tblheading">&nbsp;Select Classification                                                   &nbsp; </td>
           <td width="522" colspan="3" align="left"  valign="middle">&nbsp;<select class="tbltext" name="txtwh" style="width:170px;"  onchange="showUser(this.value)">
<option value="" selected>--Select classification--</option>
	<?php while($noticia = mysql_fetch_array($quer3)) { ?>
		...
		<?php } ?>
		 ...
		 <tr class="Light" height="25">
            <td width="322" height="24"  align="right"  valign="middle" class="tblheading">Items &nbsp;</td>
...
<option value="" selected>--Select Items--</option>
	<?php while($noticia = mysql_fetch_array($quer3)) { ?>
		...
		<?php } ?>
		 ...
		 <tr class="Light" height="25">
            <td width="322" height="24"  align="right"  valign="middle" class="tblheading">Uom&nbsp;</td>
            <td align="left"  valign="middle" colspan="3">&nbsp;<select class="tbltext" name="txtperticulars" style="width:170px;"  >
<option value="" selected>--Select Items--</option>
	<?php while($noticia = mysql_fetch_array($quer3)) { ?>
		<option value="<?php echo $noticia['whid'];?>" />   
...
<tr class="tblsubtitle" height="35">
			   ...
			   <td width="11%" rowspan="2" align="center" valign="middle" class="tblheading">Qty</td>
			    <td colspan="2" height="23" align="center" valign="middle" class="tblheading">Material Return </td>
			     <td colspan="2" height="23" align="center" valign="middle" class="tblheading">Balance</td>
				   <td width="7%" rowspan="2" align="center" valign="middle" class="tblheading">Remarks</td>
			...
			<tr class="<?php echo $trcls;?>" height="25">
              ...
              <td width="14%" align="center" valign="middle" class="smalltbltext"><input name="date" type="text" size="6" class="tbltext" tabindex="0"  readonly="true" style="background-color:#CCCCCC" /></td>
			  <td align="center" class="smalltbltext" valign="middle"><input type="checkbox" <?php  ?> name="0ne" value="2" onClick="chk();"  /></td>
...
<tr >
<td valign="top" align="center"><a href="add_issu_physical_indent.php"></a>&nbsp;<a href="javascript:document.frmaddDept.reset()"><img src="../images/reset.gif" OnClick="myReset()"alt="reset"  border="0" style="display:inline;cursor:hand;"></a>&nbsp;
