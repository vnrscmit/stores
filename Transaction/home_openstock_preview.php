...
if(isset($_POST['frm_action'])=='submit')
{
	...
	if($r_chk > 0)
	$sql_code="SELECT MAX(arr_code) FROM tblarrival where yearcode='$yearid_id' and arrival_type='OP' ORDER BY arr_code DESC";
	else
	$sql_code="SELECT MAX(arr_code) FROM tblarrival where arrival_type='OP' ORDER BY arr_code DESC";
	$res_code=mysql_query($sql_code)or die(mysql_error());
		...
		$r_chk=mysql_num_rows($s_chk);
		if($r_chk > 0)
		$sql_code1="SELECT MAX(ncode) FROM tblarrival where yearcode='$yearid_id' and arrival_type='OP' ORDER BY ncode DESC";
		else
		$sql_code1="SELECT MAX(ncode) FROM tblarrival where arrival_type='OP' ORDER BY ncode DESC";
	...
	$a123456=mysql_query($sql_main) or die(mysql_error());
		...
		echo "<script>window.location='select_arrival_opstock.php?p_id=$pid'</script>";	
...
winHandle=window.open('open_print.php?p_id='+itm+'&itmid='+itm,'WelCome','top=170,left=180,width=820,height=450,scrollbars=yes');
if(winHandle==null)
{
...
<tr class="tblsubtitle" height="25">
  <td colspan="4" align="center" class="tblheading">Opening stock</td>
</tr>
...
<td align="left"  valign="middle" class="tbltext" >&nbsp;<?php if($row_tbl_sub['ups_good']>0){ echo $row_tbl_sub['ups_good'];} else { echo $row_tbl_sub['ups_damage'];}?></td>
<td align="right"  valign="middle" class="tblheading">Quantity&nbsp;</td>
<td align="left"  valign="middle" class="tbltext" >&nbsp;<?php if($row_tbl_sub['qty_good']>0){ echo $row_tbl_sub['qty_good'];} else { echo $row_tbl_sub['qty_damage']; }?></td>
</tr>

<tr class="Light" height="30">
<td width="225" align="right"  valign="middle" class="tblheading">No of Bins&nbsp;</td>
<td width="619" align="left"  valign="middle" class="tbltext" colspan="3">&nbsp;<?php if($row_tbl_sub['noofbin_good']>0){ echo $row_tbl_sub['noofbin_good'];} else { echo $row_tbl_sub['noofbin_damage']; }?></td>
</tr>
</table>
<br/>
<?php
...
?>
<?php
$sql_sub_sloc=mysql_query("select * from tblarr_sloc where arr_id='".$row_tbl_sub['arrsub_id']."' and arr_tr_id='".$arrival_id."' and qty_good=0 and ups_good=0") or die(mysql_error());
$tot_sub_sloc=mysql_num_rows($sql_sub_sloc);
$flash=0;
while($row_sub_sloc=mysql_fetch_array($sql_sub_sloc))
{
...
<table align="center" height="27" width="100%"  border="1" cellspacing="0" cellpadding="0" bordercolor="#4ea1e1" style="border-collapse:collapse" ><tr>
<td align="right" width="49"  valign="middle" class="tblheading">&nbsp;UPS &nbsp;</td>
<td  align="left" width="83"  valign="middle" class="tbltext">&nbsp;<?php echo $row_sub_sloc['ups_damage'];?></td>	
<td  align="right" width="45"  valign="middle" class="tblheading">&nbsp;Qty &nbsp;</td>
<td width="135" align="left"  valign="middle" class="tbltext">&nbsp;<?php echo $row_sub_sloc['qty_damage'];?></td>
</tr></table></div></td>
</tr>
</table>
...
<td width="48" align="right"  valign="middle" class="tblheading">&nbsp;UPS &nbsp;</td>
<td width="80" align="left"  valign="middle" class="tbltext">&nbsp;<?php echo $row_sub_sloc['ups_damage'];?></td>	
<td width="46" align="right"  valign="middle" class="tblheading">&nbsp;Qty &nbsp;</td>
<td width="130"  align="left"  valign="middle" class="tbltext">&nbsp;<?php echo $row_sub_sloc['qty_damage'];?></td>
</tr></table></div></td>
</tr>
</table>
<?php
...
<tr >
<td valign="top" align="right"><a href="edit_stock.php?p_id=<?php echo $pid;?>"><img src="../images/edit.gif" border="0"style="display:inline;cursor:pointer;" /></a>&nbsp;&nbsp;<a href="Javascript:void(0)" onclick="openslocpopprint();"><img src="../images/printpreview.gif" border="0"style="display:inline;cursor:pointer;" /></a>&nbsp;&nbsp;<input name="Submit" type="image" src="../images/finalsubmit.gif" alt="Submit Value"  border="0" style="display:inline;cursor:hand;" tabindex="" onClick="return mySubmit();">&nbsp;&nbsp;</td>
</tr>
</table>
<td width="30"></td>
</tr>
