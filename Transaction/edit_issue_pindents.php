<?php
	...
	{ 
		...
		echo "<script>window.location='add_issue_pindents_preview.php?p_id=$p_id&remarks=$remarks'</script>";	
	}
//}
//}
$a="IP";
...
<title>Stores- Tranasction -edit issue Pindent</title>
...
<tr class="Dark" height="25">
           ...
           <td width="169" align="left"  valign="middle">&nbsp;<?php echo "TIP".$row['issue_code']."/".$yearid_id."/".$lgnid;?></td>
		 ...
		 <tr class="Light" height="25">
           ...
           <td align="left"  valign="middle">&nbsp;<input name="txtindent" type="text" size="15" class="tbltext" tabindex="0" maxlength="15" value="<?php echo $row['dcrefno'];?>" />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
       
           <td width="185" height="24"  align="right"  valign="middle" class="tblheading">Physical Indent Raised by&nbsp;</td>
           <td align="left"  valign="middle">&nbsp;<input name="txtphysical" type="text" size="15" class="tbltext" tabindex="0" maxlength="25" onchange="indentnochk();" value="<?php echo $row['strefno'];?>" />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
         </tr>
		 <tr class="Dark" height="25">
           <td width="134" height="24"  align="right"  valign="middle" class="tblheading">P-Indent Date &nbsp;</td>
           <td align="left"  valign="middle" colspan="3">&nbsp;<input name="edate" id="edate" type="text" size="10" class="tbltext" tabindex="0" readonly="true"  value="<?php echo date("d-m-Y", time());?>" style="background-color:#EFEFEF" />&nbsp;<a href="javascript:void(0)" onClick="imgOnClick1(document.frmaddDept.edate,-100,-100)" tabindex="6"><img src="../images/cal.gif" alt="Calender" border="0" align="absmiddle"></a><script type="text/javascript" language="javascript" src="../include/popcalender.js"></script></td>
         </tr>
</table>
<br />
<div id="maindiv">
...
<input type="hidden" name="srno" value="" /> <input type="hidden" name="chkbox" value=""/> <input type="hidden" name="srno1" value=""/><input type="hidden" name="edtrowid" value="" />
</table>
