...
if($printopt=="3"){
echo "<script>window.location='home_bincard_print.php'</script>";	
}
}
?>
...
{
alert("Please select issue Note");
return false;
}
	return true;	 
}
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#4ea1e1" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp; Transction - Issue Note </td>
	    </tr></table></td>
...
<td width="85"  align="right"  valign="left" class="tbltext">&nbsp;
  <input type="radio" name="fet" value="1" onClick="test1(this.value);" /></td>
    <td width="223" align="left"  valign="middle" class="tblheading">&nbsp;Issue Note </td>
</tr>
<tr class="Light" height="25">
...
<td  align="right"  valign="left" class="tbltext">&nbsp;
 ...
 <td width="223" align="left"  valign="middle" class="tblheading">&nbsp;Bin Card Print </td >
 </tr>
</table>
