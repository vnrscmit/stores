...
$sql_sub="insert into tblarrival_sub (arrival_id, classification_id, item_id, qty_per_dc, ups_per_dc, qty_good, ups_good, qty_damage, ups_damage, exsh_qty, exsh_ups, noofbin_good, noofbin_damage,uom) values('$mainid','$n','$o','0','0','$s','$r','$t','$u','0','0','$x','$n1','$txtuom')";
...
if($god2==1)
{
$sql_sub_sub="insert into tblarr_sloc (arr_type, arr_tr_id, arr_id, classification_id, item_id, whid, binid, subbin, qty_good, ups_good, qty_damage, ups_damage, rowid) values('Internalreturn','$mainid','$subid','$n','$o','$d1','$e1','$f1','$g1','$h1','0','0', '$rowid2')";
mysql_query($sql_sub_sub) or die(mysql_error());
}
if($god3==1)
{
$sql_sub_sub="insert into tblarr_sloc (arr_type, arr_tr_id, arr_id, classification_id, item_id, whid, binid, subbin, qty_good, ups_good, qty_damage, ups_damage, rowid) values('Internalreturn','$mainid','$subid','$n','$o','$i1','$j1','$k1','$l1','$m1','0','0', '$rowid3')";
mysql_query($sql_sub_sub) or die(mysql_error());
}

if($dam1==1)
{
$sql_sub_sub="insert into tblarr_sloc (arr_type, arr_tr_id, arr_id, classification_id, item_id, whid, binid, subbin, qty_good, ups_good, qty_damage, ups_damage, rowid) values('Internalreturn','$mainid','$subid','$n','$o','$o1','$p1','$q1','0','0','$r1','$s1', '$rowid4')";
mysql_query($sql_sub_sub) or die(mysql_error());
}
if($dam2==1)
{
$sql_sub_sub="insert into tblarr_sloc (arr_type, arr_tr_id, arr_id, classification_id, item_id, whid, binid, subbin, qty_good, ups_good, qty_damage, ups_damage, rowid) values('Internalreturn','$mainid','$subid','$n','$o','$t1','$u1','$v1','0','0','$w1','$x1', '$rowid5')";
mysql_query($sql_sub_sub) or die(mysql_error());
}
}
}
...
$sql_main="update tblarrival set arrival_type='Internalreturn', arrival_code='$code', arrival_date='$tdate', party_id='$partyid', stageret='$txtstage', retid='$txtrd', remarks='$y1', arr_role='$logid' where arrival_id = '$z1'";

if(mysql_query($sql_main) or die(mysql_error()))
{
$mainid=$z1;

$s_sub="delete from tblarrival_sub where arrsub_id='".$subtrid."'";
mysql_query($s_sub) or die(mysql_error());
$s_sub_sub="delete from tblarr_sloc where arr_id='".$subtrid."'";
...
<td align="right"  valign="middle" class="tblheading">Quantity Damage&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
