...
<tr class="Dark">
		 ...
		 <tr class="Dark">
		   ...
		   <tr class="Dark" height="45">
			 <td width="109"  align="right" valign="middle" class="smalltblheading">&nbsp;Address&nbsp;</td>
    <td colspan="5" align="left"  valign="top" class="tbltext">&nbsp;</td>
         </tr>
		
  <tr class="Dark">
           <td width="128" align="right"  valign="middle" class="smalltblheading">CCR&nbsp;</td>
           <td align="left"  valign="middle">&nbsp;</td>
			<td width="109" align="right"  valign="middle" class="smalltblheading">CC &nbsp;</td>
           <td width="178" align="left"  valign="middle">&nbsp;</td>
			
			<td width="80" align="right"  valign="middle" class="smalltblheading">CCR Date &nbsp;</td>
...
<table align="center" border="1" cellspacing="0" cellpadding="0" width="694" bordercolor="#4ea1e1" style="border-collapse:collapse">
  <tr class="tblsubtitle" height="25">
    ...
    <td width="65" align="center" class="tblheading" valign="middle">UPS</td>
	  <td width="64" align="center" class="tblheading" valign="middle">Quantity</td>
	   <td width="64" align="center" class="tblheading" valign="middle">Good/Damage</td>
			 ...
			 <td width="11%" align="center" rowspan="2" valign="middle" class="tblheading">Sloc</td>
              <td width="12%" rowspan="2" align="center" valign="middle" class="tblheading">UPS</td>
			   <td width="11%" rowspan="2" align="center" valign="middle" class="tblheading">Qty</td>
			    <td colspan="2" height="23" align="center" valign="middle" class="tblheading">External Cc</td>
...
<tr >
<td valign="top" align="center"><a href="add_capative _consumption.php"><img src="../images/back.gif" border="0"  style="display:inline;cursor:hand;"/></a>&nbsp;<a href="javascript:document.frmaddDept.reset()"></a>&nbsp;<input name="Submit" type="image" src="../images/submit_1.gif" alt="Submit Value" onClick="return mySubmit();"  border="0" style="display:inline;cursor:hand;"></td>
</tr>
</table>
</td><td width="30"></td>
</tr>
