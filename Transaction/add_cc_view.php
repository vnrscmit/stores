	...
	while($row_arrsub=mysql_fetch_array($sql_arrsub))
	{
		...
		while($row_arrsub_sub=mysql_fetch_array($sql_arrsub_sub))
		{
			...
			$qty=$row_arrsub_sub['qty_issue'];
				...
				$sql_sub_sub="insert into tbl_stldg_good (stlg_trtype, stlg_trsubtype, stlg_trid, stlg_trpartyid, stlg_trdate, stlg_trclassid, stlg_tritemid, stlg_whid, stlg_binid, stlg_subbinid, stlg_opups, stlg_opqty, stlg_trups, stlg_trqty, stlg_balups, stlg_balqty) values('CC', 'CC', '$pid', '$partyid', '$trdate', '$classid', '$itemid', '$whid', '$binid', '$subbinid', '$opups', '$opqty', '$ups', '$qty', '$balups', '$balqty')";
...
<td width="204"  align="left" valign="middle" class="tbltext">&nbsp;<?php echo "CC".$row['cc_code']."/".$yearid_id."/".$lgnid;?></td>
...
<tr >
<td valign="top" align="right"><a href="c_c_home.php?p_id=<?php echo $pid;?>"><img src="../images/back.gif" border="0"style="display:inline;cursor:pointer;" /></a>&nbsp;&nbsp;<a href="Javascript:void(0)" onclick="openslocpopprint();"><img src="../images/printpreview.gif" border="0"style="display:inline;cursor:pointer;" /></a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
</tr>
