...
if($printopt == "1" )
{
	echo "<script>window.location='stock_transferop.php'</script>";	
}
if($printopt<="2"){
echo "<script>window.location='bin_status_home.php'</script>";	
}
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#b9d647" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transction:Stock Transfer </td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
<table align="center" border="1" width="314" cellspacing="0" cellpadding="0" bordercolor="#b9d647" style="border-collapse:collapse" > 
...
<td width="85"  align="right"  valign="left" class="tbltext">&nbsp;
  <input type="radio" name="fet" value="1" onClick="test1(this.value);" /></td>
    <td width="223" align="left"  valign="middle" class="tblheading">&nbsp;Stock Transfer o/p </td>
</tr>
<tr class="Light" height="25">
<td  align="right"  valign="left" class="tbltext">&nbsp;
  <input type="radio" name="fet" value="2" onClick="test1(this.value);" /></td>
 <td width="223" align="left"  valign="middle" class="tblheading">&nbsp;Bin Status Card  </td >
 </tr>
</table>
