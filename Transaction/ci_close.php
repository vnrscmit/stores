...
<table width="370" height="282" border="0" align="center" cellpadding="0" cellspacing="0" >
  ...
  <td colspan="4" align="center" class="subheading" valign="middle" height="25">Cycle Inventory Closing</td>
</tr>
 ...
 <?php
	...
	*/
	...
	$sql_yr2=mysql_query("delete from tbl_ci where ci_id='$pid'")or die("Error:".mysql_error());
	
	$sql_yr3=mysql_query("delete from tbl_ciupdation  where ci_id='$pid'")or die("Error:".mysql_error());
	
	$sql_yr3=mysql_query("delete from tbl_stldg_good  where stlg_trtype='CI' and stlg_trsubtype='CI' and stlg_trid='$pid'")or die("Error:".mysql_error());
...
<td align="center"  valign="middle" class="tblheading">You have successfully closed CI:<?php echo $sql_yr2;?></td>
</tr>
