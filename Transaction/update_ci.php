...
<table align="center" border="0" cellspacing="0" cellpadding="0" width="750" style="border-collapse:collapse">
  <tr height="25" >
    <td colspan="8" align="center" class="subheading" style="color:#303918; "> Update Cycle Inventory(
      <?php //=$total_results;?>)</td>
  </tr>
  </table>
<table align="center" border="1" cellspacing="0" cellpadding="0" width="733" bordercolor="#4ea1e1" style="border-collapse:collapse">

            <tr class="tblsubtitle" height="35">
              <td width="2%" rowspan="2" align="center" valign="middle" class="tblheading">#</td>
			    <td width="10%" rowspan="2" align="center" valign="middle" class="tblheading">Classification </td>
				 <td width="7%" rowspan="2" align="center" valign="middle" class="tblheading">Item</td>
			    <td width="3%" rowspan="2" align="center" valign="middle" class="tblheading">UoM</td>
			 ...
			 <td colspan="3" height="23" align="center" valign="middle" class="tblheading">Difference is Stock</td>
			  <td width="10%" rowspan="2" align="center" valign="middle" class="tblheading">Remarks</td>
			   </tr>
			<tr class="tblsubtitle">
			 <td width="11%" align="center" valign="middle" class="tblheading">SLOC 1</td>
				   ...
				   <td width="2%" align="center" valign="middle" class="tblheading">UPS</td>
				      <td width="11%" align="center" valign="middle" class="tblheading">Qty</td>
					    <td width="11%" align="center" valign="middle" class="tblheading">Date of CI</td>
              </tr>
            ...
            <td valign="middle" class="tbltext" align="center">&nbsp;</td>
			 <td valign="middle" class="tbltext" align="center">&nbsp;</td>
              <td width="11%" align="center" valign="middle" class="smalltbltext">&nbsp;</td>
             
              <td width="7%" align="center" valign="middle" class="smalltbltext">&nbsp;</td>
			   
			   <td width="2%" align="center" valign="middle" class="smalltbltext"><input name="txtid" type="text" size="5" class="tbltext" tabindex="" readonly="true" style="background-color:#CCCCCC" /></td>
			   <td width="11%" align="center" valign="middle" class="tblheading"><input name="txtid" type="text" size="5" class="tbltext" tabindex="" readonly="true" style="background-color:#CCCCCC" /></td>
			    <td width="11%" align="center" valign="middle" class="tblheading">&nbsp;</td>
				  <td width="11%" align="center" valign="middle" class="tblheading">&nbsp;</td>
			    <td width="11%" align="center" valign="middle" class="tblheading">&nbsp;</td>
				  <td width="11%" align="center" valign="middle" class="tblheading">&nbsp;</td>
				  <td width="11%" align="center" valign="middle" class="tblheading">&nbsp;</td>
