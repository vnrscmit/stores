...
winHandle=window.open('issue_eindent_print.php?tid='+itm+'&pid='+pid,'WelCome','top=170,left=180,width=820,height=350,scrollbars=yes');
if(winHandle==null){
...
<table width="1003" height="600" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;<a href="stores_home.php" style="text-decoration:underline; cursor:hand; color:#404d21;"></a>Transction Issue- e-Indent - View</td>
	    </tr></table></td>
 ...
 <?php
	...
	$sql2=mysql_query("select * from tbl_ieindent where tid=$tid")or die(mysql_error());
...
<tr class="tblsubtitle" height="20">
  <td colspan="6" align="center" class="tblheading">Issue Internal - e-Indent</td>
</tr>
  <tr height="15" class="Light">
   ...
   <?php
	...
	$resettargetquery=mysql_query("select * from tbl_roles where id='".$row2['id']."'");
...
<td width="215"  align="left" valign="middle" class="tbltext">&nbsp;<?php echo "IE".$row['iss_code']."/".$yearid_id."/".$irole;?></td>
...
<td width="215"  align="left" valign="middle" class="tbltext">&nbsp;<input name="indentno" type="text" size="5" class="tbltext" tabindex="0"  readonly="true" style="background-color:#CCCCCC" value="<?php echo $row2['code'];?>"  />&nbsp; </td>
...
<table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#4ea1e1" style="border-collapse:collapse" >
<tr class="Dark" height="30">
<td width="12%" align="center" valign="middle" class="tblheading">&nbsp;Issuer Remarks&nbsp;</td>
...
<tr >
<td width="791" align="right" valign="top"><a href="home_transction_issue_einternal.php"><img src="../images/back.gif" border="0"style="display:inline;cursor:hand;" /></a>&nbsp;&nbsp;</td>
</tr>
