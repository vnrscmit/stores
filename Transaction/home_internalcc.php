...
<title>Stores-Transaction - Add HOD</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="739" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="740" height="25">&nbsp;Transaction - Internal Captive Consumption </td>
	    </tr></table></td>
...
<a href="add_internalcc.php" style="text-decoration:none; color:#FFFFFF"><td align="center" width="200" valign="middle" class="tblbutn" style="cursor:hand;">Add Internal CC </td></a>
</tr>
