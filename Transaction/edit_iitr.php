...
$a="IT";
	...
	{
	$sql_code="SELECT MAX(tcode) FROM tbl_iitr ORDER BY tcode DESC";
	}
...
<title>stores - Transction- Edit Inter Item Transfer</title>
...
<form id="mainform" name="frmaddDepartment" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>"   > 
	 <input name="frm_action" value="submit" type="hidden"> 
	  ...
	  <input type="hidden" name="code" value="<?php echo $row['tcode'];?>" />
...
<td width="205" height="24"  align="right"  valign="middle" class="tblheading">&nbsp;Transaction Id &nbsp;</td>
<td width="282"  align="left" valign="middle" class="tbltext">&nbsp;<input name="txtid" type="text" size="20" class="tbltext" tabindex="" readonly="true" style="background-color:#CCCCCC"  value="<?php echo "TIT".$row['tcode']."/".$yearid_id."/".$lgnid;?>"/></td>

 <td width="134" height="24"  align="right"  valign="middle" class="tblheading">Transfer &nbsp;Date&nbsp;</td>
 <td width="219"  align="left" valign="middle" class="tbltext">&nbsp;<input name="txtdate" type="text" size="6" class="tbltext" tabindex="0"  readonly="true" style="background-color:#CCCCCC"  value="<?php echo $tdate;?>"/>&nbsp;</td>
</tr>
<?php 
...
<option value="" >--Select Item--</option>
	<?php while($noticia_item = mysql_fetch_array($itemqry)) { ?>
		<option <?php if($row['items_id_from']==$noticia_item['items_id']){ echo "Selected";} ?> value="<?php echo $noticia_item['items_id'];?>" />   
...
<td width="184"  align="left" valign="middle" class="tbltext" id="uom">&nbsp;<input name="txtuom" type="text" size="10" class="tbltext" tabindex="0" readonly="true" style="background-color:#CCCCCC"  value="<?php echo $row['uom_from'];?>" /></td>
         </tr>
<tr class="Light" height="25">
            <td width="205" height="24"  align="right"  valign="middle" class="tblheading">Type &nbsp; </td>
            <td align="left"  valign="middle" colspan="3">&nbsp;<?php echo $row['typ'];?><input name="txt1" type="hidden" class="tbltext" onClick="chktyp(this.value);" value="good" /> </td>
         </tr>
</table>
<div id="maindiv">
<table align="center" border="1" width="900" cellspacing="0" cellpadding="0" bordercolor="#4ea1e1" style="border-collapse:collapse" > 
