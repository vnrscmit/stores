...
//frm_action=submit &code=1 &tid= &txtcode=IE1 &txtdate=26-06-2009 &txtindent=3216456 &txtphysical=Ram &pdate=26-06-2009 &txtclass=75 &txtitem=116 &txtuom=Number &txtups=10 &txtqty=100 &slocissue=70 &upsavl_1=20 &qtyavl_1=200 &issueups_1=10 &issueqty_1=100 &balups_1=10 &balqty_1=100 &upsavl_2=5 &qtyavl_2=0 &issueups_2= &issueqty_2= &balups_2= &balqty_2= &upsavl_3=50 &qtyavl_3=500 &issueups_3= &issueqty_3= &balups_3= &balqty_3= &upsavl_4=456 &qtyavl_4=456 &issueups_4= &issueqty_4= &balups_4= &balqty_4= &upsavl_5=45 &qtyavl_5=5 &issueups_5=&issueqty_5= &balups_5= &balqty_5= &upsavl_6=45 &qtyavl_6=45 &issueups_6= &issueqty_6= &balups_6= &balqty_6= &upsavl_7=90 &qtyavl_7=90 &issueups_7= &issueqty_7= &balups_7= &balqty_7= &upsavl_8=0 &qtyavl_8=1042 &issueups_8= &issueqty_8= &balups_8= &balqty_8= &srno=9 &chkbox=70 &srno1=1 &tt=
...
if($trid == 0)
{
$sql_main="insert into tblissue (issue_type, issue_code, issue_date, dcrefno, issue_role) values('pindent','$code','$tdate','$indentno','$logid')";
...
<tr class="Dark" height="25">
              ...
              <td align="center" width="15%" class="smalltbltext" valign="middle"><?php echo $slocs;?></td>
              <td width="4%" align="center" valign="middle" class="smalltbltext"><?php echo $opups1;?></td>
              <td valign="middle" class="smalltbltext" align="center"><?php echo $opqty1;?></td>
              <td width="4%" align="center" valign="middle" class="smalltbltext"><?php echo $sups;?></td>
              <td width="5%" align="center" valign="middle" class="smalltbltext"><?php echo $sqty;?></td>
              <td width="5%" align="center" valign="middle" class="smalltbltext"><?php echo $balups1;?></td>
              <td width="5%" align="center" valign="middle" class="smalltbltext"><?php echo $balqty1;?></td>
              <td valign="middle" class="tbltext" align="center"><img src="../images/edit.png" border="0" style="display:inline;cursor:hand;" onclick="editrecord(<?php echo $erid;?>);" /></td>
              <td valign="middle" class="tbltext" align="center"><img border="0" src="../images/delete.png"  /></td>
...
<td width="169" colspan="3" align="left" valign="middle" class="tbltext" >&nbsp;<input name="txtqty" type="text" size="10" class="tbltext" tabindex="0" maxlength="7" onchange="piqtychk(this.value);" onkeypress="return isNumberKey(event)" />&nbsp;</td>
         </tr>
</table><input type="hidden" name="trid" value="<?php echo $trid?>" />
<br />
<div id="subdiv">
