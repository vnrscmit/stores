...
//$a="c";
	//$a="c";
	$s_chk=mysql_query("SELECT * FROM tblarrival where yearcode='$yearid_id' and arrival_type='Vendor'") or die (mysql_error());
	$r_chk=mysql_num_rows($s_chk);
	if($r_chk > 0)
	$sql_code="SELECT MAX(arrival_code) FROM tblarrival where yearcode='$yearid_id' and arrival_type='Vendor' ORDER BY arrival_code DESC";
	else
	$sql_code="SELECT MAX(arrival_code) FROM tblarrival where arrival_type='Vendor' and yearcode='$yearid_id' ORDER BY arrival_code DESC";
		...
		if(mysql_num_rows($res_code) > 0)
			{
				...
				$t_code=$row_code['0'];
				$code=$t_code+1;
				$code1="TAV".$code."/".$yearid_id."/".$lgnid;
		}
...
<td width="259" colspan="3" align="left" valign="middle" class="tbltext">&nbsp;<input name="date" type="text" size="10" class="tbltext" tabindex="0"  style="background-color:#CCCCCC" readonly="true" value="<?php echo date("d-m-Y");?>" maxlength="10"/>&nbsp;</td>
</tr>
...
<table align="center" width="850" cellpadding="5" cellspacing="5" border="0" >
<tr >
<td valign="top" align="right"><a href="add_arrival_vendor1.php" tabindex="20"><img src="../images/cancel.gif" border="0"style="display:inline;cursor:pointer;" onclick="return confirm('Do You wish to Cancel this Transaction?');" /></a>&nbsp;&nbsp;<input name="Submit" type="image" src="../images/preview.gif" alt="Submit Value"  border="0" style="display:inline;cursor:pointer;" tabindex="" onClick="return mySubmit();">&nbsp;&nbsp;</td>
</tr>
</table>
</td><td width="30"></td>
</tr>
