...
if(isset($_POST['frm_action'])=='submit')
	{
	    ...
	    $sql_in="update tbl_viewer set login='$login',
									pass='$pass',
									email='$email'
									where vid='$loginid'";
											//exit;
		...
		{ 
         $sql_in1="Update tbl_user set	loginid='$login',
										password='$pass',
										email='$email'
										where role='viewer' and scode='$scode'";	
...
<title>stores - Transction-Viewer Profile</title>
...
<!-- actual page start--->	
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Viewer Profile </td>
	    </tr></table></td>
 ...
 <?php
	$result=mysql_query("SELECT * FROM tbl_viewer where vid='".$loginid."'")or die(mysql_error()); 
...
<td colspan="2" align="center" class="tblheading" valign="middle">Viewer Profile </td>
</tr>
...
<tr >
<td valign="top" align="center"><input name="Submit" type="image" src="../images/update.gif" alt="Submit Value" OnClick="return mySubmit()" border="0" style="display:inline;cursor:hand;"></td>
</tr>
</table>
</td><td width="30"></td>
</tr>
