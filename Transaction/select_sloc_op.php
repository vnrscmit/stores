...
<title>stores - Transction-Good Damage O/P</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction: SLOC Updation - Output Selection </td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
<table align="center" border="0" cellspacing="0" cellpadding="0" width="750" bordercolor="#4ea1e1" style="border-collapse:collapse">
  <tr height="25" >
    <td colspan="8" align="center" class="subheading" style="color:#303918; ">Original Locations</td>
  </tr>
  </table>
...
<table align="center" border="0" cellspacing="0" cellpadding="0" width="750" bordercolor="#4ea1e1" style="border-collapse:collapse">
  <tr height="25" >
    <td colspan="8" align="center" class="subheading" style="color:#303918; ">Changed Locations</td>
  </tr>
  </table>
<table align="center" border="1" cellspacing="0" cellpadding="0" width="750" bordercolor="#4ea1e1" style="border-collapse:collapse">
  <tr class="tblsubtitle" height="25">
...
if($a=="good")
	{
$sql_tbl=mysql_query("select * from tbl_stldg_good where stlg_trtype='SLOC' and stlg_trsubtype='SUC' and stlg_trid='".$pid."'") or die(mysql_error());
...
{
$sql_tbl=mysql_query("select * from tbl_stldg_damage where stld_trtype='SLOC' and stld_trsubtype='SUC' and stld_trid='".$pid."'") or die(mysql_error());
...
<tr >
<td valign="top" align="center"><a href="add_arrival.php"><img src="../images/back.gif" border="0"style="display:inline;cursor:pointer;" /></a>&nbsp;&nbsp;&nbsp;
