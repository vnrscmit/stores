<?php
	...
	/*$sql_main="update tbl_dtog set dgflg=1, dcode=$code  where did = '$pid'";
...
<title>stores - Transaction: Damage to Good - Output Selection </title>
...
winHandle=window.open('dg_issue_note_print.php?itmid='+itm,'WelCome','top=170,left=180,width=820,height=450,scrollbars=yes');
if(winHandle==null){
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction: Damage to Good - Output Selection </td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
<tr class="Light" height="25">
    ...
    <td align="center"  valign="middle" class="tblheading">&nbsp;<a href="Javascript:void(0)" onclick="openslocpopprint();">Damage to Good Note (D2GN)</a></td>
</tr>
</table>
<?php
	

$sql_tbl=mysql_query("select * from tbl_stldg_damage where stld_trtype='DG' and stld_trsubtype='$tp' and stld_trid='".$pid."'") or die(mysql_error());
...
<br />
<?php
//$sql_tbl=mysql_query("select * from tbl_stldg_good where stlg_trtype='DG' and stlg_trsubtype='$tp' and stlg_trid='".$pid."'") or die(mysql_error());
/*$row_tbl=mysql_fetch_array($sql_tbl);			
$issue_id=$row_tbl['issue_id'];
*/
?>
...
<?php
$srno=1;
$sql_issue=mysql_query("select distinct stlg_whid, stlg_subbinid, stlg_binid from tbl_stldg_good where stlg_trtype='DG' and stlg_trsubtype='$tp' and stlg_trid='".$pid."'") or die(mysql_error());
...
$sql_tbl=mysql_query("select * from tbl_stldg_good where stlg_id='".$row_issue1[0]."' and stlg_balqty > 0") or die(mysql_error()); 
...
<tr >
<td valign="top" align="center"><a href="add_d.php"><img src="../images/back.gif" border="0"style="display:inline;cursor:pointer;" /></a>&nbsp;&nbsp;&nbsp;
