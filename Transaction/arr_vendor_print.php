...
<td align="left"  valign="middle" class="tbltext" colspan="5"><div align="justify" class="tbltext" style="padding:2px 5px 5px 5px"><?php echo $row3['business_name'];?><br />
<?php echo $row3['address'];?>, <?php echo $row3['city'];?> - <?php echo $row3['pin'];?>, <?php echo $row3['state'];?>, <?php echo $row3['country'];?><br />
...
?>
			<tr class="tblsubtitle" height="20">
			 ...
			 <td width="18%" align="center" rowspan="3" valign="middle" class="tblheading">Classification</td>
              <td width="23%" rowspan="3" align="center" valign="middle" class="tblheading">Item</td>
...
<td width="156" align="left"  valign="middle" class="tbltext">&nbsp;<?php echo $row_param['tin'];?></td>

<td width="32" align="right"  valign="middle" class="tblheading">CST:&nbsp;</td>
<td width="151" align="left"  valign="middle" class="tbltext">&nbsp;<?php echo $row_param['cst_no'];?></td>

<td width="112" align="right"  valign="middle" class="tblheading">Seed License No.:&nbsp;</td>
<td width="259" align="left"  valign="middle" class="tbltext">&nbsp;<?php echo $row_param['licence_no'];?></td>
</tr>
</table>
