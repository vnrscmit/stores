...
$s_sub="delete from tbl_captivesub where eid='".$b."'";
mysql_query($s_sub) or die(mysql_error());
$s_sub_sub="delete from tbl_captive_sloc where isue_id='".$b."'";
mysql_query($s_sub_sub) or die(mysql_error());

$sql_t_sub=mysql_query("select * from tbl_captivesub where id_in='".$a."'") or die(mysql_error());
