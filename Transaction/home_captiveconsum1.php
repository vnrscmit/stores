...
if($printopt == "1" )
{
	echo "<script>window.location='add_internalcc.php'</script>";	
}
if($printopt<="2"){
echo "<script>window.location='add_capative _consumption.php'</script>";	
}
}
?>
...
<tr class="tblsubtitle" height="25">
  <td colspan="4" align="center" class="tblheading">Select Captive Consumption </td>
</tr>
<tr class="Light" height="25">
<td width="85"  align="right"  valign="left" class="tbltext">&nbsp;
  <input type="radio" name="fet" value="1" onClick="test1(this.value);" /></td>
    <td width="223" align="left"  valign="middle" class="tblheading">&nbsp;Internal Captive Consumption </td>
</tr>
<tr class="Light" height="25">
<td  align="right"  valign="left" class="tbltext">&nbsp;
  <input type="radio" name="fet" value="2" onClick="test1(this.value);" /></td>
 <td width="223" align="left"  valign="middle" class="tblheading">&nbsp;External Captive Consumption</td >
 </tr>
</table>

<table align="center" width="327" cellpadding="5" cellspacing="5" border="0" >
<tr >
<td width="324" align="center" valign="top"><input name="Submit" type="image" src="../images/next.gif" alt="next" OnClick="return mySubmit()" border="0" style="display:inline;cursor:hand;">&nbsp;<input type="hidden" name="fet1" value="" /></td>	
</tr>
</table>
