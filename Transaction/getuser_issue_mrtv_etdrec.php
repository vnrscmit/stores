...
<td width="146" align="left" valign="middle" class="tbltext" id="uom">&nbsp;<input name="txtuom" type="text" size="10" class="tbltext" tabindex="" maxlength="7" readonly="true" style="background-color:#CCCCCC" value="<?php echo $row_issuesub['uom'];?>"  />&nbsp;</td>
...
<td width="169"  align="left" valign="middle" class="tbltext" >&nbsp;<input name="txtqty" type="text" size="10" class="tbltext" tabindex="0" maxlength="7" onchange="piqtychk(this.value);" onkeypress="return isNumberKey(event)" value="<?php echo $row_issuesub['qty_indent'];?>" />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
         </tr> <input name="txtrettyp" type="hidden" class="tbltext" value="good"  />


</table><input name="txtrettype" value="<?php echo $row_issuesub['rettype'];?>" type="hidden"> 
<br />
<div id="subdiv">
...
$sql_issue1=mysql_query("select max(stlg_id) from tbl_stldg_good where stlg_subbinid='".$row_issue['stlg_subbinid']."' and stlg_binid='".$row_issue['stlg_binid']."' and stlg_whid='".$row_issue['stlg_whid']."'  and stlg_tritemid='".$row_issue['stlg_tritemid']."'") or die(mysql_error());
