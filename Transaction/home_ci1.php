...
{	
	...
	{*/
	if(confirm('If you abort Cycle Inventory transaction then all the items (if any) updated during the updation of CI will get removed and items will come back to its original UPS & Qty position. Record of this transaction will also get removed from the system. Do you really want to abort Cycle Inventory Transaction? OK Cancel'))
	{
		//var locid=document.frmcreatedb.locid.value;
		winHandle=window.open('ci_close.php?p_id='+p_id,'WelCome','top=170,left=180,width=420,height=350,scrollbars=yes');
		if(winHandle==null){
   ...
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <td width="940" class="Mainheading" height="25">
	   ...
	   <table width="809" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="810" height="25">&nbsp;Transction - Pending CI</td>
	    </tr></table></td>
...
<td align="center" width="100" valign="middle" class="tblbutn" style="cursor:hand;"><?php if($flg==0 && $flg1==0 && $flg2==0) { ?><a href="add_ci.php" style="text-decoration:none; color:#FFFFFF">Add </a><?php } else { ?><a href="Javascript:void(0);" onclick="alert('Can not perform Transaction.\nReason:\n1. Todays date is not in Active Current Financial Year.\n2. Transaction after todays date has been made.\n3. Cycle Inventory transaction is under process.');" style="text-decoration:none; color:#FFFFFF">Add </a><?php } ?></td>
</tr>
</table></td>
	<?php
	}
	...
	<td width="940" class="Mainheading" height="25">
	 <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="940" height="25">&nbsp;Transction - Pending CI</td>
	    </tr></table></td>
	<?php
	}
	?>
...
<?php
	 ...
	 */
	$sql_sel="select * from tbl_ci where ci_upflg=0 order by yearcode desc, ci_code desc";
	$res=mysql_query($sql_sel) or die (mysql_error());
	
	$total=mysql_num_rows($res);
	$total_results = mysql_result(mysql_query("SELECT COUNT(*) as Num FROM tbl_ci where ci_upflg=0"),0); 

	
?>
<table align="center" border="0" cellspacing="0" cellpadding="0" width="750" style="border-collapse:collapse">
  <tr height="25" >
    <td colspan="8" align="center" class="subheading" style="color:#303918; ">Pending  CI(<?php echo $total_results;?>)</td>
  </tr>
  </table>
<table align="center" border="1" cellspacing="0" cellpadding="0" width="580" bordercolor="#4ea1e1" style="border-collapse:collapse">
  <tr class="tblsubtitle" height="25">
    <td width="22" align="center" class="tblheading" valign="middle">#</td>
    <td width="93" align="left" class="tblheading" valign="middle">&nbsp;Transaction Id </td>
    <td width="70" align="center" class="tblheading" valign="middle">Date</td>
    <td width="161" align="center" class="tblheading" valign="middle">Classification</td>
    <td width="105" align="center" class="tblheading" valign="middle">CI Report Updation</td>
	<?php
	if($role=="admin")
	{
	?>
    <td width="88" align="center" class="tblheading" valign="middle">Abort CI Transaction</td>
	<?php
	}
	?>
	  </tr>
...
<tr class="Light" height="25">
    ...
    <td valign="middle" class="tbltext" align="left">&nbsp;<?php echo "CI".$row['ci_code'];?></td>
    <td valign="middle" class="tbltext" align="center"><?php echo $tdate;?></td>
    <td valign="middle" class="tbltext" align="center"><?php echo $row['classification_id'];?></td>
    <td valign="middle" class="tbltext" align="center"><a href="select_ci.php?p_id=<?php echo $row['ci_id'];?>">Update</a></td>
	<?php
	if($role=="admin")
	{
	?>
	<td valign="middle" class="tbltext" align="center"><a href="Javascript:void(0)" onclick="closeci('<?php echo $row['ci_id'];?>');">Abort</a></td>
	<?php
	}
	?>
	</tr>
...
<br/>
<table align="center" border="0" cellspacing="0" cellpadding="0" width="505" style="border-collapse:collapse">
  <tr height="25" >
    <td width="612" colspan="8" align="center" class="subheading" style="color:#303918; ">Search in between dates(<?php //=$total_results;?>)</td>
  </tr>
  </table>
<table align="center" border="1" cellspacing="0" cellpadding="0" width="580" bordercolor="#4ea1e1" style="border-collapse:collapse">
  <tr class="tblsubtitle" height="25">
       <td width="101" align="right" class="tblheading" valign="middle">From date&nbsp;</td>
    <td width="81" align="left" class="tblheading" valign="middle">&nbsp;<input name="txtid" type="text" size="5" class="tbltext" tabindex="" readonly="true" style="background-color:#CCCCCC" /></td>
    <td width="158" align="right" class="tblheading" valign="middle">To date&nbsp;</td>
    <td width="102" align="left" class="tblheading" valign="middle">&nbsp;<input name="txtid" type="text" size="5" class="tbltext" tabindex="" readonly="true" style="background-color:#CCCCCC" /></td>
	 <td width="102" align="center" class="tblheading" valign="middle"><img src="../images/search.gif" border="0"  style="display:inline;cursor:hand;"/></td>
    </tr>
...
$targetpage = $PHP_SELF; 
  ...
  $sql_arr_home=mysql_query("select * from tbl_ci where ci_upflg!=0 order by ci_code desc LIMIT $start, $limit") or die(mysql_error());
...
$query = "select * from tbl_ci where ci_upflg!=0 order by ci_code desc";
...
$pagination = "";
	...
	$sql_sel="select * from tbl_ci where ci_upflg!=0 order by ci_code desc LIMIT $from, $max_results";
	$res=mysql_query($sql_sel) or die (mysql_error());
...
<table align="center" border="0" cellspacing="0" cellpadding="0" width="505" style="border-collapse:collapse">
  <tr height="25" >
    <td width="612" colspan="8" align="center" class="subheading" style="color:#303918; ">Complete CI(<?php //=$total_results;?>)</td>
  </tr>
  </table>
<table align="center" border="1" cellspacing="0" cellpadding="0" width="580" bordercolor="#4ea1e1" style="border-collapse:collapse">
  <tr class="tblsubtitle" height="25">
    <td width="25" align="center" class="tblheading" valign="middle">#</td>
    <td width="96" align="left" class="tblheading" valign="middle">&nbsp;Transaction Id </td>
    <td width="77" align="center" class="tblheading" valign="middle">Date</td>
    <td width="174" align="center" class="tblheading" valign="middle">Classification</td>
    <td width="113" align="center" class="tblheading" valign="middle">CI Report Updation Date</td>
    </tr>
  <?php
...
<tr class="Light" height="25">
    ...
    <td valign="middle" class="tbltext" align="center"><?php echo $tdate;?></td>
    <td valign="middle" class="tbltext" align="center"><?php echo $row['classification_id'];?></td>
    <td valign="middle" class="tbltext" align="center"><?php echo $sdate;?></td>
</tr>
<?php
	}
	else
...
<?php
	...
	$tono=$srno-1;
	echo "<table width='580' align='center' class='tbltext'><tr><td align='left' >$no - $tono of $total_results Records</td><td align='right'>Select a Page    "; 
