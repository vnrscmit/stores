  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;<a href="stores_home.php" style="text-decoration:underline; cursor:hand; color:#404d21;"></a>Transction Issue- P-Indent - View</td>
	    </tr></table></td>
...
<td width="215"  align="left" valign="middle" class="tbltext">&nbsp;<?php echo "IP".$row['iss_code']."/".$yearid_id."/".$irole;?></td>
...
<tr >
<td width="791" align="right" valign="top"><a href="home_transction_issue_internal.php?p_id=<?php echo $pid;?>"><img src="../images/back.gif" border="0"style="display:inline;cursor:hand;" /></a>&nbsp;&nbsp;<a href="Javascript:void(0)" onclick="openslocpopprint();"><img src="../images/printpreview.gif" border="0"style="display:inline;cursor:hand;" /></a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
</tr>
