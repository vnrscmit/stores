<?php
	...
	$sql_code="SELECT MAX(iitr_code) FROM tbl_iitr  where yearcode='$yearid_id' ORDER BY iitr_code DESC";
	...
	$sql_main="update tbl_iitr set iitrflg=1, iitr_code=$code  where iitr_id = '$pid'";
...
<title>stores - Transction-Select Inter Item Transfer O/P</title>
...
winHandle=window.open('iitr_issue_note_print.php?itmid='+itm,'WelCome','top=170,left=180,width=820,height=450,scrollbars=yes');
if(winHandle==null){
...
alert(wid);*/
var tp=document.frmaddDepartment.tp.value;
winHandle=window.open('iss_subbind_sloc_details_print.php?slid='+subid+'&bid='+bid+'&wid='+wid+'&tp='+tp,'WelCome','top=170,left=180,width=820,height=350,scrollbars=yes');
if(winHandle==null){
alert("While Launching New Window...\nYour browser maybe blocking up Popup windows. \n\n  Please check your Popup Blocker Settings or ..\n Please hold Ctrl Key and Click on link to open new Browser"); }
//showUser(edtrecid,'postingsubtable','subformedt','','','','',''); 
}
...
alert(wid);*/
var tp=document.frmaddDepartment.tp.value;
winHandle=window.open('iss_bind_sloc_details_print.php?bid='+bid+'&wid='+wid+'&tp='+tp,'WelCome','top=170,left=180,width=820,height=350,scrollbars=yes');
if(winHandle==null){
alert("While Launching New Window...\nYour browser maybe blocking up Popup windows. \n\n  Please check your Popup Blocker Settings or ..\n Please hold Ctrl Key and Click on link to open new Browser"); }
//showUser(edtrecid,'postingsubtable','subformedt','','','','',''); bin_sloc_details_print
}
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction: Inter Item Transfer - Output Selection </td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
<tr class="Light" height="25">
    ...
    <td align="center"  valign="middle" class="tblheading">&nbsp;<a href="Javascript:void(0)" onclick="openslocpopprint();">Inter Item Transfer Note</a></td>
</tr>
</table>
<?php
...
$sql_tbl=mysql_query("select * from tbl_stldg_good where stlg_trtype='IT' and stlg_trsubtype='$tp' and stlg_trid='".$pid."'") or die(mysql_error());
/*$row_tbl=mysql_fetch_array($sql_tbl);			
...
<tr >
<td valign="top" align="center"><a href="home_interitem.php"><img src="../images/back.gif" border="0"style="display:inline;cursor:hand;" /></a>&nbsp;&nbsp;&nbsp;
