<?php
	...
	/*$sql_code="SELECT MAX(iss_code) FROM tblissue where yearcode='$yearid_id' and issue_type='eindent' ORDER BY iss_code DESC";
	$res_code=mysql_query($sql_code)or die(mysql_error());
		...
		$sql_code1="SELECT MAX(ncode) FROM tblissue where yearcode='$yearid_id' and  issue_type='eindent' ORDER BY ncode DESC";
	...
	if(isset($_POST['frm_action'])=='submit')
	{
			...
			if($printopt == "1" )
			{
				echo "<script>window.location='eindent_note.php?p_id=$pid&tid=$tid'</script>";	
			}
			else if($printopt =="2")
			{
				echo "<script>window.location='bincard_eindnet_print.php?p_id=$pid&tid=$tid&tp=eindent'</script>";	
			}
			else
			{
...
<title>stores - Transaction: Issue - e-Indent - Output Selection</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction: Issue - e-Indents  - Output Selection </td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
<tr class="Light" height="25">
    ...
    <td align="center"  valign="middle" class="tblheading">&nbsp;<a href="Javascript:void(0)" onclick="openslocpopprint();">e-Indent Issue Note</a></td>
</tr>
</table>
<?php

$tid=$pid;
$sql_tbl=mysql_query("select * from tblarrival where  arrival_type='$tp' and arrival_id='".$pid."'") or die(mysql_error());
$row_tbl=mysql_fetch_array($sql_tbl);	
$t=mysql_num_rows($sql_tbl);		
...
$sql_tbl=mysql_query("select * from tbl_stldg_good where stlg_trtype='Issue' and stlg_trsubtype='eindent' and stlg_trid='".$pid."'") or die(mysql_error());
/*$row_tbl=mysql_fetch_array($sql_tbl);			
...
<tr >
<td valign="top" align="center"><a href="add_issue_indents1.php"><img src="../images/back.gif" border="0"style="display:inline;cursor:hand;" /></a>&nbsp;&nbsp;&nbsp;
