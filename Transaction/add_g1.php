<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		if($sdate!="" && $edate!="")
		{
		echo "<script>window.location='add_g1.php?sdate=$sdate&edate=$edate'</script>";
		}
		else
		 {?>
		 <script>
...
<title>Stores- Transaction -Home G To D</title>
...
{
winHandle=window.open('gd_issue_note_print.php?itmid='+tid,'WelCome','top=170,left=180,width=820,height=450,scrollbars=yes');
if(winHandle==null){
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="809" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="810" height="25" class="Mainheading">&nbsp;Transaction - Good to Damage</td>
	    </tr></table></td>
...
<td align="center" width="130" valign="middle" class="tblbutn" style="cursor:hand;"><a href="add_gtod.php" style="text-decoration:none; color:#FFFFFF">Add </a></td>
</tr>
-->

<tr height="15" class="tbltitle" >
<td align="center" width="100" valign="middle" class="tblbutn" style="cursor:hand;"><?php if($flg==0 && $flg1==0 && $flg2==0) { ?><a href="add_gtod.php" style="text-decoration:none; color:#FFFFFF">Add </a><?php } else { ?><a href="Javascript:void(0);" onClick="alert('Can not perform Transaction.\nReason:\n1. Todays date is not in Active Current Financial Year.\n2. Transaction after todays date has been made.\n3. Cycle Inventory transaction is under process.');" style="text-decoration:none; color:#FFFFFF">Add </a><?php } ?></td>
</tr>
...
<table align="center" border="1" cellspacing="0" cellpadding="0" width="700" bordercolor="#4ea1e1" style="border-collapse:collapse">
  ...
  <td width="89" class="tblheading" align="right">&nbsp;Start Date&nbsp;</td>
  ...
  <td width="91" class="tblheading" align="right">&nbsp;End Date&nbsp;</td>
  ...
  <td width="153" class="tblheading" align="center"><input type="image" src="../images/search.gif" border="0" onClick="return mySubmit();"  /></td>
  </tr>
  </table><br />
...
/*if(!isset($_GET['page'])) { 
  ...
  $sql_arr_home=mysql_query("select * from tbl_gtod where date between '$tdate' and '$pdate' and gdflg=1 order by yearcode asc, code asc LIMIT $start, $limit") or die(mysql_error());
...
$query = "select * from tbl_gtod where date between '$tdate' and '$pdate' and gdflg=1 order by yearcode asc, code asc";
...
/*$sql_arr_home=mysql_query("select * from tbl_gtod where date between '$tdate' and '$pdate' and gdflg=1 order by yearcode desc, code desc LIMIT $from, $max_results") or die(mysql_error());
$tot_arr_home=mysql_num_rows($sql_arr_home);*/

$total_results = mysql_result(mysql_query("SELECT COUNT(*) as Num FROM tbl_gtod where date between '$tdate' and '$pdate' and  gdflg=1"),0); 
...
<tr class="Light" height="20">
  <td colspan="6" align="center" class="tblheading">Good to Damage</td>
</tr>
</table>
<table align="center" border="1" cellspacing="0" cellpadding="0" width="700" bordercolor="#4ea1e1" style="border-collapse:collapse">
            ...
            <tr class="tblsubtitle" height="20">
			 ...
			 <td width="11%" align="center" valign="middle" class="tblheading">Date</td>
			  ...
			  <td width="36%" align="center" valign="middle" class="tblheading">Item</td>
...
<tr class="Light">
         ...
         <td width="15%" align="center" valign="middle" class="tblheading"><a href="add_gtod_view.php?p_id=<?php echo $row_arr_home['gid'];?>"><?php echo "GD".$row_arr_home['gcode']."/".$row_arr_home['yearcode']."/".$lgnid;?></a></td>
		 <td width="11%" align="center" valign="middle" class="tblheading"><?php echo $trdate;?></td>
		 
         <td width="25%" align="center" valign="middle" class="tblheading"><?php echo $noticia_class['classification'];?></td>
         <td width="36%" align="center" valign="middle" class="tblheading"><?php echo $noticia_item['stores_item'];?></td>
		  <td width="9%" align="center" valign="middle" class="tblheading"><a href="Javascript:void(0)" onClick="openslocpopprint('<?php echo $row_arr_home['gid'];?>');">G2DN</a></td>
         </tr>
<?php
}
else
...
<tr >
<td valign="top" align="right"><a href="add_g.php"><img src="../images/back.gif" border="0"style="display:inline;cursor:pointer;" /></a></td>
</tr>
</table>
