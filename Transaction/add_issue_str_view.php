...
$sql_main="update tblissue set yearcode='$yearid_id',strefno='$txtstrno', party_id='$txtcla', strdate='$sdate', tmode='$txt11', trans_name='$txttname', trans_lorryrepno='$txtlrn', trans_vehno='$txtvn', trans_paymode='$txt14', courier_name='$txtcname', docket_no='$txtdc', pname_byhand='$txtpname' where issue_id = '$pid'";
...
<title>stores -Transction Issue - Stock Transfer</title>
...
<table width="1003" height="600" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
 ...
 <?php
	...
	<input name="tid" type="hidden" value="<?php echo $trid;?>" />
...
<td width="204"  align="left" valign="middle" class="tbltext">&nbsp;<?php echo "IS".$row['iss_code']."/".$yearid_id."/".$irole?></td>
...
<tr >
<td valign="top" align="right"><a href="home_str.php?p_id=<?php echo $pid;?>"><img src="../images/back.gif" border="0"style="display:inline;cursor:hand;" /></a>&nbsp;&nbsp;</td>
</tr>
