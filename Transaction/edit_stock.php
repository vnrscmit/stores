<?php
	...
	$sql_main="update  tblarrival set arrival_type='OP', arrival_date='$tdate', arr_role='$logid', type='$typ' where arrival_id='".$pid."'";

if(mysql_query($sql_main) or die(mysql_error()))
{
$mainid=$pid;

$s_sub="delete from tblarrival_sub where arrival_id='".$pid."'";
mysql_query($s_sub) or die(mysql_error());
$s_sub_sub="delete from tblarr_sloc where arr_tr_id='".$pid."'";
...
/*$sql_code="SELECT MAX(arrival_code) FROM tblarrival where arrival_type='op' ORDER BY arrival_code DESC";
...
<title>stores - Transction-Add Opening Stock Admin</title>
...
{
	if(parseInt(document.frmaddDepartment.txtslupsg3.value) <= 0)
	{
		alert("Please enter UPS");
		document.frmaddDepartment.txtslqtyg3.value="";
...
{
	//document.frmaddDepartment.txtslupsd2.value="";
	//document.frmaddDepartment.txtslupsd3.value="";
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction -Opening Stock Admin </td>
	    </tr></table></td>
	  ...
	  <?php 
$tid=$pid;
$sql_tbl=mysql_query("select * from tblarrival where arr_role='".$logid."' and arrival_type='OP' and arrival_id='".$tid."'") or die(mysql_error());
$row_tbl=mysql_fetch_array($sql_tbl);			
$arrival_id=$row_tbl['arrival_id'];

$sql=mysql_query("select * from tblarrival_sub where arrival_id='".$arrival_id."'") or die(mysql_error());
...
$flag=0; $flag1=0;
$sql_issue=mysql_query("select * from tbl_stldg_good where stlg_tritemid='".$row['item_id']."'") or die(mysql_error());
$tot=mysql_num_rows($sql_issue);
$sql_issue1=mysql_query("select * from tbl_stldg_damage where stld_tritemid='".$row['item_id']."'") or die(mysql_error());
...
<form name="frmaddDepartment" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>"   onSubmit="return mySubmit();"  > 
	 ...
	 <input name="txt11" value="" type="hidden"> 
		...
		<input name="typ" value="<?php echo $row_tbl['type']?>" type="hidden"> 
		<input type="hidden" name="txtid" value="<?php echo $row_tbl['arrival_code']?>" />
		<input type="hidden" name="logid" value="<?php echo $logid?>" />
		 <input name="code" value="<?php echo $row_tbl['arrival_code'];?>" type="hidden"> 
...
<tr class="tblsubtitle" height="20">
  <td colspan="6" align="center" class="tblheading">Edit Stock Admin </td>
</tr>
<tr height="15"><td colspan="6" align="right" class="tblheading"><font color="#FF0000" >* </font>indicates required field&nbsp;</td></tr>

 <tr class="Dark" height="30">
<td width="208" align="right" valign="middle" class="tblheading">&nbsp;Transaction Id &nbsp;</td>
<td width="370"  align="left" valign="middle" class="tbltext">&nbsp;<?php echo "TOP".$row_tbl['arrival_code']."/".$yearid_id."/".$lgnid?></td>

<td width="65" align="right" valign="middle" class="tblheading">&nbsp;Date&nbsp;</td>
<td width="197" colspan="3" align="left" valign="middle" class="tbltext">&nbsp;<input name="date" type="text" size="10" class="tbltext" tabindex="0"  readonly="true" style="background-color:#CCCCCC"  value="<?php echo date("d-m-Y");?>" maxlength="10"//>&nbsp; </td>
</tr>
<?php 
...
?>
 <tr class="Dark" height="25">
           <td width="208"  align="right"  valign="middle" class="tblheading">&nbsp;Classification&nbsp;</td>
           <td align="left"  valign="middle" colspan="3" class="tbltext">&nbsp;<select class="tbltext" name="txtclass" style="width:230px;"   onchange="modetchk(this.value)"><option value="" >--Select Classification--</option>
...
<td width="376" align="left" valign="middle" class="tbltext">&nbsp;<select class="tbltext" name="txtitem" id="itm" style="width:230px;" onchange="classchk(this.value);" ><option value="" selected>---Select Item---</option>
	<?php while($noticia_item = mysql_fetch_array($itemqry)) { ?>
		<option <?php if($noticia_item['items_id']==$row['item_id']) { echo "Selected"; }?> value="<?php echo $noticia_item['items_id'];?>" />   
...
<td width="174" align="left" valign="middle" class="tbltext" id="uom">&nbsp;<input name="txtuom" type="text" size="10" class="tbltext" tabindex="" maxlength="7" value="<?php echo $row['uom'];?>" readonly="true" style="background-color:#CCCCCC"  />&nbsp;</td><input type="hidden" name="itmdupchkg" value="<?php echo $flag;?>" /><input type="hidden" name="itmdupchkd" value="<?php echo $flag1;?>" />
</tr>


 <tr class="Light" height="25">
            <td width="208" height="24"  align="right"  valign="middle" class="tblheading">Type &nbsp;</td>
            <td align="left"  valign="middle" colspan="3">&nbsp;<input name="txt1" type="radio" class="tbltext" value="Good" onClick="clk22(this.value);" <?php if($row_tbl['type']=="Good"){ echo "Checked";}?> />&nbsp;Good&nbsp;&nbsp;&nbsp;&nbsp;<input name="txt1" type="radio" class="tbltext" value="Damage" onClick="clk22(this.value);" <?php if($row_tbl['type']=="Damage"){ echo "Checked";}?> />&nbsp;Damage&nbsp;&nbsp;<font color="#FF0000">*</font>&nbsp;&nbsp;</td>
         </tr>
		 
<?php
if($row_tbl['type']=="Good")
{
$ups=$row['ups_good'];
$qty=$row['qty_good'];
}
...
<td align="left"  valign="middle" class="tbltext" >&nbsp;<input name="txtupsd" type="text" size="10" class="tbltext" tabindex="" maxlength="5" value="<?php echo $ups;?>" onkeypress="return isNumberKey(event)" onchange="upschk1();" />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
<td align="right"  valign="middle" class="tblheading">Quantity&nbsp;</td>
<td align="left"  valign="middle" class="tbltext" >&nbsp;<input name="txtqtyd" type="text" size="10" class="tbltext" tabindex=""  maxlength="7" value="<?php echo $qty;?>" onkeypress="return isNumberKey(event)" onchange="qtychk1();" />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
</table>
...
<div id="ds" style="display:<?php if($row_tbl['type']=="Good") echo "block"; else echo "none";?>">
<table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#4ea1e1" style="border-collapse:collapse" >
<tr class="Dark" height="30">
...
<option <?php if($row['noofbin_good']==1){ echo "Selected"; } ?> value="1" >1</option>
<option <?php if($row['noofbin_good']==2){ echo "Selected"; } ?> value="2" >2</option>
<option <?php if($row['noofbin_good']==3){ echo "Selected"; } ?> value="3" >3</option>   
...
<div id="gsloc1" style="display:<?php if($row['noofbin_good'] >= 1) {echo "block";} else {echo "none";} ?>">
<?php
if($flash==0)
{
?>
...
<td width="101" align="left"  valign="middle" class="tbltext">&nbsp;<select class="tbltext" name="txtslwhg1" style="width:70px;" onchange="wh1(this.value);"  >
...
<?php
$bing1_query=mysql_query("select binid, binname from tbl_bin where whid='".$row_sub_sloc['whid']."'") or die(mysql_error());
?>
...
<?php
$subbing1_query=mysql_query("select sid, sname from tbl_subbin where whid='".$row_sub_sloc['whid']."' and binid='".$row_sub_sloc['binid']."'") or die(mysql_error());
?>	
...
<td  align="left" width="83"  valign="middle" class="tbltext">&nbsp;<input name="txtslupsg1" id="ups1" type="text" size="4" class="tbltext" tabindex="" maxlength="7" onkeypress="return isNumberKey(event)" onchange="upsf1(this.value);" value="<?php echo $row_sub_sloc['ups_good'];?>"  />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>	
<td  align="right" width="45"  valign="middle" class="tblheading">&nbsp;Qty &nbsp;</td>
<td width="135" align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtslqtyg1" id="qty1" type="text" size="4" class="tbltext" tabindex="" maxlength="7" onkeypress="return isNumberKey(event)" onchange="qtyf1(this.value);" value="<?php echo $row_sub_sloc['qty_good'];?>"  />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr></table></div></td>
</tr>
</table>
</div>
...
?>
<div  id="gsloc2" style="display:<?php if($row['noofbin_good']>=2) echo "block";else echo "none"; ?>">
<table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#4ea1e1" style="border-collapse:collapse" >
<tr class="Light" height="30"  >
<td width="61" align="right"  valign="middle" class="tblheading">WH&nbsp;</td>
<td width="101" align="left"  valign="middle" class="tbltext">&nbsp;<select class="tbltext" name="txtslwhg2" style="width:70px;" onchange="wh2(this.value);" >
<option value="" selected>--WH--</option>
	<?php while($noticia_whg2 = mysql_fetch_array($whg2_query)) { ?>
		<option <?php if($row_sub_sloc['whid']==$noticia_whg2['whid']){ echo "Selected"; } ?>  value="<?php echo $noticia_whg2['whid'];?>" />   
		<?php echo $noticia_whg2['perticulars'];?>
		<?php } ?>
	</select>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
<?php
$bing2_query=mysql_query("select binid, binname from tbl_bin where whid='".$row_sub_sloc['whid']."'") or die(mysql_error());
?>
<td width="55" align="right"  valign="middle" class="tblheading">&nbsp;Bin No.&nbsp;</td>
...
<?php while($noticia_bing2 = mysql_fetch_array($bing2_query)) { ?>
		<option <?php if($row_sub_sloc['binid']==$noticia_bing2['binid']){ echo "Selected"; } ?> value="<?php echo $noticia_bing2['binid'];?>" />   
		<?php echo $noticia_bing2['binname'];?>
		<?php } ?>
</select>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
<?php
$subbing2_query=mysql_query("select sid, sname from tbl_subbin where whid='".$row_sub_sloc['whid']."' and binid='".$row_sub_sloc['binid']."'") or die(mysql_error());
?>	
<td width="97" align="right"  valign="middle" class="tblheading">&nbsp;Sub Bin No.&nbsp;</td>
...
<?php while($noticia_subbing2 = mysql_fetch_array($subbing2_query)) { ?>
		<option <?php if($row_sub_sloc['subbin']==$noticia_subbing2['sid']){ echo "Selected"; } ?> value="<?php echo $noticia_subbing2['sid'];?>" />   
...
<td width="80" align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtslupsg2" id="ups2" type="text" size="4" class="tbltext" tabindex="" maxlength="7" onkeypress="return isNumberKey(event)" onchange="upsf2(this.value);" value="<?php echo $row_sub_sloc['ups_good'];?>"  />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>	
<td width="46" align="right"  valign="middle" class="tblheading">&nbsp;Qty &nbsp;</td>
<td width="130"  align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtslqtyg2" id="qty2" type="text" size="4" class="tbltext" tabindex="" maxlength="7" onkeypress="return isNumberKey(event)" onchange="qtyf2(this.value);" value="<?php echo $row_sub_sloc['qty_good'];?>"  />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr></table></div></td>
</tr>
</table>
</div>
...
?>
<div  id="gsloc3" style="display:<?php if($row['noofbin_good']==3) echo "block"; else echo "none"; ?>">
<table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#4ea1e1" style="border-collapse:collapse" >
<tr class="Light" height="30"  >
<td width="62" align="right"  valign="middle" class="tblheading">WH&nbsp;</td>
<td width="103" align="left"  valign="middle" class="tbltext">&nbsp;<select class="tbltext" name="txtslwhg3" style="width:70px;" onchange="wh3(this.value);" >
<option value="" selected>--WH--</option>
	<?php while($noticia_whg3 = mysql_fetch_array($whg3_query)) { ?>
		<option <?php if($row_sub_sloc['whid']==$noticia_whg3['whid']){ echo "Selected"; } ?>  value="<?php echo $noticia_whg3['whid'];?>" />   
		<?php echo $noticia_whg3['perticulars'];?>
		<?php } ?>
	</select>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
<?php
$bing3_query=mysql_query("select binid, binname from tbl_bin where whid='".$row_sub_sloc['whid']."'") or die(mysql_error());
?>
...
<?php while($noticia_bing3 = mysql_fetch_array($bing3_query)) { ?>
		<option <?php if($row_sub_sloc['binid']==$noticia_bing3['binid']){ echo "Selected"; } ?> value="<?php echo $noticia_bing3['binid'];?>" />   
		<?php echo $noticia_bing3['binname'];?>
		<?php } ?>
</select>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
<?php
$subbing3_query=mysql_query("select sid, sname from tbl_subbin where whid='".$row_sub_sloc['whid']."' and binid='".$row_sub_sloc['binid']."'") or die(mysql_error());
?>	
...
<?php while($noticia_subbing3 = mysql_fetch_array($subbing3_query)) { ?>
		<option <?php if($row_sub_sloc['subbin']==$noticia_subbing3['sid']){ echo "Selected"; } ?> value="<?php echo $noticia_subbing3['sid'];?>" />   
...
<td width="80" align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtslupsg3" id="ups3" type="text" size="4" class="tbltext" tabindex="" maxlength="7" onkeypress="return isNumberKey(event)" onchange="upsf3(this.value);" value="<?php echo $row_sub_sloc['ups_good'];?>"   />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>	
<td width="43" align="right"  valign="middle" class="tblheading">&nbsp;Qty &nbsp;</td>
<td width="132"  align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtslqtyg3" id="qty3" type="text" size="4" class="tbltext" tabindex="" maxlength="7" onkeypress="return isNumberKey(event)" onchange="qtyf3(this.value);" value="<?php echo $row_sub_sloc['qty_good'];?>"  />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr></table></div></td>
</tr>
</table>
</div>
...
$whg3_query=mysql_query("select whid, perticulars from tbl_warehouse") or die(mysql_error());
?>
<div  id="gsloc3" style="display:<?php if($row_tbl_sub['noofbin_good']==3) echo "block"; else echo "none"; ?>">
<table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#4ea1e1" style="border-collapse:collapse" >
<tr class="Light" height="30"  >
<td width="62" align="right"  valign="middle" class="tblheading">WH&nbsp;</td>
<td width="103" align="left"  valign="middle" class="tbltext">&nbsp;<select class="tbltext" name="txtslwhg3" style="width:70px;" onchange="wh3(this.value);" >
...
<td width="305"  valign="middle">
<div id="slocrow3">
<table align="center" height="27" border="1" cellspacing="0" width="100%" cellpadding="0" bordercolor="#4ea1e1" style="border-collapse:collapse" >		
...
<div id="ds1" style="display:<?php if($row_tbl['type']=="Damage") echo "block";else echo "none"; ?>">
<table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#4ea1e1" style="border-collapse:collapse" >
 <tr class="Dark" height="30">
...
<option value="">--Bin--</option>
<option <?php if($row['noofbin_damage']==1){ echo "Selected"; } ?> value="1" >1</option>
<option <?php if($row['noofbin_damage']==2){ echo "Selected"; } ?> value="2" >2</option>
</select>&nbsp;</td>
</tr>
</table>
<?php
/*$sql_sub_sloc=mysql_query("select * from tblarr_sloc where arr_id='".$rid."' and qty_damage=0 and ups_damage=0") or die(mysql_error());
$tot_sub_sloc=mysql_num_rows($sql_sub_sloc);*/
$sql_sub_sloc1=mysql_query("select * from tblarr_sloc where arr_id='".$rid."' and qty_good=0 and ups_good=0 order by arrsloc_id") or die(mysql_error());
...
?>
<div  id="dsloc1" style="display:<?php if($row['noofbin_damage']>=1) echo "block";else echo "none"; ?>">
<?php
if($flash1==0)
{ 
?>
...
<tr class="Light" height="30"  >
<td width="62" align="right"  valign="middle" class="tblheading">WH&nbsp;</td>
<td width="103" align="left"  valign="middle" class="tbltext">&nbsp;<select class="tbltext" name="txtslwhd1" style="width:70px;" onchange="wh4(this.value);" >
<option value="" selected>--WH--</option>
	<?php while($noticia_whd1 = mysql_fetch_array($whd1_query)) { ?>
	<option <?php if($row_sub_sloc1['whid']==$noticia_whd1['whid']){ echo "Selected"; } ?> value="<?php echo $noticia_whd1['whid'];?>" />   
		<?php echo $noticia_whd1['perticulars'];?>
		<?php } ?>
	</select>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
<?php
$bind1_query=mysql_query("select binid, binname from tbl_bin where whid='".$row_sub_sloc1['whid']."'") or die(mysql_error());
?>
<td width="56" align="right"  valign="middle" class="tblheading">&nbsp;Bin No.&nbsp;</td>
...
<?php while($noticia_bind1 = mysql_fetch_array($bind1_query)) { ?>
		<option <?php if($row_sub_sloc1['binid']==$noticia_bind1['binid']){ echo "Selected"; } ?> value="<?php echo $noticia_bind1['binid'];?>" />   
		<?php echo $noticia_bind1['binname'];?>
		<?php } ?>
</select>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
<?php
$subbind1_query=mysql_query("select sid, sname from tbl_subbin where whid='".$row_sub_sloc1['whid']."' and binid='".$row_sub_sloc1['binid']."'") or die(mysql_error());
?>	
<td width="99" align="right"  valign="middle" class="tblheading">&nbsp;Sub Bin No.&nbsp;</td>
...
<?php while($noticia_subbind1 = mysql_fetch_array($subbind1_query)) { ?>
		<option <?php if($row_sub_sloc1['subbin']==$noticia_subbind1['sid']){ echo "Selected"; } ?> value="<?php echo $noticia_subbind1['sid'];?>" />   
...
<td width="46" align="right"  valign="middle" class="tblheading">&nbsp;UPS &nbsp;</td>
<td width="80" align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtslupsd1" id="ups4" type="text" size="4" class="tbltext" tabindex="" maxlength="7" onkeypress="return isNumberKey(event)"  onchange="upsf4(this.value);" value="<?php echo $row_sub_sloc1['ups_damage'];?>"  />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>	
<td width="35" align="right"  valign="middle" class="tblheading">&nbsp;Qty &nbsp;</td>
<td width="132"  align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtslqtyd1" id="qty4" type="text" size="4" class="tbltext" tabindex="" maxlength="7" onkeypress="return isNumberKey(event)" onchange="qtyf4(this.value);"  value="<?php echo $row_sub_sloc1['qty_damage'];?>" />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr></table></div></td>
</tr>
</table>
</div>
...
?>
<div  id="dsloc2" style="display:<?php if($row['noofbin_damage']==2) echo "block";else echo "none"; ?>">
<table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#4ea1e1" style="border-collapse:collapse" >
<tr class="Light" height="30" >
<td width="62" align="right"  valign="middle" class="tblheading">WH&nbsp;</td>
<td width="103" align="left"  valign="middle" class="tbltext">&nbsp;<select class="tbltext" name="txtslwhd2" style="width:70px;" onchange="wh5(this.value);" >
<option value="" selected>--WH--</option>
	<?php while($noticia_whd2 = mysql_fetch_array($whd2_query)) { ?>
		<option <?php if($row_sub_sloc1['whid']==$noticia_whd2['whid']){ echo "Selected"; } ?> value="<?php echo $noticia_whd2['whid'];?>" />   
		<?php echo $noticia_whd2['perticulars'];?>
		<?php } ?>
	</select>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
<?php
$bind2_query=mysql_query("select binid, binname from tbl_bin where whid='".$row_sub_sloc1['whid']."'") or die(mysql_error());
?>
<td width="56" align="right"  valign="middle" class="tblheading">&nbsp;Bin No.&nbsp;</td>
...
<?php while($noticia_bind2 = mysql_fetch_array($bind2_query)) { ?>
		<option <?php if($row_sub_sloc1['binid']==$noticia_bind2['binid']){ echo "Selected"; } ?> value="<?php echo $noticia_bind2['binid'];?>" />   
		<?php echo $noticia_bind2['binname'];?>
		<?php } ?>
</select>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
<?php
$subbind2_query=mysql_query("select sid, sname from tbl_subbin where whid='".$row_sub_sloc1['whid']."' and binid='".$row_sub_sloc1['binid']."'") or die(mysql_error());
?>	
<td width="99" align="right"  valign="middle" class="tblheading">&nbsp;Sub Bin No.&nbsp;</td>
...
<?php while($noticia_subbind2 = mysql_fetch_array($subbind2_query)) { ?>
		<option <?php if($row_sub_sloc1['subbin']==$noticia_subbind2['sid']){ echo "Selected"; } ?> value="<?php echo $noticia_subbind2['sid'];?>" />   
...
<td width="46" align="right"  valign="middle" class="tblheading">&nbsp;UPS &nbsp;</td>
<td width="80" align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtslupsd2" id="ups5" type="text" size="4" class="tbltext" tabindex="" maxlength="7" onkeypress="return isNumberKey(event)"  onchange="upsf5(this.value);" value="<?php echo $row_sub_sloc1['ups_damage'];?>"  />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>	
<td width="35" align="right"  valign="middle" class="tblheading">&nbsp;Qty &nbsp;</td>
<td width="132"  align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtslqtyd2" id="qty5" type="text" size="4" class="tbltext" tabindex="" maxlength="7" onkeypress="return isNumberKey(event)" onchange="qtyf5(this.value);" value="<?php echo $row_sub_sloc1['qty_damage'];?>" />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr></table></div></td>
</tr>
</table>
</div>
...
if($row['noofbin_damage']==0 || $row['noofbin_damage']=="")
{
$whd1_query=mysql_query("select whid, perticulars from tbl_warehouse") or die(mysql_error());
?>
<div  id="dsloc1" style="display:<?php if($row['noofbin_damage']>=1) echo "block";else echo "none"; ?>">
...
else if($row_tbl_sub['noofbin_damage']==1)
{
?>
<?php
$whd2_query=mysql_query("select whid, perticulars from tbl_warehouse") or die(mysql_error());
