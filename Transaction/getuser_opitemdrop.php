...
$flag=0; 
//echo $a;
$sql_month=mysql_query("select items_id, stores_item from tbl_stores where classification_id='".$a."' and actstatus='Active'")or die(mysql_error());
//$row_month=mysql_fetch_array($sql_month);
?><td align="right" valign="middle" class="tblheading">Stores Items&nbsp;</td>
<td align="left" valign="middle" class="tbltext" colspan="3">&nbsp;<select class="tbltext" name="txtitem" style="width:170px;" onchange="classchk(this.value);" >
