...
<title>Stores- Tranasaction-P - Indent  Note</title>
...
<?php
	...
	$code1="IP".$row['iss_code'];
	 ?> 
<table align="center" border="0" width="750" cellspacing="0" cellpadding="0" bordercolor="#4ea1e1" style="border-collapse:collapse" ><HR />
<tr  height="20">
  <td colspan="6" align="center" class="Mainheading"><font color="#000000">P-Indent Issue Note</font></td>
</tr></table> <br />
...
<td width="193" align="right" valign="middle" class="tblheading">P-Indents Issue&nbsp;Date&nbsp;</td>
...
<td width="215"  align="left" valign="middle" class="tbltext">&nbsp;<?php echo $row['dcrefno'];?></td>

<td width="193" align="right" valign="middle" class="tblheading">Physical Indent Raised by&nbsp;</td>
<td width="227" colspan="3" align="left" valign="middle" class="tbltext">&nbsp;<?php echo $row['strefno'];?></td>
</tr>
 <tr class="Dark" height="30">
<td width="205" align="right" valign="middle" class="tblheading">P-Indent Date &nbsp;</td>
<td width="215"  align="left" valign="middle" class="tbltext" colspan="3">&nbsp;<?php echo $tdate;?></td>
...
$balups=$row_eindent_sub['ups_indent']-$slups;
if($balups1!="")
$balups1=$balups1.$balups."<br/>";
else
$balups1=$balups."<br/>";
$balqty=$row_eindent_sub['qty_indent']-$slqty;
if($balqty1!="")
...
<tr class="Dark" height="25">
              <td align="center" class="smalltblheading" valign="middle"><?php echo $sr;?></td>
              <td align="center" class="smalltblheading" valign="middle"><?php echo $noticia_class['classification'];?></td>
			  <td align="center" class="smalltblheading" valign="middle"><?php echo $noticia_item['stores_item'];?></td>
			  <td align="center" width="5%" class="smalltblheading" valign="middle"><?php echo $row_eindent_sub['uom']?></td>
              <td align="center" width="6%" class="smalltblheading" valign="middle"><?php echo $row_eindent_sub['ups_indent']?></td>
              <td align="center" width="6%" class="smalltblheading" valign="middle"><?php echo $row_eindent_sub['qty_indent']?></td>
              <td width="4%" align="center" valign="middle" class="smalltblheading"><?php echo $slups;?></td>
              <td width="5%" align="center" valign="middle" class="smalltblheading"><?php echo $slqty;?></td>
...
<tr >
<td align="right" colspan="3"><img src="../images/close_icon2.jpg" height="30" border="0" class="butn" onClick="window.close()" />&nbsp;&nbsp;<img src="../images/Vista-printer.png" height="29" width="35" border="0" class="butn" onClick="javascript:window.print();" />&nbsp;&nbsp;</td>
</tr>
</table>
</form>
</td></tr>
