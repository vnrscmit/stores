...
<title>stores - Transction-Issue Bin card</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="940" height="25" class="Mainheading" >&nbsp;Transaction Issue - <span class="subheading" style="color:#303918; ">Bin Status Card </span></td>
	    </tr></table></td>
...
<tr >
<td valign="top" align="center"><a href="select_issue_eindentop.php?p_id=<?php echo $pid;?>&tid=<?php echo $tid;?>"><img src="../images/back.gif" border="0"  style="display:inline;cursor:hand;"/></a>&nbsp;&nbsp;<input name="Submit" type="image" src="../images/next.gif" alt="next" OnClick="return mySubmit()" border="0" style="display:inline;cursor:hand;">&nbsp;<input type="hidden" name="fet1" value="" /></td>	
</tr>
</table>
</td>
<td width="30"></td>
