<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		...
		if($sdate!="" && $edate!="")
		{
		echo "<script>window.location='home_interitem1.php?sdate=$sdate&edate=$edate'</script>";
		}
		else
		 {?>
		 <script>
...
<title>stores - Transaction-Home Interitem</title>
...
{
winHandle=window.open('iitr_issue_note_print.php?itmid='+tid,'WelCome','top=170,left=180,width=820,height=450,scrollbars=yes');
if(winHandle==null){
...
<body>
<table width="1003" height="700" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="809" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="810" height="25" class="Mainheading">&nbsp;Transaction - Inter Item Transfer </td>
	    </tr></table></td>
...
<td align="center" width="130" valign="middle" class="tblbutn" style="cursor:hand;"><a href="add_interitem.php" style="text-decoration:none; color:#FFFFFF">Add </a></td>
</tr>-->

<tr height="15" class="tbltitle" >
<td align="center" width="100" valign="middle" class="tblbutn" style="cursor:hand;"><?php if($flg==0 && $flg1==0 && $flg2==0) { ?><a href="add_interitem.php" style="text-decoration:none; color:#FFFFFF">Add </a><?php } else { ?><a href="Javascript:void(0);" onClick="alert('Can not perform Transaction.\nReason:\n1. Todays date is not in Active Current Financial Year.\n2. Transaction after todays date has been made.\n3. Cycle Inventory transaction is under process.');" style="text-decoration:none; color:#FFFFFF">Add </a><?php } ?></td>
</tr>
...
$targetpage = $PHP_SELF; 
  ...
  $sql_arr_home=mysql_query("select * from tbl_iitr where  iitrflg=1 order by yearcode desc, iitr_code desc LIMIT $start, $limit") or die(mysql_error());
...
$query = "select * from tbl_iitr where  iitrflg=1 order by yearcode desc, iitr_code desc";
...
$sql_arr_home=mysql_query("select * from tbl_iitr where  iitrflg=1 order by yearcode desc, iitr_code desc LIMIT $from, $max_results") or die(mysql_error());
$tot_arr_home=mysql_num_rows($sql_arr_home);

$total_results = mysql_result(mysql_query("SELECT COUNT(*) as Num FROM tbl_iitr where  iitrflg=1"),0); */
...
<tr class="Light">
         ...
         <td width="15%" align="center" valign="middle" class="tblheading"><a href="iitr_view.php?p_id=<?php echo $row_arr_home['iitr_id'];?>"><?php echo "AV".$row_arr_home['iitr_code']."/".$row_arr_home['yearcode']."/".$logid;?></a></td>
         ...
         <td width="17%" align="center" valign="middle" class="tblheading"><a href="Javascript:void(0)" onClick="openslocpopprint('<?php echo $row_arr_home['iitr_id'];?>');">IITN</a></td>
</tr>
<?php
}
else
