...
<td align="center" valign="middle" class="tbltext"><input type="text" name="balups<?php echo $srno?>" class="tbltext" size="3" value="<?php echo $row_sub_sloc['ups_good']+$up;?>"  onkeypress="return isNumberKey(event)"/></td>
...
<td align="center" valign="middle" class="tbltext"><input type="text" name="balups<?php echo $srno?>" class="tbltext"  onkeypress="return isNumberKey(event)" size="3" value="<?php echo $row_sub_sloc['ups_good']+$up;?>" /></td>
...
<td align="center" valign="middle" class="tbltext"><input type="text" name="balupsd<?php echo $srno?>" class="tbltext"  onkeypress="return isNumberKey(event)" size="3" value="<?php echo $row_sub_sloc['ups_damage']+$up;?>" /></td>
