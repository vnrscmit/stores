...
session_start();
	...
	echo "<script>window.location='add_returnd_stores_preview.php?p_id=$p_id&remarks=$remarks&partyid=$partyid&txtstage=$rfs&txtrd=$rbd'</script>";	
...
<title>Stores -Transaction- Edit Return Internal</title>
<link href="../include/main.css" rel="stylesheet" type="text/css" />
<link href="../include/vnrtrac.css" rel="stylesheet" type="text/css" />
</head>
<script src="intretdchk.js"></script>
...
{	
	...
	{	//alert("hi");
		...
		if(d==0)
		{
		alert("Please check. Quantity Received Damage cannot be Zero or Blank");
		return false;
		f=1;
		}
		if(f==1)
...
function showslocbins()
{
			...
			showUser(clasid,'subsubdivgood','slocshowsubdamage',itmid,clasid,itmid,'','');
}
...
<tr class="tblsubtitle" height="25">
  <td colspan="4" align="center" class="tblheading">Edit Internal Material Return - Party (Damage)</td>
</tr>
  <tr height="15">
...
<tr class="Dark" height="25">
      ...
      <td width="363" align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtcode" type="text" size="20" class="tbltext" tabindex="0" readonly="true" style="background-color:#CCCCCC" value="<?php echo "TAI".$row_tbl['arrival_code']."/".$yearid_id."/".$lgnid;?>" />&nbsp;</td>
     
	  <td width="143" height="24"  align="right"  valign="middle" class="tblheading">&nbsp;Date&nbsp;</td>
      <td width="182" align="left"  valign="middle" class="tbltext">&nbsp;<input name="date" type="text" size="10" class="tbltext" tabindex="0"  readonly="true" style="background-color:#CCCCCC"  value="<?php echo $tdate;?>" maxlength="10"/></td>
</tr>

<tr class="Light" height="25">
<?php
$quer1=mysql_query("SELECT p_id, business_name FROM tbl_partymaser where classification='Vendor' order by business_name")or die(mysql_error()); 
?>
...
<option value="" selected>--Select--</option>
	<?php while($noticia = mysql_fetch_array($quer1)) { ?>
		<option <?php if($row_tbl['party_id']==$noticia['p_id']){ echo "Selected"; }?> value="<?php echo $noticia['p_id'];?>" />   
      ...
      <td align="left"  valign="middle" class="tbltext">&nbsp;<select name="txtstage" class="tbltext"  style="width:100px;" tabindex="" value="text" onchange="retchk(this.value)">
           ...
           <option <?php if($row_tbl['stageret']=="RSW"){ echo "Selected"; }?> value="RSW">RSW</option>
		   <option <?php if($row_tbl['stageret']=="Processing"){ echo "Selected"; }?> value="Processing">Processing</option>
		   <option <?php if($row_tbl['stageret']=="CSW"){ echo "Selected"; }?> value="CSW">CSW</option>
           <option <?php if($row_tbl['stageret']=="Packing"){ echo "Selected"; }?> value="Packing">Packing</option>
		   <option <?php if($row_tbl['stageret']=="PSW"){ echo "Selected"; }?> value="PSW">PSW</option>
		   <option <?php if($row_tbl['stageret']=="Dispatch"){ echo "Selected"; }?> value="Dispatch">Dispatch</option>
		   <option <?php if($row_tbl['stageret']=="Sales Return"){ echo "Selected"; }?> value="Sales Return">Sales Return</option>
           <option <?php if($row_tbl['stageret']=="Quality"){ echo "Selected"; }?> value="Quality">Quality</option>
		    </select>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
...
<option value="" selected>--Select--</option>
	<?php while($noticia = mysql_fetch_array($quer1)) { ?>
		<option  <?php if($row_tbl['retid']==$noticia['id'] || $row_tbl['retid']==$noticia['login']){ echo "Selected"; $f++; }?> value="<?php echo $noticia['login'];?>" />   
		<?php echo $noticia['login'];?>
		<?php } ?>
	</select>&nbsp;<font color="#FF0000">*</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font class="tblheading">OR Specify</font>&nbsp;&nbsp;<input name="txtrbd" id="rbd" type="text" size="15" class="tbltext" tabindex="" maxlength="15" value="<?php if ($f > 0) { echo $row_tbl['retid']; } else { echo ""; } ?>" />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
<?php 
...
<table align="center" border="1" width="850" cellspacing="0" cellpadding="0" bordercolor="#4ea1e1" style="border-collapse:collapse" >
 <tr class="tblsubtitle" height="20">
			 ...
			 <td width="17%" align="center" rowspan="2" valign="middle" class="tblheading">Classification</td>
              <td width="20%" rowspan="2" align="center" valign="middle" class="tblheading">Items</td>
...
<td width="361" align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtupsd" type="text" size="10" class="tbltext" tabindex=""   maxlength="5" onkeypress="return isNumberKey(event)" onchange="upschk1(this.value);"/>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
<td align="right"  valign="middle" class="tblheading">Quantity Damage&nbsp;</td>
<td align="left"  valign="middle" class="tbltext">&nbsp;<input name="txtqtyd" type="text" size="10" class="tbltext" tabindex=""  maxlength="7" onkeypress="return isNumberKey(event)" onchange="qtychk1(this.value);"  />&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
