...
<title>Stores- Tranasction - Arrival  Home</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Transaction: Arrival Types </td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
<table align="center" border="1" width="252" cellspacing="0" cellpadding="0" bordercolor="#4ea1e1" style="border-collapse:collapse" > 

<tr class="tblsubtitle" height="25">
  <td colspan="4" align="center" class="tblheading">Select Arrival  Types</td>
</tr>
<tr class="Light" height="25">
  <td width="248" align="center"  valign="middle" class="tblheading"  >&nbsp;&nbsp; &nbsp;&nbsp;<a href="add_arrival_vendor1.php">From Vendor</a> </td>
</tr>
<tr class="Dark" height="25">

 <td width="248" align="center"  valign="middle" class="tblheading">&nbsp;&nbsp;&nbsp;&nbsp;<a href="add_arrival_stocktransfer2.php">From Stock transfer </a></td >
 </tr>
 <tr class="Light" height="25">
 <td width="248" align="center"  valign="middle" class="tblheading">&nbsp;&nbsp;&nbsp;&nbsp;<a  href="add_return_stores2.php">From Internal Return</a></td>  
</tr>
</table>
