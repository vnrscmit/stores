...
<title>Stores -Transaction -Transaction - Sloc Update </title>
...
<td width="415" align="left" valign="middle" class="tbltext" >&nbsp;<select class="tbltext" name="txtitem" id="itm" style="width:230px;" onchange="classchk(this.value);" >
<option value="" selected>---Select Item---</option>
</select>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
		
<td width="64" align="right"  valign="middle" class="tblheading" >UoM&nbsp;</td>
<td width="161"  align="left" valign="middle" class="tbltext" id="uom">&nbsp;<input name="txtuom" type="text" size="10" class="tbltext" tabindex="" maxlength="7" readonly="true" style="background-color:#CCCCCC"  />&nbsp;</td>
</tr><input type="hidden" name="itmdchk" value="" />
 <tr class="Light" height="25">
            <td width="276" height="24"  align="right"  valign="middle" class="tblheading">Select Type&nbsp;</td>
           <td align="left"  valign="middle" colspan="3"  class="tbltext">&nbsp;<input name="txtrettyp" id="smt" type="radio" class="tbltext" value="good" onClick="chktp(this.value);" />&nbsp;Good&nbsp;&nbsp;&nbsp;&nbsp;<input name="txtrettyp" id="smt" type="radio" class="tbltext" value="damage" onClick="chktp(this.value);" />&nbsp;Damage&nbsp;&nbsp;<font color="#FF0000">*</font>&nbsp;&nbsp; </td>
         </tr>	
</table>
<br />
<div id="maindiv">
