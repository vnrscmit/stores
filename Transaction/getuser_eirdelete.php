...
if(isset($_GET['a']))
	...
	$sql_tbl=mysql_query("select * from tbl_ieindent_sub where eid='".$a."'") or die(mysql_error());
	$row_tbl=mysql_fetch_array($sql_tbl);
	$tid=$row_tbl['id_in'];
	
$s_sub="delete from tbl_ieindent_sub where eid='".$a."'";
...
<td valign="middle" class="tbltext" align="center"><img border="0" src="../images/delete.png"  style="display:inline;cursor:pointer;" onclick="deleterec(<?php echo $row_tbl_sub['id_in'];?>,<?php echo $row_tbl_sub['eid'];?>,'');" /></td>
</tr>
<?php
	}
	else
