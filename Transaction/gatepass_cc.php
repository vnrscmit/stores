...
<tr class="Dark" >
<td width="444" rowspan="3"  align="left" valign="top" class="smalltbltext"><div align="justify" class="tbltext" style="padding:2px 5px 5px 5px"><?php echo $business_name;?><br /><?php echo $address;?><br />Ph: <?php echo $phone;?></div></td>
<td width="181"  align="right" valign="middle" class="smalltblheading">Gate Pass No.&nbsp;</td>
<td width="178"  align="left" valign="middle" class="smalltbltext">&nbsp;<?php echo "CC".$row['cc_code']."/".$yearid_id."/".$gpcode;?></td>
</tr>	
		  <tr class="Dark" >
...
<td width="164" align="center" class="tblheading" valign="middle">Classification</td>
<td width="281" align="center" class="tblheading" valign="middle">Item</td>
<td width="67" align="center" class="tblheading" valign="middle">UoM</td>
<td width="84" align="center" class="tblheading" valign="middle">UPS</td>
<td width="93" align="center" class="tblheading" valign="middle">Quantity</td>
</tr>
