...
if(tp=="slocshowmrv")
{ //alert(str);
var url="getuser_gd_slocshow.php";
url=url+"?a="+str;
url=url+"&b="+d;
url=url+"&c="+e;
url=url+"&f="+i;
...
if(tp=="mformccupdate")
{ //alert(str);
var url="getuser_gdetdupdate.php";
url=url+"?"+str; 
url=url+"&sid="+Math.random();
xmlHttp.onreadystatechange=stateChanged ;
xmlHttp.open("GET",url,true);
...
{
var url="getuser_gd_slocshowd.php";
url=url+"?a="+str;
url=url+"&b="+d;
url=url+"&c="+e;
url=url+"&f="+i;
