<?php
	...
	if(isset($_POST['frm_action'])=='submit')
	{
	 ...
	 $query=mysql_query("SELECT * FROM tbl_country where country='$country'") or die("Error: " . mysql_error());
		// exit;
		...
		<script>
		 ...
		 {
		 $sql_in="insert into tbl_country(country) values(
											  '$country'
														)";
...
<title>Stores -  Master -Add Country</title>
...
<tr class="tblsubtitle" height="25">
  <td colspan="4" align="center" class="subheading">Add a NEW Country Form</td>
</tr>
<tr height="30">
    <td colspan="4" align="right" class="tblheading"><font color="#FF0000" >* </font>indicates required field&nbsp;</td>
  </tr>
<tr class="Light" height="25">
<td width="150" align="right" height="30" valign="middle" class="tblheading">Country&nbsp;</td>
