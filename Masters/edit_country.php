...
<title>Stores - country Master -Edit country</title>
...
<!-- actual page start--->	
  ...
  <tr><td>
   ...
   <?php
	 $sql1=mysql_query("select * from tbl_country where country_id='$country_id'")or die(mysql_error());
...
<tr class="Light" height="25">
 <td width="150" align="right"  valign="middle" class="tblheading">&nbsp;Country&nbsp;</td>
