...
<title>Stores - Classification Master -Classification Home</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="840" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="840" height="25" class="Mainheading">&nbsp;Classification Master </td>
	    </tr></table></td>
...
$query = "select * from tbl_classification order by classification desc";
...
$pagination = "";
	...
	$sql_sel="select * from tbl_classification order by classification LIMIT $from, $max_results";
...
<td valign="middle" class="tbltext" align="center"><a href="edit_classification.php?classification_id=<?php echo $row['classification_id'];?>"><img src="../images/edit.png" border="0" /></a></td>

<td valign="middle" class="tbltext" align="center"><?php if($num_of_records_target_set > 0)
{
?>
<img border="0" src="../images/delete.png" style="cursor:hand" onClick="alert('Cannot be deleted as Stores items are  Present under this Classification')" />
