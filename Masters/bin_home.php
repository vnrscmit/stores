...
<title>Stores - Bin Master -Bin Home</title>
...
<td align="center" width="130" valign="middle" class="tblbutn" style="cursor:hand;"><a href="add_bin.php?whid=<?php echo $whid;?>" style="text-decoration:none; color:#ffffff">Add </a> </td>
</tr>
...
<?php
  ...
  $sql_arr_home=mysql_query("select * from tbl_bin where whid='".$whid."' order by binname asc LIMIT $start, $limit") or die(mysql_error());
...
$query = "select * from tbl_bin where whid='".$whid."' order by binname asc";
...
$pagination = "";
	...
	{	
		...
		//previous button
		if ($page > 1) 
			$pagination.= " <a href=\"$targetpage?page=$prev&whid=$whid\">� previous </a> ";
		else
		...
		{	
			for ($counter = 1; $counter <= $lastpage; $counter++)
			{
				if ($counter == $page)
					...
					$pagination.= " <a href=\"$targetpage?page=$counter&whid=$whid\"> $counter </a> ";					
			}
		}
		elseif($lastpage > 5 + ($adjacents * 2))	//enough pages to hide some
		{
			...
			if($page < 1 + ($adjacents * 2))		
			{
				...
				$pagination.= " ... ";
				$pagination.= " <a href=\"$targetpage?page=$lpm1&whid=$whid\"> $lpm1 </a> ";
				$pagination.= " <a href=\"$targetpage?page=$lastpage&whid=$whid\"> $lastpage </a> ";		
			}
			//in middle; hide some front and some back
			elseif($lastpage - ($adjacents * 2) > $page && $page > ($adjacents * 2))
			{
				$pagination.= " <a href=\"$targetpage?page=1&whid=$whid\"> 1 </a> ";
				$pagination.= " <a href=\"$targetpage?page=2&whid=$whid\"> 2 </a> ";
				$pagination.= " ... ";
		...
		//next button
		if ($page < $counter - 1) 
			$pagination.= " <a href=\"$targetpage?page=$next&whid=$whid\"> next �</a> ";
		else
...
<td valign="middle" class="tbltext" align="center"><a href="../include/delete.php?print=bin&code=<?php echo $row['binid'];?>&id=<?php echo $whid;?>" onclick="return confirm('Do you really want to delete this Record?')"><img border="0" src="../images/delete.png"  /></a></td>
</tr>
<?php
	}
	else
