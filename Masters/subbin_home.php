...
<title>Stores-Masters-Subbin home</title>
...
function mmLoadMenus() {if (window.mm_menu_0804145533_0) return;
  ...
  //mm_menu_0804145533_0.fontWeight="bold";
   ...
   mm_menu_0804145533_0.menuBorderBgColor='#FF6600';window.mm_menu_0804150040_0 = new Menu("root",164,18,"Arial, Verdana, Helvetica, sans-serif",12,"#000000","#FFFFFF","#D2E9FF","#4ea1e1","left","middle",3,0,1000,-5,7,true,false,true,0,true,true);
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="810" height="25">&nbsp;Sub-Bin Home </td>
	    </tr></table></td>
	  <td width="139" height="25" align="right" class="submenufont" >
	  <table border="3" align="right" bordercolordark="#4ea1e1" cellspacing="0" cellpadding="0" width="130" style="border-collapse:collapse;">
...
<?php
	...
	$sql_sel="select * from tbl_subbin order by sname LIMIT $from, $max_results";
	$res=mysql_query($sql_sel) or die (mysql_error());
	
	$total=mysql_num_rows($res);
	$total_results = mysql_result(mysql_query("SELECT COUNT(*) as Num FROM tbl_subbin"),0); 

	if($total >0) { 
?>
<table align="center" border="0" cellspacing="0" cellpadding="0" width="750" style="border-collapse:collapse">
  <tr height="25" >
    <td colspan="8" align="center" class="subheading" style="color:#303918; ">Sub Bin  List (<?php echo $total_results;?>)</td>
  </tr>
  </table>
<table align="center" border="1" cellspacing="0" cellpadding="0" width="706" bordercolor="#4ea1e1" style="border-collapse:collapse">
 
 <tr class="tblsubtitle" height="25">
<td width="47" align="center" class="tblheading" valign="middle">#</td>
<td width="103" align="left" class="tblheading" valign="middle">&nbsp;Sub-Bin Number</td>
<td width="164" align="center" class="tblheading" valign="middle">Bin </td>
<td width="125" align="center" class="tblheading" valign="middle">WH </td>
<td width="81" align="center" class="tblheading" valign="middle">Status</td>
<td width="72" align="center" class="tblheading" valign="middle">Edit</td>
<td width="98" align="center" class="tblheading" valign="middle">Delete</td>
</tr>
<?php
//$srno=1;
	...
	$resettargetquery=mysql_query("select * from tbl_bin where binid='".$row['binid']."'")or die(mysql_error());
	...
	/* $sql_p=mysql_query("select * from tbl_bin where binid='".$row['whid']."'")or die(mysql_error());
  	 $row_p=mysql_fetch_array($sql_p);
	 $num_p=mysql_num_rows($sql_p);
...
<td valign="middle" class="tbltext" align="left">&nbsp;<?php echo $row['sname'];?></td>
<td valign="middle" class="tbltext" align="center"><?php echo $resetresult['binname'];?></td>
...
<td valign="middle" class="tbltext" align="center"><a href="edit_subbin.php?sid=<?php echo $row['sid'];?>"><img src="../images/edit.png" border="0" /></a></td>
<td valign="middle" class="tbltext" align="center"><a href="../include/delete.php?print=subbin&code=<?php echo $row['sid'];?>" onclick="return confirm('Do you really want to delete this Record?')"><img border="0" src="../images/delete.png"  /></a></td>
</tr>
<?php
	}
	else
...
<?php
	...
	$tono=$srno-1;
	echo "<table width='706' align='center' class='tbltext'><tr><td align='left' >$no - $tono of $total_results Records</td><td align='right'>Select a Page    "; 
