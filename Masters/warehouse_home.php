...
<title>stores-Master-Warehouse Master</title>
...
<table width="1004" border="0" cellspacing="0" cellpadding="0">
  ...
  <td width="974" valign="top"><table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
    <tr>
      <td><table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
          <tr style="padding:0px 0px 0px 0px" >
            <td width="34" height="25"><img src="../images/rupee1.jpg" align="right" width="30" height="30" />&nbsp;</td>
            <td width="801" class="Mainheading" height="25"><table width="809" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
                <tr >
                  <td width="810" height="25">&nbsp;Warehouse Master Home </td>
                </tr>
            </table></td>
            <td width="139" height="25" align="right" class="submenufont" ><table border="3" align="right" bordercolordark="#5b7e1b" cellspacing="0" cellpadding="0" width="130" style="border-collapse:collapse;">
                <tr height="15" class="tbltitle" > 
                  <td align="center" width="130" valign="middle" class="tblbutn" style="cursor:hand;"><a href="add_warehouse.php" style="text-decoration:none; color:#FFFFFF">Add Warehouse</a></td>
                 </tr>
            </table></td>
          </tr>
      </table></td>
...
?>
                <table align="center" border="0" cellspacing="0" cellpadding="0" width="750" style="border-collapse:collapse">
                  <tr height="25" >
                    <td colspan="8" align="center" class="subheading" style="color:#303918; ">Ware house List (
                        <?php echo $total_results;?>
                      )</td>
                  </tr>
                </table>
          <table align="center" border="1" cellspacing="0" cellpadding="0" width="688" bordercolor="#4ea1e1" style="border-collapse:collapse">
                  <tr class="tblsubtitle" height="25">
                    ...
                    <td width="91" align="center" class="tblheading" valign="middle">Edit</td>
                    <td width="133" align="center" class="tblheading" valign="middle">Delete</td>
                  </tr>
                  <?php
...
?>
                ...
                <td valign="middle" class="tbltext" align="center"><a href="bin_home.php"><?php echo $num_of_records_target_set;?></a></td>
