...
session_start();
	...
	if(isset($_POST['frm_action'])=='submit')
	{
		$classification=trim($_POST['txtcla']);
		 ...
		 $query=mysql_query("SELECT * FROM tbl_classification where classification='$classification' and classification_id!='$classification_id'") or die("Error: " . mysql_error());
		// exit;
		...
		<script>
		 ...
		 {
	  $sql_in="UPDATE tbl_classification SET classification='$classification' where classification_id ='$classification_id'";
...
<title>Stores - Classification Master -Edit Classification</title>
...
{ 
	...
	{
	alert("Classification cannot start with space.");
	document.frmaddDepartment.txtcla.focus();
	return false;
	}
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Classification Master - Edit Classification </td>
	    </tr></table></td>
   ...
   <?php
	 $sql1=mysql_query("select * from tbl_classification where classification_id='$classification_id'")or die(mysql_error());
...
<tr class="Light" height="25">
 <td width="150" align="right"  valign="middle" class="tblheading">&nbsp;Classification&nbsp;</td>
<td align="left"  valign="middle">&nbsp;<input name="txtcla" type="text" size="40" class="tbltext" tabindex="0" maxlength="40" value="<?php echo $row['classification'];?>" onBlur="javascript:this.value=ucwords_w(this.value.toLowerCase());" /><font color="#FF0000" >* </font>&nbsp;</td>
</tr>
 
</table>
<table align="center" width="650" cellpadding="5" cellspacing="5" border="0" >
<tr >
<td valign="top" align="center"><a href="home_classification.php"><img src="../images/back.gif" border="0"  style="display:inline;cursor:hand;"/></a>&nbsp;&nbsp;<input name="Submit" type="image" src="../images/update.gif" alt="Submit Value" OnClick="return mySubmit()" border="0" style="display:inline;cursor:hand;"></td>
</tr>
</table>
</td><td width="30"></td>
</tr>
