...
<title>Stores - Operator Master -Edit Operator</title>
...
return false;
	...
	/*if(document.frmaddDepartment.txtId.value!="")
{
var txtVal = document.frmaddDepartment.txtId.value;
for(var i = 0;i<document.frmaddDepartment.txtId.value.length; i++)
{
if(txtVal.charAt(i) < 'A' || txtVal.charAt(i) > 'Z' && txtVal.charAt(i) <'a' || txtVal.charAt(i)>'z' && txtVal.charAt(i) !=32)
{
alert("Invalid Id Enter only Alphabets.");
document.frmaddDepartment.txtId.focus();
return false;
}
}
	...
	if(!isNaN(document.frmaddDepartment.txtpass.value))
{
alert("Invalid Password Enter only Alphabets. and spc Character");
document.frmaddDepartment.txtpass.focus();
return false;
/*var txtVal = document.frmaddDepartment.txtpass.value;
for(var i = 0;i<document.frmaddDepartment.txtpass.value.length; i++)
{
if(txtVal.charAt(i) < 'A' || txtVal.charAt(i) > 'Z' && txtVal.charAt(i) <'a' || txtVal.charAt(i)>'z' )
{
alert("Invalid Id Enter only Alphabets.");
...
<!-- actual page start--->	
 ...
 <?php 
    $sql=mysql_query("select * from tbl_opr where id='$id'")or die(mysql_error()); 
...
<td width="right" align="right" valign="middle" class="tblheading">&nbsp;Operator Code &nbsp;</td>
<td width="275"  align="left" valign="middle" class="tbltext">&nbsp;<input name="txtid1" type="text" size="12" class="tbltext" tabindex="" readonly="true" style="background-color:#CCCCCC"   value="<?php echo "OP".$row['code'];?>"/></td></tr>
...
<td width="472" align="left" valign="middle" class="tbltext">&nbsp;<input name="txtId" type="text" class="tbltext" tabindex="0" value="<?php echo $row['login'];?>" size="10" maxlength="10"/>&nbsp;<font color="#FF0000">*</font>&nbsp;Min 6 Max 10</td> </tr>

<tr class="Dark" height="25">
<td align="right" valign="middle" class="tblheading">&nbsp;Password&nbsp;</td>
<td align="left" valign="middle" class="tbltext">&nbsp;<input name="txtpass" type="password" class="tbltext" tabindex="1" value="<?php echo $row['pass'];?>" size="10" maxlength="10"/>&nbsp;<font color="#FF0000">*</font>&nbsp;Min 6 Max 10</td> </tr>

<tr class="Light" height="25">
<td align="right" valign="middle" class="tblheading">Confirm Password&nbsp;</td>
<td align="left" valign="middle" class="tbltext">&nbsp;<input name="txtrepass" type="password" class="tbltext" tabindex="2" value="<?php echo $row['pass'];?>" size="10" maxlength="10"/>&nbsp;<font color="#FF0000">*</font>&nbsp;Min 6 Max 10</td> </tr>
<tr class="Dark" height="25">
...
<td align="left" valign="middle" class="tbltext">&nbsp;<input tabindex="3" name="txtemail" type="text" size="35" class="tbltext" value="<?php echo $row['email'];?>" maxlength="35"/>&nbsp;<font color="#FF0000">*</font>&nbsp;</td>
</tr>
...
<tr >
<td valign="top" align="center"><a href="operator_home.php"><img src="../images/back.gif" border="0" style="cursor:hand" /></a>&nbsp;<input name="Submit" type="image" src="../images/update.gif" alt="Submit Value" OnClick="return mySubmit()" border="0" style="display:inline;cursor:hand;"></td>
</tr>
</table>
</td><td width="30"></td>
</tr>
