...
<title>Stores - Warehouse Master -Warehouse Home</title>
...
<?php
  ...
  $sql_arr_home=mysql_query("select * from tbl_warehouse order by perticulars asc LIMIT $start, $limit") or die(mysql_error());
...
$query = "select * from tbl_warehouse order by perticulars asc";
...
$pagination = "";
	...
	$count_result = mysql_query("SELECT COUNT(*) as Num FROM tbl_warehouse");
