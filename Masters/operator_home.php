...
<title>Stores - Operator Master -Operator Home</title>
...
function butnchk()
{
alert("Addition of Max. 3 Operators Allowed");
}
</script>
...
<tr height="15" class="tbltitle" ><?php
	...
	$count_result = mysql_query("SELECT COUNT(*) as Num FROM tbl_opr");
	$count_row = mysql_fetch_array($count_result);
	$total_results = $count_row[0]; 
	if($total <3)
	{
?>
<td align="center" width="130" valign="middle" class="tblbutn" style="cursor:hand;"><a href="add_Operator.php" style="text-decoration:none; color:#000000">Add Operator</a></td>
<?php
}
else
{
?>
<td align="center" width="130" valign="middle" class="tblbutn" style="cursor:hand;"><a href="Javascript:void(0);" onclick="butnchk();" style="text-decoration:none; color:#FFFFFF; cursor:hand">Add Operator</a></td>
<?php
}
?></tr> 
</table></td>
...
<table align="center" border="1" cellspacing="0" cellpadding="0" width="702" bordercolor="#4ea1e1" style="border-collapse:collapse">
 
 <tr class="tblsubtitle" height="25">
<td width="130" align="center" class="tblheading" valign="middle">Operator Code</td>
...
<td valign="middle" class="tbltext" align="center"><a href="edit_operator.php?id=<?php echo $row['id'];?>"><img src="../images/edit.png" border="0" /></a></td>
</tr>
<?php
	}
	else
...
<table align="center" border="0" cellspacing="0" cellpadding="0" width="702" style="border-collapse:collapse">
  <tr height="25" >
    <td  colspan="8" align="Right" class="subheading" style="color:#303918; "><br/>
    <td width="197"  colspan="8" align="Right"  class="smalltbltext" style="color:#303918; "><font color="#FF0000" >* </font>Max. 3 Operator roles allowed</td>
  </tr>
  </table>
<?php
