	...
	if(isset($_POST['frm_action'])=='submit')
	{
	 ...
	 /*	
		$query=mysql_query("SELECT * FROM tbl_subbin where sname='$sbin'") or die("Error: " . mysql_error());
		 ...
		 ?>
		 <script>
		  alert("This Sub-bin is Already Present.");
		  </script>
		 <?php }
		 else 
		{
	 	*/
 	  $sql_in="UPDATE  tbl_subbin SET sname='$sbin', 
	                        whid='$wh'
	                         where binid='$bin'";
					//exit;							
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Sub-Bin Master - Edit Sub-Bin </td>
	    </tr></table></td>
...
<tr class="tblsubtitle" height="25">
  <td colspan="4" align="center" class="tblheading">Edit Sub-Bin </td>
</tr>

<?php
		$sql2=mysql_query("SELECT * FROM tbl_subbin where sid='".$sid."'"); 
...
<tr class="Light" height="25">
           <td width="317"  align="right"  valign="middle" class="tblheading">&nbsp;Select Warehouse Numbe&nbsp; </td>
           <td width="327" colspan="3" align="left"  valign="middle" class="tbltext">&nbsp;<select class="tbltext" name="txtwh" style="width:170px;" tabindex="" >
...
?>
           <td width="317"  align="right"  valign="middle" class="tblheading">&nbsp;Select Bin Number&nbsp;</td>
...
<tr class="Light" height="25">
           <td width="317"  align="right"  valign="middle" class="tblheading">Sub-Bin Number&nbsp;</td>
           <td align="left"  valign="middle" colspan="3" class="tbltext">&nbsp;<select name="txtsbin" class="tbltext"  style="width:170px;" tabindex="">
          <option value="<?php echo $row['sname'];?>" selected><?php echo $row['sname'];?> </option>
          <option value="Select State">--Select Sub- Bin no--</option>
...
<table align="center" width="640" cellpadding="5" cellspacing="5" border="0" >
<tr >
<td width="620" align="center" valign="top"><a href="subbin_home.php"><img src="../images/back.gif" border="0"  style="display:inline;cursor:hand;"/></a>&nbsp;<a href="javascript:document.frmaddDept.reset()"></a>&nbsp;<input name="Submit" type="image" src="../images/update.gif" alt="Submit Value" OnClick="return mySubmit()" border="0" style="display:inline;cursor:hand;"></td>
</tr>
</table>
</td><td width="30"></td>
</tr>
