<?php
	...
	if(isset($_POST['frm_action']) && $_POST['frm_action']=='submit')
	{
	 ...
	 $query=mysql_query("SELECT * FROM tbl_state where state='$state'") or die("Error: " . mysql_error());
		// exit;
		...
		<script>
		 ...
		 {
		 $sql_in="insert into tbl_state(state) values(
											  '$state'
														)";
...
/*$sql_code="SELECT MAX(`country`) FROM tbl_country ORDER BY `location_code` DESC";
...
<title>Stores -  Master -Add State</title>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="5398ee" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="4ea1e1" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;state Master - Add state </td>
	    </tr></table></td>
...
<tr class="tblsubtitle" height="25">
  <td colspan="4" align="center" class="subheading">Add a NEW State Form</td>
</tr>
<tr height="30">
    <td colspan="4" align="right" class="tblheading"><font color="#FF0000" >* </font>indicates required field&nbsp;</td>
  </tr>
<tr class="Light" height="25">
<td width="150" align="right" height="30" valign="middle" class="tblheading">State&nbsp;</td>
<td align="left"  valign="middle">&nbsp;<input name="txtcla" type="text" size="40" class="tbltext" tabindex="0" maxlength="40" onBlur="javascript:this.value=ucwords_w(this.value.toLowerCase());"  />&nbsp;<font color="#FF0000" >* </font>&nbsp;</td>
