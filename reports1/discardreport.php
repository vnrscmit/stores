<?php
	...
	$itemid = $_REQUEST['txtitem'];
		...
		if($sdate!="" && $edate!="")
		{
		echo "<script>window.location='discardreport1.php?sdate=$sdate&edate=$edate&txtclass=$cid&txtitem=$itemid'</script>";
		}
		else
		 {?>
		 <script>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25"class="Mainheading"  >Discard Report</td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
<tr class="tblsubtitle" height="25">
  <td colspan="4" align="center" class="tblheading">Discardr Report</td>
</tr>
