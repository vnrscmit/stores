<?php
	...
	{
	$classification_id = $_REQUEST['txtclass'];
	}
		if(isset($_REQUEST['txtitem']))
	{
   $items_id = $_REQUEST['txtitem'];
	}
?>
...
<tr >
<td align="right" colspan="3"><a  href="utility.php?txtclass=<?php echo $classification_id?>&txtitem=<?php echo $items_id?>"><img src="../images/close_icon2.jpg" height="30" border="0" class="butn" style="cursor:pointer"  /></a>&nbsp;&nbsp; <img src="../images/Vista-printer.png" height="29" width="35" border="0" onClick="javascript:window.print();" class="butn" style="cursor:pointer"  />&nbsp;&nbsp;</td>
</tr>
</table>
</form>
</td></tr>
