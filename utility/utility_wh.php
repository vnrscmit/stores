<?php
	...
	if(isset($_POST['frm_action'])=='Submit')
	{
		 ...
		 $bid=trim($_POST['txtslbing1']);
			...
			echo "<script>window.location='utility_wh2.php?txtslwhg1=$whid&txtslsubbg1=$sid&txtslbing1=$bid'</script>";	
		}
...
<title>Stores- Utility -Utility Sloc Selection</title>
...
<tr class="tblsubtitle" height="25">
  <td colspan="6" align="center" class="tblheading">SLOC Search </td>
</tr>
  <tr height="15">
...
<option value="ALL" selected>-----ALL---</option></select>&nbsp;&nbsp;</td></tr>
