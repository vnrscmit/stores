...
$flag=0; 
//echo $a;
$sql_month=mysql_query("select items_id, stores_item from tbl_stores where classification_id='$a' and actstatus='Active' order by stores_item")or die("Error:".mysql_error());
