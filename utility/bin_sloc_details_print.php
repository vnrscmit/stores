<?php
	...
	{
	echo $classification_id = $_GET['txtclass'];
	}
		if(isset($_GET['txtitem']))
	{
echo 	$items_id = $_GET['txtitem'];
	}
?>
...
<title>Stores-Transaction -Bin card</title>
...
<body topmargin="0" >
<?php  
$sql1=mysql_query("select * from tblarr_sloc where whid='".$wid."' and binid='".$bid."'  and arr_tr_id='".$pid."' order by subbin")or die(mysql_error());
$rowtblsub=mysql_fetch_array($sql1);
$f=$rowtblsub['item_id'];
?>
...
<table align="center" border="1" cellspacing="0" cellpadding="0" width="800" bordercolor="#4ea1e1" style="border-collapse:collapse">
			...
			<tr class="tblsubtitle">
			  ...
			  <td width="7%" align="center" valign="middle" class="tblheading">UoM</td>
                    <td width="5%" align="center" valign="middle" class="tblheading">G/D</td>
...
<?php
$srno=1;
$sql_tbl=mysql_query("select stlg_subbinid, stlg_tritemid from tbl_stldg_good where stlg_whid='".$wid."' and stlg_binid='".$bid."' group by stlg_subbinid, stlg_tritemid order by stlg_subbinid") or die(mysql_error());  
//echo $t=mysql_num_rows($sql_tbl);
while($row_tbl=mysql_fetch_array($sql_tbl))
{

$sql_tbl1=mysql_query("select max(stlg_id) from tbl_stldg_good where stlg_whid='".$wid."' and stlg_binid='".$bid."' and stlg_subbinid='".$row_tbl['stlg_subbinid']."' and stlg_tritemid='".$row_tbl['stlg_tritemid']."'") or die(mysql_error());  
...
?>			  
 <tr class="Light" height="20">
             ...
             <td width="36%" align="center" valign="middle" class="tblheading"><?php echo $row_item['stores_item'];?></td>
...
?>			 
 		     ...
 		     <td width="6%" align="center" valign="middle" class="tblheading"><?php echo $slups;?></td>
...
$sql_tbl=mysql_query("select stld_subbinid, stld_tritemid from tbl_stldg_damage where stld_whid='".$wid."' and stld_binid='".$bid."' group by stld_subbinid, stld_tritemid order by stld_subbinid") or die(mysql_error());  
//echo $t=mysql_num_rows($sql_tbl);
while($row_tbl=mysql_fetch_array($sql_tbl))
{

$sql_tbl1=mysql_query("select max(stld_id) from tbl_stldg_damage where stld_whid='".$wid."' and stld_binid='".$bid."' and stld_subbinid='".$row_tbl['stld_subbinid']."' and stld_tritemid='".$row_tbl['stld_tritemid']."'") or die(mysql_error());  
$row_tbl1=mysql_fetch_array($sql_tbl1);
//echo $t1=mysql_num_rows($sql_tbl1);
...
<tr >
<td align="right" colspan="3"><a  href="utility.php?" ><img src="../images/close_icon2.jpg" height="30" border="0" onClick=class="butn" style="cursor:pointer"  /></a>&nbsp;&nbsp;<img src="../images/Vista-printer.png" height="29" width="35" border="0" onClick="javascript:window.print();" class="butn"  style="cursor:pointer" />&nbsp;&nbsp;</td>
</tr>
</table>
</form>
</td></tr>
