...
if($printopt == "1" )
{
	echo "<script>window.location='utility_wh.php'</script>";	
}
if($printopt=="2"){
echo "<script>window.location='utility_sloc.php'</script>";	
}
if($printopt=="3"){
...
<title>Expro - Employee Claim Booking</title>
...
window.mm_menu_0226134618_0 = new Menu("root",124,18,"Arial, Verdana, Helvetica, sans-serif",12,"#000000","#FFFFFF","#D2E9FF","#F5F5F5","left","middle",3,0,1000,-5,7,true,false,true,0,true,true);
 mm_menu_0226134618_0.addMenuItem("Hired&nbsp;Vehicle","location='../utility/selectvendor.php'");
...
<table width="1004" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="1004">
	<?php require_once("../include/header_admin.php");?></td>
  </tr>
  <tr>
  <td>
  ...
  <tr><td>
   <table  width="974" border="0" cellpadding="0" cellspacing="0" bordercolor="#b9d647" >
	  ...
	  <table width="940" border="0" cellpadding="0" cellspacing="0" bordercolor="#4ea1e1" style="border-bottom:solid; border-bottom-color:#4ea1e1" >
	    <tr >
	      <td width="813" height="25" class="Mainheading">&nbsp;Utility - Search</td>
	    </tr></table></td>
	  </tr>
	  </table></td></tr>
...
<tr class="tblsubtitle" height="25">
  <td colspan="4" align="center" class="tblheading">Select Utility </td>
</tr>
<tr class="Light" height="25">
<td width="85"  align="right"  valign="middle" class="tbltext">&nbsp;<input type="radio" name="fet" value="1" onClick="test1(this.value);" /></td>
    <td width="223" align="left"  valign="middle" class="tblheading">&nbsp;Sloc Search </td>
</tr>
<tr class="Light" height="25">
<td  align="right"  valign="middle" class="tbltext">&nbsp;<input type="radio" name="fet" value="2" onClick="test1(this.value);" /></td>
 <td width="223" align="left"  valign="middle" class="tblheading">&nbsp;Sloc Search &amp; Bin  Card Print  </td >
 </tr>
 <tr class="Light" height="25">
<td  align="right"  valign="middle" class="tbltext">&nbsp;<input type="radio" name="fet" value="3" onClick="test1(this.value);" /></td>
 <td width="223" align="left"  valign="middle" class="tblheading">&nbsp;Stores Item Search</td >
 </tr>
</table>
